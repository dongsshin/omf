 ...
 * Program ID : MenuSubMenuRelInfo.java
 * ===========================================
...
/**
 * <pre>
 * Class : MenuSubMenuRelInfo
 * Description : TODO
 * </pre>
 * 
 * @author s_dongsshin
 */
public class MenuSubMenuInfo extends ModelRootVO{
    private String  obid                               ;
    ...
    public boolean getMenuIsActive(){
        if(Bit.isInclude(this.getMnuFlags(), OmcSystemConstants.SYSMNU_FLAG_Active)) return true;
        return false;
    }

 ...
 * Program ID : PdmValidationUtil.java
 * ===========================================
 * Modify Date    Modifier    Description 
 * -------------------------------------------
 * 2015. 10. 19.  jongjung.kwon   Initial
 * ===========================================
 */
...
/**
 * <pre>
 * Class : PdmValidationUtil
 * Description : TODO
 * </pre>
 * 
 * @author jongjung.kwon
 */
public class PdmValidationUtil {
...
//    private static final String PHONE_BACK_NUMBER_PATTERN = "\\d{4}";
    ...
    public static final String[] ALLTAGS = { "a", "abbr", "acronym", "address", "applet", "area", "b", "base", "basefont", "bdo", "big", "blockquote", "body", "br", "button", "caption", "center", "cite", "code", "col", "colgroup", "dd", "del", "dfn", "dir", "div", "dl", "dt", "em", "fieldset", "font", "form", "frame", "frameset", "h1", "h2", "h3", "h4", "h5", "h6", "head", "hr", "html", "i", "iframe", "img", "input", "ins", "isindex", "kbd", "label", "legend", "li", "link", "map", "menu", "meta", "noframes", "noscript", "object", "ol", "optgroup", "option", "p", "param", "pre", "q", "samp", "script", "select", "small", "span", "strong", "style", "sub", "sup", "table", "tbody", "td", "textarea", "tfoot", "th", "thead", "title", "tr", "tt", "ul", "var", "bgsound", "comment", "embed", "listing", "marquee", "nextid", "nobr", "plaintext", "rt", "ruby", "s", "strike", "u", "wbr", "xml", "xmp" };
    public static final String[] WEBEDITORTAGS = { "embed", "script", "object" };

    public static final String[] ALLEVENTS = { "fscommand", "onabort", "onactivate", "onafterprint", "onafterupdate", "onbeforeactivate", "onbeforecopy", "onbeforecut", "onbeforedeactivate", "onbeforeeditfocus", "onbeforepaste", "onbeforeprint", "onbeforeunload", "onbeforeupdate", "onbegin", "onblur", "onbounce", "oncellchange", "onchange", "onclick", "oncontextmenu", "oncontrolselect", "oncopy", "oncut", "ondataavailable", "ondatasetchanged", "ondatasetcomplete", "ondblclick", "ondeactivate", "ondrag", "ondragdrop", "ondragend", "ondragenter", "ondragleave", "ondragover", "ondragstart", "ondrop", "onend", "onerror", "onerrorupdate", "onfilterchange", "onfinish", "onfocus", "onfocusin", "onfocusout", "onhelp", "onkeydown", "onkeypress", "onkeyup", "onlayoutcomplete", "onload", "onlosecapture", "onmediacomplete", "onmediaerror", "onmousedown", "onmouseenter", "onmouseleave", "onmousemove", "onmouseout", "onmouseover", "onmouseup", "onmousewheel", "onmove", "onmoveend", "onmovestart", "onoutofsync", "onpaste", "onpause", "onprogress", "onpropertychange", "onreadystatechange", "onrepeat", "onreset", "onresize", "onresizeend", "onresizestart", "onresume", "onreverse", "onrowdelete", "onrowenter", "onrowexit", "onrowinserted", "onrowsdelete", "onrowsenter", "onrowsinserted", "onscroll", "onseek", "onselect", "onselectionchange", "onselectstart", "onstart", "onstop", "onsubmit", "onsyncrestored", "ontimeerror", "ontrackchange", "onunload", "onurlflip", "seeksegmenttime" };

    public static final List<String> TAGLIST = Arrays.asList(ALLTAGS);
    public static final List<String> WEBEDITORTAGLIST = Arrays.asList(WEBEDITORTAGS);

    public static final List<String> EVENTLIST = Arrays.asList(ALLEVENTS);

    public static boolean checkXSSForWebEditor(String value)
    {
      if (NullUtil.isNone(value)) return true;

      Matcher tagMatcher = TAG_REG.matcher(value);
      while (tagMatcher.find())
      {
        String tag = tagMatcher.group(3).toLowerCase();
        if (WEBEDITORTAGLIST.contains(tag)) {
          return false;
        }
      }
    ...
    public static boolean checkPhone(String number)
    {
      ...
      return phoneNumber.matches("(01[016789]|02|03[1-3]|04[1-3]|05[1-5]|06[1-4]|030|0303|050[1-9]|0[6-8]0|0130)[1-9]{1}[0-9]{2,3}\\d{4}");
    }
    ...
    public static boolean checkTelephone(String number)
    {
      ...
      return phoneNumber.matches("(02|03[1-3]|04[1-3]|05[1-5]|06[1-4]|030|0303|050[1-9]|0[6-8]0|0130)[1-9]{1}[0-9]{2,3}\\d{4}");
    }
    ...
    public static boolean checkResidentRegNo(String number, boolean includeHyphen)
    {
      ...
      String date = new StringBuilder().append(((ssn.charAt(6) == '1') || (ssn.charAt(6) == '2')) ? "19" : "20").append(ssn.substring(0, 6)).toString();
    ...
    public static boolean checkAlienRegNo(String number, boolean includeHyphen)
    {
      ...
      String date = new StringBuilder().append(((frn.charAt(6) == '5') || (frn.charAt(6) == '6')) ? "19" : "20").append(frn.substring(0, 6)).toString();
    ...
    {
      return checkBizRegNo(new StringBuilder().append(frontNumber).append(middleNumber).append(backNumber).toString(), false);
    }
    ...
    public static boolean checkBizRegNo(String number, boolean includeHyphen)
    {
      ...
      if (includeHyphen) {
        ...
        crn = new StringBuilder().append(crn.substring(0, 3)).append(crn.substring(4, 6)).append(crn.substring(7)).toString();
      }
      ...
      return ((10 - ((sum + Character.getNumericValue(characters[(size - 1)]) * 5 / 10) % 10)) % 10 == Character.getNumericValue(characters[size]));
    }

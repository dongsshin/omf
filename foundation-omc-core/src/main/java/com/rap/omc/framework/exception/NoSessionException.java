...
public class NoSessionException extends BusinessException {
    ...
    public NoSessionException(int statusCode, String code) {
     ...
     * @param code 예외메시지코드
     */
    public NoSessionException(String code) {
        super(code, null, null, null, null);
        super.setMessage(MessageUtil.getMessage(code));
    }
     ...
     */
    public NoSessionException(int statusCode, String code, Object[] messageParameters) {
        super(code, null, null, null, null);
     ...
     * @param args 메시지를 구성하는 arguments
     */
    public NoSessionException(String code, Object[] messageParameters) {
        super(code, null, null, null, null);
        super.setMessage(MessageUtil.getMessage(code, messageParameters));
    }
     ...
     */
    public NoSessionException(String code, MessageSource messageSource) {
     ...
     * @param args 메시지를 구성하는 arguments
     */
    public NoSessionException(String code, MessageSource messageSource, Object[] messageParameters) {

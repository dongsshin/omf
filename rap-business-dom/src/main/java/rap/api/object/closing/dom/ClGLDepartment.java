 ...
 * Program ID : ClGLDepartment.java
 * ===================================================================
...
import rap.api.object.closing.model.ClGLDepartmentVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ClGLDepartment extends BusinessObjectMaster {
    public ClGLDepartment(String obid){
        super(obid);
    }
    public ClGLDepartment(ClGLDepartmentVO vo){
        super(vo);
    }
    @Override
    public ClGLDepartmentVO getVo(){
        return (ClGLDepartmentVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeClGLDepartment();
    }
    public void initializeClGLDepartment(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ClGLDepartment[toString()=" + super.toString() + "]";
    }

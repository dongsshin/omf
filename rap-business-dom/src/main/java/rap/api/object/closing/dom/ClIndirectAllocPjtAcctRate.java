 ...
 * Program ID : ClIndirectAllocPjtAcctRate.java
 * ===================================================================
 *  Modification Date      Modifier           Description
 *      2017.04.??       DS Shin            Initial
 * ===================================================================
 */
package rap.api.object.closing.dom;


import java.util.Map;
import rap.api.object.closing.model.ClIndirectAllocPjtAcctRateVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ClIndirectAllocPjtAcctRate extends BusinessObjectMaster {
    public ClIndirectAllocPjtAcctRate(String obid){
        super(obid);
    }
    public ClIndirectAllocPjtAcctRate(ClIndirectAllocPjtAcctRateVO vo){
        super(vo);
    }
    @Override
    public ClIndirectAllocPjtAcctRateVO getVo(){
        return (ClIndirectAllocPjtAcctRateVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeClIndirectAllocPjtAcctRate();
    }
    public void initializeClIndirectAllocPjtAcctRate(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ClIndirectAllocPjtAcctRate[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ClProjectGradeMMDetail.java
 * ===================================================================
...
import rap.api.object.closing.model.ClProjectGradeMMDetailVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ClProjectGradeMMDetail extends BusinessObjectMaster {
    public ClProjectGradeMMDetail(String obid){
        super(obid);
    }
    public ClProjectGradeMMDetail(ClProjectGradeMMDetailVO vo){
        super(vo);
    }
    @Override
    public ClProjectGradeMMDetailVO getVo(){
        return (ClProjectGradeMMDetailVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeClProjectGradeMMDetail();
    }
    public void initializeClProjectGradeMMDetail(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ClProjectGradeMMDetail[toString()=" + super.toString() + "]";
    }

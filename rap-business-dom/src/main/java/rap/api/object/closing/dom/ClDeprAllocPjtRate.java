 ...
 * Program ID : ClDeprAllocPjtRate.java
 * ===================================================================
...
import rap.api.object.closing.model.ClDeprAllocPjtRateVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ClDeprAllocPjtRate extends BusinessObjectMaster {
    public ClDeprAllocPjtRate(String obid){
        super(obid);
    }
    public ClDeprAllocPjtRate(ClDeprAllocPjtRateVO vo){
        super(vo);
    }
    @Override
    public ClDeprAllocPjtRateVO getVo(){
        return (ClDeprAllocPjtRateVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeClDeprAllocPjtRate();
    }
    public void initializeClDeprAllocPjtRate(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ClDeprAllocPjtRate[toString()=" + super.toString() + "]";
    }

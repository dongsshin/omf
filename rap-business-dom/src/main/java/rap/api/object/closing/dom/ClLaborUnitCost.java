 ...
 * Program ID : ClLaborUnitCost.java
 * ===================================================================
...
import rap.api.object.closing.model.ClLaborUnitCostVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ClLaborUnitCost extends BusinessObjectMaster {
    public ClLaborUnitCost(String obid){
        super(obid);
    }
    public ClLaborUnitCost(ClLaborUnitCostVO vo){
        super(vo);
    }
    @Override
    public ClLaborUnitCostVO getVo(){
        return (ClLaborUnitCostVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeClLaborUnitCost();
    }
    public void initializeClLaborUnitCost(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ClLaborUnitCost[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ClIndirectAllocPjtRate.java
 * ===================================================================
...
import rap.api.object.closing.model.ClIndirectAllocPjtRateVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ClIndirectAllocPjtRate extends BusinessObjectMaster {
    public ClIndirectAllocPjtRate(String obid){
        super(obid);
    }
    public ClIndirectAllocPjtRate(ClIndirectAllocPjtRateVO vo){
        super(vo);
    }
    @Override
    public ClIndirectAllocPjtRateVO getVo(){
        return (ClIndirectAllocPjtRateVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeClIndirectAllocPjtRate();
    }
    public void initializeClIndirectAllocPjtRate(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ClIndirectAllocPjtRate[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.closing.model.ClProjectMMVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ClProjectMM extends BusinessObjectMaster {
    public ClProjectMM(String obid){
        super(obid);
    }
    public ClProjectMM(ClProjectMMVO vo){
        super(vo);
    }
    @Override
    public ClProjectMMVO getVo(){
        return (ClProjectMMVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeClProjectMM();
    }
    public void initializeClProjectMM(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ClProjectMM[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ClFundDeptProject.java
 * ===================================================================
...
import rap.api.object.closing.model.ClFundDeptProjectVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ClFundDeptProject extends BusinessObjectMaster {
    public ClFundDeptProject(String obid){
        super(obid);
    }
    public ClFundDeptProject(ClFundDeptProjectVO vo){
        super(vo);
    }
    @Override
    public ClFundDeptProjectVO getVo(){
        return (ClFundDeptProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeClFundDeptProject();
    }
    public void initializeClFundDeptProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ClFundDeptProject[toString()=" + super.toString() + "]";
    }

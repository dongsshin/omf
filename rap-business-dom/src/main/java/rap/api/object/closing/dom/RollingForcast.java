 ...
 * Program ID : RollingForcast.java
 * ===================================================================
...
import rap.api.object.closing.model.RollingForcastVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class RollingForcast extends BusinessObjectMaster {
    public RollingForcast(String obid){
        super(obid);
    }
    public RollingForcast(RollingForcastVO vo){
        super(vo);
    }
    @Override
    public RollingForcastVO getVo(){
        return (RollingForcastVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeRollingForcast();
    }
    public void initializeRollingForcast(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "RollingForcast[toString()=" + super.toString() + "]";
    }

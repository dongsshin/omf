...
import rap.api.object.closing.model.ClDeprAmountVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ClDeprAmount extends BusinessObjectMaster {
    public ClDeprAmount(String obid){
        super(obid);
    }
    public ClDeprAmount(ClDeprAmountVO vo){
        super(vo);
    }
    @Override
    public ClDeprAmountVO getVo(){
        return (ClDeprAmountVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeClDeprAmount();
    }
    public void initializeClDeprAmount(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ClDeprAmount[toString()=" + super.toString() + "]";
    }

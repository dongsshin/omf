 ...
 * Program ID : ClProjectGradeMM.java
 * ===================================================================
...
import rap.api.object.closing.model.ClProjectGradeMMVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ClProjectGradeMM extends BusinessObjectMaster {
    public ClProjectGradeMM(String obid){
        super(obid);
    }
    public ClProjectGradeMM(ClProjectGradeMMVO vo){
        super(vo);
    }
    @Override
    public ClProjectGradeMMVO getVo(){
        return (ClProjectGradeMMVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeClProjectGradeMM();
    }
    public void initializeClProjectGradeMM(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ClProjectGradeMM[toString()=" + super.toString() + "]";
    }

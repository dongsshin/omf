...
import rap.api.object.closing.model.ClFundMappingVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ClFundMapping extends BusinessObjectMaster {
    public ClFundMapping(String obid){
        super(obid);
    }
    public ClFundMapping(ClFundMappingVO vo){
        super(vo);
    }
    @Override
    public ClFundMappingVO getVo(){
        return (ClFundMappingVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeClFundMapping();
    }
    public void initializeClFundMapping(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ClFundMapping[toString()=" + super.toString() + "]";
    }

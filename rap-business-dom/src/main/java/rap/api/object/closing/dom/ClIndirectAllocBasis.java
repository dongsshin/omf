 ...
 * Program ID : ClIndirectAllocBasis.java
 * ===================================================================
...
import rap.api.object.closing.model.ClIndirectAllocBasisVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ClIndirectAllocBasis extends BusinessObjectMaster {
    public ClIndirectAllocBasis(String obid){
        super(obid);
    }
    public ClIndirectAllocBasis(ClIndirectAllocBasisVO vo){
        super(vo);
    }
    @Override
    public ClIndirectAllocBasisVO getVo(){
        return (ClIndirectAllocBasisVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeClIndirectAllocBasis();
    }
    public void initializeClIndirectAllocBasis(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ClIndirectAllocBasis[toString()=" + super.toString() + "]";
    }

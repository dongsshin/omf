 ...
 * Program ID : ClGLUpdateRule.java
 * ===================================================================
...
import rap.api.object.closing.model.ClGLUpdateRuleVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ClGLUpdateRule extends BusinessObjectMaster {
    public ClGLUpdateRule(String obid){
        super(obid);
    }
    public ClGLUpdateRule(ClGLUpdateRuleVO vo){
        super(vo);
    }
    @Override
    public ClGLUpdateRuleVO getVo(){
        return (ClGLUpdateRuleVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeClGLUpdateRule();
    }
    public void initializeClGLUpdateRule(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ClGLUpdateRule[toString()=" + super.toString() + "]";
    }

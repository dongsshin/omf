 ...
 * Program ID : RNDFAInvestment.java
 * ===================================================================
...
import rap.api.object.closing.model.RNDFAInvestmentVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class RNDFAInvestment extends BusinessObjectMaster {
    public RNDFAInvestment(String obid){
        super(obid);
    }
    public RNDFAInvestment(RNDFAInvestmentVO vo){
        super(vo);
    }
    @Override
    public RNDFAInvestmentVO getVo(){
        return (RNDFAInvestmentVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeRNDFAInvestment();
    }
    public void initializeRNDFAInvestment(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "RNDFAInvestment[toString()=" + super.toString() + "]";
    }

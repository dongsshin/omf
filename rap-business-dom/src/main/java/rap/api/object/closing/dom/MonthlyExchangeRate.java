 ...
 * Program ID : MonthlyExchangeRate.java
 * ===================================================================
...
import rap.api.object.closing.model.MonthlyExchangeRateVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class MonthlyExchangeRate extends BusinessObjectMaster {
    public MonthlyExchangeRate(String obid){
        super(obid);
    }
    public MonthlyExchangeRate(MonthlyExchangeRateVO vo){
        super(vo);
    }
    @Override
    public MonthlyExchangeRateVO getVo(){
        return (MonthlyExchangeRateVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeMonthlyExchangeRate();
    }
    public void initializeMonthlyExchangeRate(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "MonthlyExchangeRate[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ClDeprAllocAcctRate.java
 * ===================================================================
...
import rap.api.object.closing.model.ClDeprAllocAcctRateVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ClDeprAllocAcctRate extends BusinessObjectMaster {
    public ClDeprAllocAcctRate(String obid){
        super(obid);
    }
    public ClDeprAllocAcctRate(ClDeprAllocAcctRateVO vo){
        super(vo);
    }
    @Override
    public ClDeprAllocAcctRateVO getVo(){
        return (ClDeprAllocAcctRateVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeClDeprAllocAcctRate();
    }
    public void initializeClDeprAllocAcctRate(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ClDeprAllocAcctRate[toString()=" + super.toString() + "]";
    }

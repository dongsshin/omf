 ...
 * Program ID : BusinessObjectSample1.java
 * ===================================================================
...
import rap.api.object.prototype.dom.BusinessObjectSample;


public class BusinessObjectSample1 extends BusinessObjectSample {
    public BusinessObjectSample1(String obid){
        super(obid);
    }
    public BusinessObjectSample1(BusinessObjectSample1VO vo){
        super(vo);
    }
    @Override
    public BusinessObjectSample1VO getVo(){
        return (BusinessObjectSample1VO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeBusinessObjectSample1();
    }
    public void initializeBusinessObjectSample1(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BusinessObjectSample1[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : BusinessObjectSample2.java
 * ===================================================================
 *  Modification Date      Modifier           Description
 *      2017.04.??       DS Shin            Initial
 * ===================================================================
 */
package rap.api.object.prototype.dom;


import java.util.Map;
import rap.api.object.prototype.model.BusinessObjectSample2VO;
import rap.api.object.prototype.dom.BusinessObjectSample1;


public class BusinessObjectSample2 extends BusinessObjectSample1 {
    public BusinessObjectSample2(String obid){
        super(obid);
    }
    public BusinessObjectSample2(BusinessObjectSample2VO vo){
        super(vo);
    }
    @Override
    public BusinessObjectSample2VO getVo(){
        return (BusinessObjectSample2VO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeBusinessObjectSample2();
    }
    public void initializeBusinessObjectSample2(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BusinessObjectSample2[toString()=" + super.toString() + "]";
    }

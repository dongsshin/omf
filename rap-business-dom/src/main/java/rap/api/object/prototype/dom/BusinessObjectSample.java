 ...
 * Program ID : BusinessObjectSample.java
 * ===================================================================
...
public class BusinessObjectSample extends BusinessObject {
    public BusinessObjectSample(String obid){
        super(obid);
    }
    public BusinessObjectSample(BusinessObjectSampleVO vo){
        super(vo);
    }
    @Override
    public BusinessObjectSampleVO getVo(){
        return (BusinessObjectSampleVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeBusinessObjectSample();
    }
    public void initializeBusinessObjectSample(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BusinessObjectSample[toString()=" + super.toString() + "]";
    }

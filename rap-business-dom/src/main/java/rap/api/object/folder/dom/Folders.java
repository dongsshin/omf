...
import rap.api.object.folder.model.FoldersVO;
import rap.api.object.classification.dom.Libraries;


public class Folders extends Libraries {
    public Folders(String obid){
        super(obid);
    }
    public Folders(FoldersVO vo){
        super(vo);
    }
    @Override
    public FoldersVO getVo(){
        return (FoldersVO)super.getVo();
    }
    @Override
    ...
    public String toString() {
        return "Folders[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ProjectFolder.java
 * ===================================================================
 *  Modification Date      Modifier           Description
 *      2017.04.??       DS Shin            Initial
 * ===================================================================
 */
package rap.api.object.folder.dom;


import java.util.Map;
import rap.api.object.folder.model.ProjectFolderVO;
import rap.api.object.folder.dom.Folders;


public class ProjectFolder extends Folders {
    public ProjectFolder(String obid){
        super(obid);
    }
    public ProjectFolder(ProjectFolderVO vo){
        super(vo);
    }
    @Override
    public ProjectFolderVO getVo(){
        return (ProjectFolderVO)super.getVo();
    }
    @Override
    ...
    public void initializeProjectFolder(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectFolder[toString()=" + super.toString() + "]";
    }

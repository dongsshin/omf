 ...
 * Program ID : PersonalFolder.java
 * ===================================================================
...
import rap.api.object.folder.model.PersonalFolderVO;
import rap.api.object.folder.dom.Folders;


public class PersonalFolder extends Folders {
    public PersonalFolder(String obid){
        super(obid);
    }
    public PersonalFolder(PersonalFolderVO vo){
        super(vo);
    }
    @Override
    public PersonalFolderVO getVo(){
        return (PersonalFolderVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePersonalFolder();
    }
    public void initializePersonalFolder(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PersonalFolder[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.folder.model.PublicFolderVO;
import rap.api.object.folder.dom.Folders;


public class PublicFolder extends Folders {
    public PublicFolder(String obid){
        super(obid);
    }
    public PublicFolder(PublicFolderVO vo){
        super(vo);
    }
    @Override
    public PublicFolderVO getVo(){
        return (PublicFolderVO)super.getVo();
    }
    @Override
    ...
    public String toString() {
        return "PublicFolder[toString()=" + super.toString() + "]";
    }

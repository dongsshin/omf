 ...
 * Program ID : ConsultChemicalItem.java
 * ===================================================================
...
import rap.api.object.consult.model.ConsultChemicalItemVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ConsultChemicalItem extends BusinessObjectMaster {
    public ConsultChemicalItem(String obid){
        super(obid);
    }
    public ConsultChemicalItem(ConsultChemicalItemVO vo){
        super(vo);
    }
    @Override
    public ConsultChemicalItemVO getVo(){
        return (ConsultChemicalItemVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeConsultChemicalItem();
    }
    public void initializeConsultChemicalItem(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ConsultChemicalItem[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ConsultOSCModifyInfo.java
 * ===================================================================
...
import rap.api.object.consult.model.ConsultOSCModifyInfoVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ConsultOSCModifyInfo extends BusinessObjectMaster {
    public ConsultOSCModifyInfo(String obid){
        super(obid);
    }
    public ConsultOSCModifyInfo(ConsultOSCModifyInfoVO vo){
        super(vo);
    }
    @Override
    public ConsultOSCModifyInfoVO getVo(){
        return (ConsultOSCModifyInfoVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeConsultOSCModifyInfo();
    }
    public void initializeConsultOSCModifyInfo(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ConsultOSCModifyInfo[toString()=" + super.toString() + "]";
    }

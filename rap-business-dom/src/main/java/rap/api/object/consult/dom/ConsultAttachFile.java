 ...
 * Program ID : ConsultAttachFile.java
 * ===================================================================
...
import rap.api.object.consult.model.ConsultAttachFileVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ConsultAttachFile extends BusinessObjectMaster {
    public ConsultAttachFile(String obid){
        super(obid);
    }
    public ConsultAttachFile(ConsultAttachFileVO vo){
        super(vo);
    }
    @Override
    public ConsultAttachFileVO getVo(){
        return (ConsultAttachFileVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeConsultAttachFile();
    }
    public void initializeConsultAttachFile(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ConsultAttachFile[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ConsultFormReqType.java
 * ===================================================================
...
import rap.api.object.consult.model.ConsultFormReqTypeVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ConsultFormReqType extends BusinessObjectMaster {
    public ConsultFormReqType(String obid){
        super(obid);
    }
    public ConsultFormReqType(ConsultFormReqTypeVO vo){
        super(vo);
    }
    @Override
    public ConsultFormReqTypeVO getVo(){
        return (ConsultFormReqTypeVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeConsultFormReqType();
    }
    public void initializeConsultFormReqType(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ConsultFormReqType[toString()=" + super.toString() + "]";
    }

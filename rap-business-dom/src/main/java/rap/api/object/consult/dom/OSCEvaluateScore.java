 ...
 * Program ID : OSCEvaluateScore.java
 * ===================================================================
...
import rap.api.object.consult.model.OSCEvaluateScoreVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class OSCEvaluateScore extends BusinessObjectMaster {
    public OSCEvaluateScore(String obid){
        super(obid);
    }
    public OSCEvaluateScore(OSCEvaluateScoreVO vo){
        super(vo);
    }
    @Override
    public OSCEvaluateScoreVO getVo(){
        return (OSCEvaluateScoreVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeOSCEvaluateScore();
    }
    public void initializeOSCEvaluateScore(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "OSCEvaluateScore[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ConsultOutsourcingMM.java
 * ===================================================================
...
import rap.api.object.consult.model.ConsultOutsourcingMMVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ConsultOutsourcingMM extends BusinessObjectMaster {
    public ConsultOutsourcingMM(String obid){
        super(obid);
    }
    public ConsultOutsourcingMM(ConsultOutsourcingMMVO vo){
        super(vo);
    }
    @Override
    public ConsultOutsourcingMMVO getVo(){
        return (ConsultOutsourcingMMVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeConsultOutsourcingMM();
    }
    public void initializeConsultOutsourcingMM(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ConsultOutsourcingMM[toString()=" + super.toString() + "]";
    }

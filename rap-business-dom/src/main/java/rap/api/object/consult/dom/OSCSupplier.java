...
import rap.api.object.consult.model.OSCSupplierVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class OSCSupplier extends BusinessObjectMaster {
    public OSCSupplier(String obid){
        super(obid);
    }
    public OSCSupplier(OSCSupplierVO vo){
        super(vo);
    }
    @Override
    public OSCSupplierVO getVo(){
        return (OSCSupplierVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeOSCSupplier();
    }
    public void initializeOSCSupplier(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "OSCSupplier[toString()=" + super.toString() + "]";
    }

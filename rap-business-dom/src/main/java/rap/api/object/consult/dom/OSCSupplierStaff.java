 ...
 * Program ID : OSCSupplierStaff.java
 * ===================================================================
...
import rap.api.object.consult.model.OSCSupplierStaffVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class OSCSupplierStaff extends BusinessObjectMaster {
    public OSCSupplierStaff(String obid){
        super(obid);
    }
    public OSCSupplierStaff(OSCSupplierStaffVO vo){
        super(vo);
    }
    @Override
    public OSCSupplierStaffVO getVo(){
        return (OSCSupplierStaffVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeOSCSupplierStaff();
    }
    public void initializeOSCSupplierStaff(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "OSCSupplierStaff[toString()=" + super.toString() + "]";
    }

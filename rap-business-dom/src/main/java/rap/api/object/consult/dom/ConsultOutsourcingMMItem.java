 ...
 * Program ID : ConsultOutsourcingMMItem.java
 * ===================================================================
 *  Modification Date      Modifier           Description
 *      2017.04.??       DS Shin            Initial
 * ===================================================================
 */
package rap.api.object.consult.dom;


import java.util.Map;
import rap.api.object.consult.model.ConsultOutsourcingMMItemVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ConsultOutsourcingMMItem extends BusinessObjectMaster {
    public ConsultOutsourcingMMItem(String obid){
        super(obid);
    }
    public ConsultOutsourcingMMItem(ConsultOutsourcingMMItemVO vo){
        super(vo);
    }
    @Override
    public ConsultOutsourcingMMItemVO getVo(){
        return (ConsultOutsourcingMMItemVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeConsultOutsourcingMMItem();
    }
    public void initializeConsultOutsourcingMMItem(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ConsultOutsourcingMMItem[toString()=" + super.toString() + "]";
    }

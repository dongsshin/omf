 ...
 * Program ID : OSCEvaluateItem.java
 * ===================================================================
...
import rap.api.object.consult.model.OSCEvaluateItemVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class OSCEvaluateItem extends BusinessObjectMaster {
    public OSCEvaluateItem(String obid){
        super(obid);
    }
    public OSCEvaluateItem(OSCEvaluateItemVO vo){
        super(vo);
    }
    @Override
    public OSCEvaluateItemVO getVo(){
        return (OSCEvaluateItemVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeOSCEvaluateItem();
    }
    public void initializeOSCEvaluateItem(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "OSCEvaluateItem[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : OSCPaymentPlan.java
 * ===================================================================
...
import rap.api.object.consult.model.OSCPaymentPlanVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class OSCPaymentPlan extends BusinessObjectMaster {
    public OSCPaymentPlan(String obid){
        super(obid);
    }
    public OSCPaymentPlan(OSCPaymentPlanVO vo){
        super(vo);
    }
    @Override
    public OSCPaymentPlanVO getVo(){
        return (OSCPaymentPlanVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeOSCPaymentPlan();
    }
    public void initializeOSCPaymentPlan(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "OSCPaymentPlan[toString()=" + super.toString() + "]";
    }

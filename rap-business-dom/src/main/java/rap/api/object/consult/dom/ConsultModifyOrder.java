 ...
 * Program ID : ConsultModifyOrder.java
 * ===================================================================
...
import rap.api.object.consult.model.ConsultModifyOrderVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ConsultModifyOrder extends BusinessObjectMaster {
    public ConsultModifyOrder(String obid){
        super(obid);
    }
    public ConsultModifyOrder(ConsultModifyOrderVO vo){
        super(vo);
    }
    @Override
    public ConsultModifyOrderVO getVo(){
        return (ConsultModifyOrderVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeConsultModifyOrder();
    }
    public void initializeConsultModifyOrder(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ConsultModifyOrder[toString()=" + super.toString() + "]";
    }

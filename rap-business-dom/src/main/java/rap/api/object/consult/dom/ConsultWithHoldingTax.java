 ...
 * Program ID : ConsultWithHoldingTax.java
 * ===================================================================
...
import rap.api.object.consult.model.ConsultWithHoldingTaxVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ConsultWithHoldingTax extends BusinessObjectMaster {
    public ConsultWithHoldingTax(String obid){
        super(obid);
    }
    public ConsultWithHoldingTax(ConsultWithHoldingTaxVO vo){
        super(vo);
    }
    @Override
    public ConsultWithHoldingTaxVO getVo(){
        return (ConsultWithHoldingTaxVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeConsultWithHoldingTax();
    }
    public void initializeConsultWithHoldingTax(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ConsultWithHoldingTax[toString()=" + super.toString() + "]";
    }

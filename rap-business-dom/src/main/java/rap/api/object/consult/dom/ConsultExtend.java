...
import rap.api.object.consult.model.ConsultExtendVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ConsultExtend extends BusinessObjectMaster {
    public ConsultExtend(String obid){
        super(obid);
    }
    public ConsultExtend(ConsultExtendVO vo){
        super(vo);
    }
    @Override
    public ConsultExtendVO getVo(){
        return (ConsultExtendVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeConsultExtend();
    }
    public void initializeConsultExtend(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ConsultExtend[toString()=" + super.toString() + "]";
    }

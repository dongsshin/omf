...
import rap.api.object.consult.model.ConsultFormVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ConsultForm extends BusinessObjectMaster {
    public ConsultForm(String obid){
        super(obid);
    }
    public ConsultForm(ConsultFormVO vo){
        super(vo);
    }
    @Override
    public ConsultFormVO getVo(){
        return (ConsultFormVO)super.getVo();
    }
    @Override
    ...
    public void initializeConsultForm(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ConsultForm[toString()=" + super.toString() + "]";
    }

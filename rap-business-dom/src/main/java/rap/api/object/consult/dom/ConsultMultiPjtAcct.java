 ...
 * Program ID : ConsultMultiPjtAcct.java
 * ===================================================================
...
import rap.api.object.consult.model.ConsultMultiPjtAcctVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ConsultMultiPjtAcct extends BusinessObjectMaster {
    public ConsultMultiPjtAcct(String obid){
        super(obid);
    }
    public ConsultMultiPjtAcct(ConsultMultiPjtAcctVO vo){
        super(vo);
    }
    @Override
    public ConsultMultiPjtAcctVO getVo(){
        return (ConsultMultiPjtAcctVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeConsultMultiPjtAcct();
    }
    public void initializeConsultMultiPjtAcct(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ConsultMultiPjtAcct[toString()=" + super.toString() + "]";
    }

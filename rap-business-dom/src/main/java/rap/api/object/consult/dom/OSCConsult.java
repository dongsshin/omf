...
import rap.api.object.consult.model.OSCConsultVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class OSCConsult extends BusinessObjectMaster {
    public OSCConsult(String obid){
        super(obid);
    }
    public OSCConsult(OSCConsultVO vo){
        super(vo);
    }
    @Override
    public OSCConsultVO getVo(){
        return (OSCConsultVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeOSCConsult();
    }
    public void initializeOSCConsult(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "OSCConsult[toString()=" + super.toString() + "]";
    }

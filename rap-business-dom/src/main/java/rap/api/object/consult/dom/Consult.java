...
import rap.api.object.consult.model.ConsultVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class Consult extends BusinessObjectMaster {
    public Consult(String obid){
        super(obid);
    }
    public Consult(ConsultVO vo){
        super(vo);
    }
    @Override
    public ConsultVO getVo(){
        return (ConsultVO)super.getVo();
    }
    @Override
    ...
    public void initializeConsult(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "Consult[toString()=" + super.toString() + "]";
    }

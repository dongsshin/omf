 ...
 * Program ID : ConsultFormEssentialFile.java
 * ===================================================================
...
import rap.api.object.consult.model.ConsultFormEssentialFileVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ConsultFormEssentialFile extends BusinessObjectMaster {
    public ConsultFormEssentialFile(String obid){
        super(obid);
    }
    public ConsultFormEssentialFile(ConsultFormEssentialFileVO vo){
        super(vo);
    }
    @Override
    public ConsultFormEssentialFileVO getVo(){
        return (ConsultFormEssentialFileVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeConsultFormEssentialFile();
    }
    public void initializeConsultFormEssentialFile(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ConsultFormEssentialFile[toString()=" + super.toString() + "]";
    }

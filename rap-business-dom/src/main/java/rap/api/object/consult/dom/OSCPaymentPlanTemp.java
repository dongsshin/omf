 ...
 * Program ID : OSCPaymentPlanTemp.java
 * ===================================================================
...
import rap.api.object.consult.model.OSCPaymentPlanTempVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class OSCPaymentPlanTemp extends BusinessObjectMaster {
    public OSCPaymentPlanTemp(String obid){
        super(obid);
    }
    public OSCPaymentPlanTemp(OSCPaymentPlanTempVO vo){
        super(vo);
    }
    @Override
    public OSCPaymentPlanTempVO getVo(){
        return (OSCPaymentPlanTempVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeOSCPaymentPlanTemp();
    }
    public void initializeOSCPaymentPlanTemp(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "OSCPaymentPlanTemp[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ConsultBuyItem.java
 * ===================================================================
...
import rap.api.object.consult.model.ConsultBuyItemVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ConsultBuyItem extends BusinessObjectMaster {
    public ConsultBuyItem(String obid){
        super(obid);
    }
    public ConsultBuyItem(ConsultBuyItemVO vo){
        super(vo);
    }
    @Override
    public ConsultBuyItemVO getVo(){
        return (ConsultBuyItemVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeConsultBuyItem();
    }
    public void initializeConsultBuyItem(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ConsultBuyItem[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ConsultDesignRefPrice.java
 * ===================================================================
...
import rap.api.object.consult.model.ConsultDesignRefPriceVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ConsultDesignRefPrice extends BusinessObjectMaster {
    public ConsultDesignRefPrice(String obid){
        super(obid);
    }
    public ConsultDesignRefPrice(ConsultDesignRefPriceVO vo){
        super(vo);
    }
    @Override
    public ConsultDesignRefPriceVO getVo(){
        return (ConsultDesignRefPriceVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeConsultDesignRefPrice();
    }
    public void initializeConsultDesignRefPrice(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ConsultDesignRefPrice[toString()=" + super.toString() + "]";
    }

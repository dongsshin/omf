 ...
 * Program ID : OSCConsultTemp.java
 * ===================================================================
...
import rap.api.object.consult.model.OSCConsultTempVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class OSCConsultTemp extends BusinessObjectMaster {
    public OSCConsultTemp(String obid){
        super(obid);
    }
    public OSCConsultTemp(OSCConsultTempVO vo){
        super(vo);
    }
    @Override
    public OSCConsultTempVO getVo(){
        return (OSCConsultTempVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeOSCConsultTemp();
    }
    public void initializeOSCConsultTemp(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "OSCConsultTemp[toString()=" + super.toString() + "]";
    }

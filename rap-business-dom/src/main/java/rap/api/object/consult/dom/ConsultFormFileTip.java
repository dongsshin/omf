 ...
 * Program ID : ConsultFormFileTip.java
 * ===================================================================
...
import rap.api.object.consult.model.ConsultFormFileTipVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ConsultFormFileTip extends BusinessObjectMaster {
    public ConsultFormFileTip(String obid){
        super(obid);
    }
    public ConsultFormFileTip(ConsultFormFileTipVO vo){
        super(vo);
    }
    @Override
    public ConsultFormFileTipVO getVo(){
        return (ConsultFormFileTipVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeConsultFormFileTip();
    }
    public void initializeConsultFormFileTip(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ConsultFormFileTip[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.consult.model.PRIMESItemVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PRIMESItem extends BusinessObjectMaster {
    public PRIMESItem(String obid){
        super(obid);
    }
    public PRIMESItem(PRIMESItemVO vo){
        super(vo);
    }
    @Override
    public PRIMESItemVO getVo(){
        return (PRIMESItemVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePRIMESItem();
    }
    public void initializePRIMESItem(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PRIMESItem[toString()=" + super.toString() + "]";
    }

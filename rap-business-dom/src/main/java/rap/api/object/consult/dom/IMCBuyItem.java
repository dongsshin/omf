...
import rap.api.object.consult.model.IMCBuyItemVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class IMCBuyItem extends BusinessObjectMaster {
    public IMCBuyItem(String obid){
        super(obid);
    }
    public IMCBuyItem(IMCBuyItemVO vo){
        super(vo);
    }
    @Override
    public IMCBuyItemVO getVo(){
        return (IMCBuyItemVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeIMCBuyItem();
    }
    public void initializeIMCBuyItem(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "IMCBuyItem[toString()=" + super.toString() + "]";
    }

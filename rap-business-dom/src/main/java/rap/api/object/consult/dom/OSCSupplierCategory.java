 ...
 * Program ID : OSCSupplierCategory.java
 * ===================================================================
...
import rap.api.object.consult.model.OSCSupplierCategoryVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class OSCSupplierCategory extends BusinessObjectMaster {
    public OSCSupplierCategory(String obid){
        super(obid);
    }
    public OSCSupplierCategory(OSCSupplierCategoryVO vo){
        super(vo);
    }
    @Override
    public OSCSupplierCategoryVO getVo(){
        return (OSCSupplierCategoryVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeOSCSupplierCategory();
    }
    public void initializeOSCSupplierCategory(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "OSCSupplierCategory[toString()=" + super.toString() + "]";
    }

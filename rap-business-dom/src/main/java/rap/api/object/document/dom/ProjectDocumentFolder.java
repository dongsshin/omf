 ...
 * Program ID : ProjectDocumentFolder.java
 * ===================================================================
...
import rap.api.object.document.model.ProjectDocumentFolderVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectDocumentFolder extends BusinessObjectMaster {
    public ProjectDocumentFolder(String obid){
        super(obid);
    }
    public ProjectDocumentFolder(ProjectDocumentFolderVO vo){
        super(vo);
    }
    @Override
    public ProjectDocumentFolderVO getVo(){
        return (ProjectDocumentFolderVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectDocumentFolder();
    }
    public void initializeProjectDocumentFolder(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectDocumentFolder[toString()=" + super.toString() + "]";
    }

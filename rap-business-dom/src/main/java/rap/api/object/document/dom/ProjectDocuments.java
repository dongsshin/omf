 ...
 * Program ID : ProjectDocuments.java
 * ===================================================================
...
public class ProjectDocuments extends ProjectGenericDocuments {
    public ProjectDocuments(String obid){
        super(obid);
    }
    public ProjectDocuments(ProjectDocumentsVO vo){
        super(vo);
    }
     @Override
    public ProjectDocumentsVO getVo(){
        return (ProjectDocumentsVO)super.getVo();
    }
     @Override
    ...
    public void initializeProjectDocuments(){
    /*code here*/
    }
     @Override
    public String toString() {
        return "ProjectDocuments[toString()=" + super.toString() + "]";
    }
    ...
    protected void postProcessForCreate(Map<String, Object> map){
        ...
        /*code below*/
        String projectObid = (String)map.get("projectObid");
        if(StrUtil.isNotEmpty(projectObid)){
            addFromObject(ApplicationSchemaConstants.RELCLASS_PROJECTDELIVERABLES, DomUtil.toDom(projectObid).getVo(), null);
        }
    }
    ...
    public ProjectsVO getRelatedProjects(){
        return getRelatedObject(ApplicationSchemaConstants.RELCLASS_PROJECTDELIVERABLES, ApplicationSchemaConstants.BIZCLASS_PROJECTS, GlobalConstants.FLAG_TYPE_FROM);
    }

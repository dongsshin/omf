...
import rap.api.object.document.model.DocumentRootVO;
import com.rap.omc.api.object.dom.BusinessObject;


public class DocumentRoot extends BusinessObject {
    public DocumentRoot(String obid){
        super(obid);
    }
    public DocumentRoot(DocumentRootVO vo){
        super(vo);
    }
    @Override
    public DocumentRootVO getVo(){
        return (DocumentRootVO)super.getVo();
    }
    @Override
    ...
    public void initializeDocumentRoot(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DocumentRoot[toString()=" + super.toString() + "]";
    }

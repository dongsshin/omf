 ...
 * Program ID : GeneralDocuments.java
 * ===================================================================
...
import rap.api.object.document.model.GeneralDocumentsVO;
import rap.api.object.document.dom.WorkspaceDocument;


public class GeneralDocuments extends WorkspaceDocument {
    public GeneralDocuments(String obid){
        super(obid);
    }
    public GeneralDocuments(GeneralDocumentsVO vo){
        super(vo);
    }
    @Override
    public GeneralDocumentsVO getVo(){
        return (GeneralDocumentsVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeGeneralDocuments();
    }
    public void initializeGeneralDocuments(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "GeneralDocuments[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ProjectGenericDocuments.java
 * ===================================================================
...
import rap.api.object.document.model.ProjectGenericDocumentsVO;
import rap.api.object.document.dom.WorkspaceDocument;


public class ProjectGenericDocuments extends WorkspaceDocument {
    public ProjectGenericDocuments(String obid){
        super(obid);
    }
    public ProjectGenericDocuments(ProjectGenericDocumentsVO vo){
        super(vo);
    }
    @Override
    public ProjectGenericDocumentsVO getVo(){
        return (ProjectGenericDocumentsVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectGenericDocuments();
    }
    public void initializeProjectGenericDocuments(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectGenericDocuments[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ProjectGeneralDocumentTemplate.java
 * ===================================================================
...
import rap.api.object.document.model.ProjectGeneralDocumentTemplateVO;
import rap.api.object.document.dom.ProjectDocumentTemplate;


public class ProjectGeneralDocumentTemplate extends ProjectDocumentTemplate {
    public ProjectGeneralDocumentTemplate(String obid){
        super(obid);
    }
    public ProjectGeneralDocumentTemplate(ProjectGeneralDocumentTemplateVO vo){
        super(vo);
    }
    @Override
    public ProjectGeneralDocumentTemplateVO getVo(){
        return (ProjectGeneralDocumentTemplateVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectGeneralDocumentTemplate();
    }
    public void initializeProjectGeneralDocumentTemplate(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectGeneralDocumentTemplate[toString()=" + super.toString() + "]";
    }

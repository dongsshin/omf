 ...
 * Program ID : ProjectDocumentTemplate.java
 * ===================================================================
...
import rap.api.object.document.dom.ProjectGenericDocuments;


public class ProjectDocumentTemplate extends ProjectGenericDocuments {
    public ProjectDocumentTemplate(String obid){
        super(obid);
    }
    public ProjectDocumentTemplate(ProjectDocumentTemplateVO vo){
        super(vo);
    }
    @Override
    public ProjectDocumentTemplateVO getVo(){
        return (ProjectDocumentTemplateVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectDocumentTemplate();
    }
    public void initializeProjectDocumentTemplate(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectDocumentTemplate[toString()=" + super.toString() + "]";
    }

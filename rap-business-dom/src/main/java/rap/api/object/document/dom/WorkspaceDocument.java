 ...
 * Program ID : WorkspaceDocument.java
 * ===================================================================
...
import rap.api.object.document.model.WorkspaceDocumentVO;
import rap.api.object.document.dom.DocumentRoot;


public class WorkspaceDocument extends DocumentRoot {
    public WorkspaceDocument(String obid){
        super(obid);
    }
    public WorkspaceDocument(WorkspaceDocumentVO vo){
        super(vo);
    }
    @Override
    public WorkspaceDocumentVO getVo(){
        return (WorkspaceDocumentVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeWorkspaceDocument();
    }
    public void initializeWorkspaceDocument(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "WorkspaceDocument[toString()=" + super.toString() + "]";
    }

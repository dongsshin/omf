 ...
 * Program ID : GeneralDocumentTemplate.java
 * ===================================================================
...
import rap.api.object.document.model.GeneralDocumentTemplateVO;
import rap.api.object.document.dom.GeneralDocuments;


public class GeneralDocumentTemplate extends GeneralDocuments {
    public GeneralDocumentTemplate(String obid){
        super(obid);
    }
    public GeneralDocumentTemplate(GeneralDocumentTemplateVO vo){
        super(vo);
    }
    @Override
    public GeneralDocumentTemplateVO getVo(){
        return (GeneralDocumentTemplateVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeGeneralDocumentTemplate();
    }
    public void initializeGeneralDocumentTemplate(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "GeneralDocumentTemplate[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ProjectGeneralDocument.java
 * ===================================================================
...
import rap.api.object.document.model.ProjectGeneralDocumentVO;
import rap.api.object.document.dom.ProjectDocuments;


public class ProjectGeneralDocument extends ProjectDocuments {
    public ProjectGeneralDocument(String obid){
        super(obid);
    }
    public ProjectGeneralDocument(ProjectGeneralDocumentVO vo){
        super(vo);
    }
    @Override
    public ProjectGeneralDocumentVO getVo(){
        return (ProjectGeneralDocumentVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectGeneralDocument();
    }
    public void initializeProjectGeneralDocument(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectGeneralDocument[toString()=" + super.toString() + "]";
    }

...
public class InvestObject extends BusinessObjectMaster {
    public InvestObject(String obid){
        super(obid);
    }
    public InvestObject(InvestObjectVO vo){
        super(vo);
    }
    @Override
    public InvestObjectVO getVo(){
        return (InvestObjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeInvestObject();
    }
    public void initializeInvestObject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "InvestObject[toString()=" + super.toString() + "]";
    }

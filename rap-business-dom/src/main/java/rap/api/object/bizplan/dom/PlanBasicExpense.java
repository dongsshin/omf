 ...
 * Program ID : PlanBasicExpense.java
 * ===================================================================
...
import rap.api.object.bizplan.model.PlanBasicExpenseVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PlanBasicExpense extends BusinessObjectMaster {
    public PlanBasicExpense(String obid){
        super(obid);
    }
    public PlanBasicExpense(PlanBasicExpenseVO vo){
        super(vo);
    }
    @Override
    public PlanBasicExpenseVO getVo(){
        return (PlanBasicExpenseVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePlanBasicExpense();
    }
    public void initializePlanBasicExpense(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PlanBasicExpense[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : BizPlanVersionDepartment.java
 * ===================================================================
...
import rap.api.object.bizplan.model.BizPlanVersionDepartmentVO;
import rap.api.object.organization.dom.AbstractAccountDepartment;


public class BizPlanVersionDepartment extends AbstractAccountDepartment {
    public BizPlanVersionDepartment(String obid){
        super(obid);
    }
    public BizPlanVersionDepartment(BizPlanVersionDepartmentVO vo){
        super(vo);
    }
    @Override
    public BizPlanVersionDepartmentVO getVo(){
        return (BizPlanVersionDepartmentVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeBizPlanVersionDepartment();
    }
    public void initializeBizPlanVersionDepartment(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BizPlanVersionDepartment[toString()=" + super.toString() + "]";
    }

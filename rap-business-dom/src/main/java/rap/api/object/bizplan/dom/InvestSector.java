...
import rap.api.object.bizplan.model.InvestSectorVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class InvestSector extends BusinessObjectMaster {
    public InvestSector(String obid){
        super(obid);
    }
    public InvestSector(InvestSectorVO vo){
        super(vo);
    }
    @Override
    public InvestSectorVO getVo(){
        return (InvestSectorVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeInvestSector();
    }
    public void initializeInvestSector(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "InvestSector[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : PlanProjectTransfer.java
 * ===================================================================
...
import rap.api.object.bizplan.model.PlanProjectTransferVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PlanProjectTransfer extends BusinessObjectMaster {
    public PlanProjectTransfer(String obid){
        super(obid);
    }
    public PlanProjectTransfer(PlanProjectTransferVO vo){
        super(vo);
    }
    @Override
    public PlanProjectTransferVO getVo(){
        return (PlanProjectTransferVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePlanProjectTransfer();
    }
    public void initializePlanProjectTransfer(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PlanProjectTransfer[toString()=" + super.toString() + "]";
    }

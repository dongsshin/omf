...
import rap.api.object.bizplan.model.PlanBudgetCutVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PlanBudgetCut extends BusinessObjectMaster {
    public PlanBudgetCut(String obid){
        super(obid);
    }
    public PlanBudgetCut(PlanBudgetCutVO vo){
        super(vo);
    }
    @Override
    public PlanBudgetCutVO getVo(){
        return (PlanBudgetCutVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePlanBudgetCut();
    }
    public void initializePlanBudgetCut(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PlanBudgetCut[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : WelfareUnitCost.java
 * ===================================================================
...
import rap.api.object.bizplan.model.WelfareUnitCostVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class WelfareUnitCost extends BusinessObjectMaster {
    public WelfareUnitCost(String obid){
        super(obid);
    }
    public WelfareUnitCost(WelfareUnitCostVO vo){
        super(vo);
    }
    @Override
    public WelfareUnitCostVO getVo(){
        return (WelfareUnitCostVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeWelfareUnitCost();
    }
    public void initializeWelfareUnitCost(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "WelfareUnitCost[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : PlanOperateExpense.java
 * ===================================================================
...
import rap.api.object.bizplan.model.PlanOperateExpenseVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PlanOperateExpense extends BusinessObjectMaster {
    public PlanOperateExpense(String obid){
        super(obid);
    }
    public PlanOperateExpense(PlanOperateExpenseVO vo){
        super(vo);
    }
    @Override
    public PlanOperateExpenseVO getVo(){
        return (PlanOperateExpenseVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePlanOperateExpense();
    }
    public void initializePlanOperateExpense(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PlanOperateExpense[toString()=" + super.toString() + "]";
    }

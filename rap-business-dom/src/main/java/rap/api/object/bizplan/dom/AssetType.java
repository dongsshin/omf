...
import rap.api.object.bizplan.model.AssetTypeVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class AssetType extends BusinessObjectMaster {
    public AssetType(String obid){
        super(obid);
    }
    public AssetType(AssetTypeVO vo){
        super(vo);
    }
    @Override
    public AssetTypeVO getVo(){
        return (AssetTypeVO)super.getVo();
    }
    @Override
    ...
    public void initializeAssetType(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "AssetType[toString()=" + super.toString() + "]";
    }

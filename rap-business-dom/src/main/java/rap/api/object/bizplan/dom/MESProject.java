...
import rap.api.object.bizplan.model.MESProjectVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class MESProject extends BusinessObjectMaster {
    public MESProject(String obid){
        super(obid);
    }
    public MESProject(MESProjectVO vo){
        super(vo);
    }
    @Override
    public MESProjectVO getVo(){
        return (MESProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeMESProject();
    }
    public void initializeMESProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "MESProject[toString()=" + super.toString() + "]";
    }

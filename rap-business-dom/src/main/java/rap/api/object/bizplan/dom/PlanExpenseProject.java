 ...
 * Program ID : PlanExpenseProject.java
 * ===================================================================
...
import rap.api.object.bizplan.model.PlanExpenseProjectVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PlanExpenseProject extends BusinessObjectMaster {
    public PlanExpenseProject(String obid){
        super(obid);
    }
    public PlanExpenseProject(PlanExpenseProjectVO vo){
        super(vo);
    }
    @Override
    public PlanExpenseProjectVO getVo(){
        return (PlanExpenseProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePlanExpenseProject();
    }
    public void initializePlanExpenseProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PlanExpenseProject[toString()=" + super.toString() + "]";
    }

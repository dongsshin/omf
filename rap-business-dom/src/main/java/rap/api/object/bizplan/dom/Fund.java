...
import rap.api.object.bizplan.model.FundVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class Fund extends BusinessObjectMaster {
    public Fund(String obid){
        super(obid);
    }
    public Fund(FundVO vo){
        super(vo);
    }
    @Override
    public FundVO getVo(){
        return (FundVO)super.getVo();
    }
    @Override

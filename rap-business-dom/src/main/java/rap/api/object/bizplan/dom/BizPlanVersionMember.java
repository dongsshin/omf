 ...
 * Program ID : BizPlanVersionMember.java
 * ===================================================================
...
import rap.api.object.bizplan.model.BizPlanVersionMemberVO;
import rap.api.object.organization.dom.AbstractUsers;


public class BizPlanVersionMember extends AbstractUsers {
    public BizPlanVersionMember(String obid){
        super(obid);
    }
    public BizPlanVersionMember(BizPlanVersionMemberVO vo){
        super(vo);
    }
    @Override
    public BizPlanVersionMemberVO getVo(){
        return (BizPlanVersionMemberVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeBizPlanVersionMember();
    }
    public void initializeBizPlanVersionMember(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BizPlanVersionMember[toString()=" + super.toString() + "]";
    }

...
public class AssetMinor extends BusinessObjectMaster {
    public AssetMinor(String obid){
        super(obid);
    }
    public AssetMinor(AssetMinorVO vo){
        super(vo);
    }
    @Override
    public AssetMinorVO getVo(){
        return (AssetMinorVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeAssetMinor();
    }
    public void initializeAssetMinor(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "AssetMinor[toString()=" + super.toString() + "]";
    }

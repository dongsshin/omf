 ...
 * Program ID : ManagementGroupList.java
 * ===================================================================
...
public class ManagementGroupList extends BusinessObjectMaster {
    public ManagementGroupList(String obid){
        super(obid);
    }
    public ManagementGroupList(ManagementGroupListVO vo){
        super(vo);
    }
    @Override
    public ManagementGroupListVO getVo(){
        return (ManagementGroupListVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeManagementGroupList();
    }
    public void initializeManagementGroupList(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ManagementGroupList[toString()=" + super.toString() + "]";
    }

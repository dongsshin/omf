 ...
 * Program ID : BizPlanProjectKPI.java
 * ===================================================================
...
import rap.api.object.bizplan.model.BizPlanProjectKPIVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class BizPlanProjectKPI extends BusinessObjectMaster {
    public BizPlanProjectKPI(String obid){
        super(obid);
    }
    public BizPlanProjectKPI(BizPlanProjectKPIVO vo){
        super(vo);
    }
    @Override
    public BizPlanProjectKPIVO getVo(){
        return (BizPlanProjectKPIVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeBizPlanProjectKPI();
    }
    public void initializeBizPlanProjectKPI(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BizPlanProjectKPI[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.bizplan.model.InvestProjectVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class InvestProject extends BusinessObjectMaster {
    public InvestProject(String obid){
        super(obid);
    }
    public InvestProject(InvestProjectVO vo){
        super(vo);
    }
    @Override
    public InvestProjectVO getVo(){
        return (InvestProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeInvestProject();
    }
    public void initializeInvestProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "InvestProject[toString()=" + super.toString() + "]";
    }

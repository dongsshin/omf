...
public class AssetMajor extends BusinessObjectMaster {
    public AssetMajor(String obid){
        super(obid);
    }
    public AssetMajor(AssetMajorVO vo){
        super(vo);
    }
    @Override
    public AssetMajorVO getVo(){
        return (AssetMajorVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeAssetMajor();
    }
    public void initializeAssetMajor(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "AssetMajor[toString()=" + super.toString() + "]";
    }

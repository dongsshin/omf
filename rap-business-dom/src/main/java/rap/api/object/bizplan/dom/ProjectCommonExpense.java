 ...
 * Program ID : ProjectCommonExpense.java
 * ===================================================================
...
import rap.api.object.bizplan.model.ProjectCommonExpenseVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectCommonExpense extends BusinessObjectMaster {
    public ProjectCommonExpense(String obid){
        super(obid);
    }
    public ProjectCommonExpense(ProjectCommonExpenseVO vo){
        super(vo);
    }
    @Override
    public ProjectCommonExpenseVO getVo(){
        return (ProjectCommonExpenseVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectCommonExpense();
    }
    public void initializeProjectCommonExpense(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectCommonExpense[toString()=" + super.toString() + "]";
    }

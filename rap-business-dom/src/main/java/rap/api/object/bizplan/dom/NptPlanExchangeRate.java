 ...
 * Program ID : NptPlanExchangeRate.java
 * ===================================================================
...
import rap.api.object.bizplan.model.NptPlanExchangeRateVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class NptPlanExchangeRate extends BusinessObjectMaster {
    public NptPlanExchangeRate(String obid){
        super(obid);
    }
    public NptPlanExchangeRate(NptPlanExchangeRateVO vo){
        super(vo);
    }
    @Override
    public NptPlanExchangeRateVO getVo(){
        return (NptPlanExchangeRateVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeNptPlanExchangeRate();
    }
    public void initializeNptPlanExchangeRate(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "NptPlanExchangeRate[toString()=" + super.toString() + "]";
    }

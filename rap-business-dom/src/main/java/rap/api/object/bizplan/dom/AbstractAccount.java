 ...
 * Program ID : AbstractAccount.java
 * ===================================================================
...
import rap.api.object.bizplan.model.AbstractAccountVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class AbstractAccount extends BusinessObjectMaster {
    public AbstractAccount(String obid){
        super(obid);
    }
    public AbstractAccount(AbstractAccountVO vo){
        super(vo);
    }
    @Override
    public AbstractAccountVO getVo(){
        return (AbstractAccountVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeAbstractAccount();
    }
    public void initializeAbstractAccount(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "AbstractAccount[toString()=" + super.toString() + "]";
    }

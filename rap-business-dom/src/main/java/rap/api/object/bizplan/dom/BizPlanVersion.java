 ...
 * Program ID : BizPlanVersion.java
 * ===================================================================
...
public class BizPlanVersion extends BusinessObject {
    public BizPlanVersion(String obid){
        super(obid);
    }
    public BizPlanVersion(BizPlanVersionVO vo){
        super(vo);
    }
    @Override
    public BizPlanVersionVO getVo(){
        return (BizPlanVersionVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeBizPlanVersion();
    }
    public void initializeBizPlanVersion(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BizPlanVersion[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.bizplan.model.PlanItExpenseVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PlanItExpense extends BusinessObjectMaster {
    public PlanItExpense(String obid){
        super(obid);
    }
    public PlanItExpense(PlanItExpenseVO vo){
        super(vo);
    }
    @Override
    public PlanItExpenseVO getVo(){
        return (PlanItExpenseVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePlanItExpense();
    }
    public void initializePlanItExpense(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PlanItExpense[toString()=" + super.toString() + "]";
    }

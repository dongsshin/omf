 ...
 * Program ID : InvestProjectSubGroup.java
 * ===================================================================
...
public class InvestProjectSubGroup extends BusinessObjectMaster {
    public InvestProjectSubGroup(String obid){
        super(obid);
    }
    public InvestProjectSubGroup(InvestProjectSubGroupVO vo){
        super(vo);
    }
    @Override
    public InvestProjectSubGroupVO getVo(){
        return (InvestProjectSubGroupVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeInvestProjectSubGroup();
    }
    public void initializeInvestProjectSubGroup(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "InvestProjectSubGroup[toString()=" + super.toString() + "]";
    }

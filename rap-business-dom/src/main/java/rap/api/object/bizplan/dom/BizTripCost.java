...
public class BizTripCost extends BusinessObjectMaster {
    public BizTripCost(String obid){
        super(obid);
    }
    public BizTripCost(BizTripCostVO vo){
        super(vo);
    }
    @Override
    public BizTripCostVO getVo(){
        return (BizTripCostVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeBizTripCost();
    }
    public void initializeBizTripCost(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BizTripCost[toString()=" + super.toString() + "]";
    }

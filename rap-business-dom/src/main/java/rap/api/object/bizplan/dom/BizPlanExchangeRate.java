 ...
 * Program ID : BizPlanExchangeRate.java
 * ===================================================================
...
import rap.api.object.bizplan.model.BizPlanExchangeRateVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class BizPlanExchangeRate extends BusinessObjectMaster {
    public BizPlanExchangeRate(String obid){
        super(obid);
    }
    public BizPlanExchangeRate(BizPlanExchangeRateVO vo){
        super(vo);
    }
    @Override
    public BizPlanExchangeRateVO getVo(){
        return (BizPlanExchangeRateVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeBizPlanExchangeRate();
    }
    public void initializeBizPlanExchangeRate(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BizPlanExchangeRate[toString()=" + super.toString() + "]";
    }

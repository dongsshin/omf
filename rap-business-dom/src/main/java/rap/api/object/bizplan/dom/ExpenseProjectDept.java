 ...
 * Program ID : ExpenseProjectDept.java
 * ===================================================================
...
import rap.api.object.bizplan.model.ExpenseProjectDeptVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ExpenseProjectDept extends BusinessObjectMaster {
    public ExpenseProjectDept(String obid){
        super(obid);
    }
    public ExpenseProjectDept(ExpenseProjectDeptVO vo){
        super(vo);
    }
    @Override
    public ExpenseProjectDeptVO getVo(){
        return (ExpenseProjectDeptVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeExpenseProjectDept();
    }
    public void initializeExpenseProjectDept(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ExpenseProjectDept[toString()=" + super.toString() + "]";
    }

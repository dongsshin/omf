 ...
 * Program ID : ExpenseProject.java
 * ===================================================================
...
import rap.api.object.bizplan.model.ExpenseProjectVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ExpenseProject extends BusinessObjectMaster {
    public ExpenseProject(String obid){
        super(obid);
    }
    public ExpenseProject(ExpenseProjectVO vo){
        super(vo);
    }
    @Override
    public ExpenseProjectVO getVo(){
        return (ExpenseProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeExpenseProject();
    }
    public void initializeExpenseProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ExpenseProject[toString()=" + super.toString() + "]";
    }

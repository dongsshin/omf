 ...
 * Program ID : BudgetActivity.java
 * ===================================================================
...
public class BudgetActivity extends BusinessObjectMaster {
    public BudgetActivity(String obid){
        super(obid);
    }
    public BudgetActivity(BudgetActivityVO vo){
        super(vo);
    }
    @Override
    public BudgetActivityVO getVo(){
        return (BudgetActivityVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeBudgetActivity();
    }
    public void initializeBudgetActivity(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BudgetActivity[toString()=" + super.toString() + "]";
    }

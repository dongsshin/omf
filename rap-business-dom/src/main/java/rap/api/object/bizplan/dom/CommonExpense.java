...
import rap.api.object.bizplan.model.CommonExpenseVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class CommonExpense extends BusinessObjectMaster {
    public CommonExpense(String obid){
        super(obid);
    }
    public CommonExpense(CommonExpenseVO vo){
        super(vo);
    }
    @Override
    public CommonExpenseVO getVo(){
        return (CommonExpenseVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeCommonExpense();
    }
    public void initializeCommonExpense(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "CommonExpense[toString()=" + super.toString() + "]";
    }

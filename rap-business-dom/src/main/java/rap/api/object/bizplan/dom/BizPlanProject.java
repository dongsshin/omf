 ...
 * Program ID : BizPlanProject.java
 * ===================================================================
...
public class BizPlanProject extends BusinessObject {
    public BizPlanProject(String obid){
        super(obid);
    }
    public BizPlanProject(BizPlanProjectVO vo){
        super(vo);
    }
    @Override
    public BizPlanProjectVO getVo(){
        return (BizPlanProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeBizPlanProject();
    }
    public void initializeBizPlanProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BizPlanProject[toString()=" + super.toString() + "]";
    }

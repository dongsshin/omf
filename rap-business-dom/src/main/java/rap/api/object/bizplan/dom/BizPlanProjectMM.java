 ...
 * Program ID : BizPlanProjectMM.java
 * ===================================================================
...
import rap.api.object.bizplan.model.BizPlanProjectMMVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class BizPlanProjectMM extends BusinessObjectMaster {
    public BizPlanProjectMM(String obid){
        super(obid);
    }
    public BizPlanProjectMM(BizPlanProjectMMVO vo){
        super(vo);
    }
    @Override
    public BizPlanProjectMMVO getVo(){
        return (BizPlanProjectMMVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeBizPlanProjectMM();
    }
    public void initializeBizPlanProjectMM(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BizPlanProjectMM[toString()=" + super.toString() + "]";
    }

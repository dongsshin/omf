 ...
 * Program ID : PlanBasicInvest.java
 * ===================================================================
...
import rap.api.object.bizplan.model.PlanBasicInvestVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PlanBasicInvest extends BusinessObjectMaster {
    public PlanBasicInvest(String obid){
        super(obid);
    }
    public PlanBasicInvest(PlanBasicInvestVO vo){
        super(vo);
    }
    @Override
    public PlanBasicInvestVO getVo(){
        return (PlanBasicInvestVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePlanBasicInvest();
    }
    public void initializePlanBasicInvest(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PlanBasicInvest[toString()=" + super.toString() + "]";
    }

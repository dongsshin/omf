 ...
 * Program ID : BizPlanJobGrade.java
 * ===================================================================
...
import rap.api.object.bizplan.model.BizPlanJobGradeVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class BizPlanJobGrade extends BusinessObjectMaster {
    public BizPlanJobGrade(String obid){
        super(obid);
    }
    public BizPlanJobGrade(BizPlanJobGradeVO vo){
        super(vo);
    }
    @Override
    public BizPlanJobGradeVO getVo(){
        return (BizPlanJobGradeVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeBizPlanJobGrade();
    }
    public void initializeBizPlanJobGrade(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BizPlanJobGrade[toString()=" + super.toString() + "]";
    }

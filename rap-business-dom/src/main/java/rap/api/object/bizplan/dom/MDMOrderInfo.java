...
import rap.api.object.bizplan.model.MDMOrderInfoVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class MDMOrderInfo extends BusinessObjectMaster {
    public MDMOrderInfo(String obid){
        super(obid);
    }
    public MDMOrderInfo(MDMOrderInfoVO vo){
        super(vo);
    }
    @Override
    public MDMOrderInfoVO getVo(){
        return (MDMOrderInfoVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeMDMOrderInfo();
    }
    public void initializeMDMOrderInfo(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "MDMOrderInfo[toString()=" + super.toString() + "]";
    }

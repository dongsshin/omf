...
import rap.api.object.bizplan.model.BizPlanYearVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class BizPlanYear extends BusinessObjectMaster {
    public BizPlanYear(String obid){
        super(obid);
    }
    public BizPlanYear(BizPlanYearVO vo){
        super(vo);
    }
    @Override
    public BizPlanYearVO getVo(){
        return (BizPlanYearVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeBizPlanYear();
    }
    public void initializeBizPlanYear(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BizPlanYear[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : PlanLaborUnitCost.java
 * ===================================================================
...
import rap.api.object.bizplan.model.PlanLaborUnitCostVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PlanLaborUnitCost extends BusinessObjectMaster {
    public PlanLaborUnitCost(String obid){
        super(obid);
    }
    public PlanLaborUnitCost(PlanLaborUnitCostVO vo){
        super(vo);
    }
    @Override
    public PlanLaborUnitCostVO getVo(){
        return (PlanLaborUnitCostVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePlanLaborUnitCost();
    }
    public void initializePlanLaborUnitCost(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PlanLaborUnitCost[toString()=" + super.toString() + "]";
    }

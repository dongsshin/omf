 ...
 * Program ID : PlanExpenseProjectDept.java
 * ===================================================================
...
import rap.api.object.bizplan.model.PlanExpenseProjectDeptVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PlanExpenseProjectDept extends BusinessObjectMaster {
    public PlanExpenseProjectDept(String obid){
        super(obid);
    }
    public PlanExpenseProjectDept(PlanExpenseProjectDeptVO vo){
        super(vo);
    }
    @Override
    public PlanExpenseProjectDeptVO getVo(){
        return (PlanExpenseProjectDeptVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePlanExpenseProjectDept();
    }
    public void initializePlanExpenseProjectDept(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PlanExpenseProjectDept[toString()=" + super.toString() + "]";
    }

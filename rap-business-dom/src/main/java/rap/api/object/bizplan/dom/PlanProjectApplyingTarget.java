 ...
 * Program ID : PlanProjectApplyingTarget.java
 * ===================================================================
...
import rap.api.object.bizplan.model.PlanProjectApplyingTargetVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PlanProjectApplyingTarget extends BusinessObjectMaster {
    public PlanProjectApplyingTarget(String obid){
        super(obid);
    }
    public PlanProjectApplyingTarget(PlanProjectApplyingTargetVO vo){
        super(vo);
    }
    @Override
    public PlanProjectApplyingTargetVO getVo(){
        return (PlanProjectApplyingTargetVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePlanProjectApplyingTarget();
    }
    public void initializePlanProjectApplyingTarget(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PlanProjectApplyingTarget[toString()=" + super.toString() + "]";
    }

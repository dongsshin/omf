 ...
 * Program ID : InvestProjectGroup.java
 * ===================================================================
...
import rap.api.object.bizplan.model.InvestProjectGroupVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class InvestProjectGroup extends BusinessObjectMaster {
    public InvestProjectGroup(String obid){
        super(obid);
    }
    public InvestProjectGroup(InvestProjectGroupVO vo){
        super(vo);
    }
    @Override
    public InvestProjectGroupVO getVo(){
        return (InvestProjectGroupVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeInvestProjectGroup();
    }
    public void initializeInvestProjectGroup(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "InvestProjectGroup[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : PartProjectExcelPerson.java
 * ===================================================================
...
import rap.api.object.partproject.model.PartProjectExcelPersonVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PartProjectExcelPerson extends BusinessObjectMaster {
    public PartProjectExcelPerson(String obid){
        super(obid);
    }
    public PartProjectExcelPerson(PartProjectExcelPersonVO vo){
        super(vo);
    }
    @Override
    public PartProjectExcelPersonVO getVo(){
        return (PartProjectExcelPersonVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartProjectExcelPerson();
    }
    public void initializePartProjectExcelPerson(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartProjectExcelPerson[toString()=" + super.toString() + "]";
    }

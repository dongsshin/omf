 ...
 * Program ID : PartProjectFullMaster.java
 * ===================================================================
...
import rap.api.object.partproject.model.PartProjectFullMasterVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PartProjectFullMaster extends BusinessObjectMaster {
    public PartProjectFullMaster(String obid){
        super(obid);
    }
    public PartProjectFullMaster(PartProjectFullMasterVO vo){
        super(vo);
    }
    @Override
    public PartProjectFullMasterVO getVo(){
        return (PartProjectFullMasterVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartProjectFullMaster();
    }
    public void initializePartProjectFullMaster(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartProjectFullMaster[toString()=" + super.toString() + "]";
    }

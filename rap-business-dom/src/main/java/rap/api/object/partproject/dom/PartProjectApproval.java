 ...
 * Program ID : PartProjectApproval.java
 * ===================================================================
...
import rap.api.object.partproject.model.PartProjectApprovalVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PartProjectApproval extends BusinessObjectMaster {
    public PartProjectApproval(String obid){
        super(obid);
    }
    public PartProjectApproval(PartProjectApprovalVO vo){
        super(vo);
    }
    @Override
    public PartProjectApprovalVO getVo(){
        return (PartProjectApprovalVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartProjectApproval();
    }
    public void initializePartProjectApproval(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartProjectApproval[toString()=" + super.toString() + "]";
    }

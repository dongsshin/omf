...
import rap.api.object.partproject.model.NewPartNoVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class NewPartNo extends BusinessObjectMaster {
    public NewPartNo(String obid){
        super(obid);
    }
    public NewPartNo(NewPartNoVO vo){
        super(vo);
    }
    @Override
    public NewPartNoVO getVo(){
        return (NewPartNoVO)super.getVo();
    }
    @Override
    ...
    public void initializeNewPartNo(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "NewPartNo[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : PartProjectMembersRev.java
 * ===================================================================
...
import rap.api.object.partproject.model.PartProjectMembersRevVO;
import com.rap.omc.api.object.dom.BusinessObject;


public class PartProjectMembersRev extends BusinessObject {
    public PartProjectMembersRev(String obid){
        super(obid);
    }
    public PartProjectMembersRev(PartProjectMembersRevVO vo){
        super(vo);
    }
    @Override
    public PartProjectMembersRevVO getVo(){
        return (PartProjectMembersRevVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartProjectMembersRev();
    }
    public void initializePartProjectMembersRev(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartProjectMembersRev[toString()=" + super.toString() + "]";
    }

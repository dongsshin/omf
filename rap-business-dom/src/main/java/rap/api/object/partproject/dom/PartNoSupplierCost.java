 ...
 * Program ID : PartNoSupplierCost.java
 * ===================================================================
...
import rap.api.object.partproject.model.PartNoSupplierCostVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PartNoSupplierCost extends BusinessObjectMaster {
    public PartNoSupplierCost(String obid){
        super(obid);
    }
    public PartNoSupplierCost(PartNoSupplierCostVO vo){
        super(vo);
    }
    @Override
    public PartNoSupplierCostVO getVo(){
        return (PartNoSupplierCostVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartNoSupplierCost();
    }
    public void initializePartNoSupplierCost(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartNoSupplierCost[toString()=" + super.toString() + "]";
    }

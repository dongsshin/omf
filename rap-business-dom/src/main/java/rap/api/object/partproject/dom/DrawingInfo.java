...
import rap.api.object.partproject.model.DrawingInfoVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class DrawingInfo extends BusinessObjectMaster {
    public DrawingInfo(String obid){
        super(obid);
    }
    public DrawingInfo(DrawingInfoVO vo){
        super(vo);
    }
    @Override
    public DrawingInfoVO getVo(){
        return (DrawingInfoVO)super.getVo();
    }
    @Override
    ...
    public void initializeDrawingInfo(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DrawingInfo[toString()=" + super.toString() + "]";
    }

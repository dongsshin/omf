 ...
 * Program ID : PartProjectEventYield.java
 * ===================================================================
...
import rap.api.object.partproject.model.PartProjectEventYieldVO;
import com.rap.omc.api.object.dom.BusinessObject;


public class PartProjectEventYield extends BusinessObject {
    public PartProjectEventYield(String obid){
        super(obid);
    }
    public PartProjectEventYield(PartProjectEventYieldVO vo){
        super(vo);
    }
    @Override
    public PartProjectEventYieldVO getVo(){
        return (PartProjectEventYieldVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartProjectEventYield();
    }
    public void initializePartProjectEventYield(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartProjectEventYield[toString()=" + super.toString() + "]";
    }

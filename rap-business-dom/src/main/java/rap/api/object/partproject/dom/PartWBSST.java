...
import rap.api.object.partproject.model.PartWBSSTVO;
import com.rap.omc.api.object.dom.BusinessObject;


public class PartWBSST extends BusinessObject {
    public PartWBSST(String obid){
        super(obid);
    }
    public PartWBSST(PartWBSSTVO vo){
        super(vo);
    }
    @Override
    public PartWBSSTVO getVo(){
        return (PartWBSSTVO)super.getVo();
    }
    @Override
    ...
    public void initializePartWBSST(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartWBSST[toString()=" + super.toString() + "]";
    }

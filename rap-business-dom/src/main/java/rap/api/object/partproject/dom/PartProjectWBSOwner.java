 ...
 * Program ID : PartProjectWBSOwner.java
 * ===================================================================
...
import rap.api.object.partproject.model.PartProjectWBSOwnerVO;
import com.rap.omc.api.object.dom.BusinessObject;


public class PartProjectWBSOwner extends BusinessObject {
    public PartProjectWBSOwner(String obid){
        super(obid);
    }
    public PartProjectWBSOwner(PartProjectWBSOwnerVO vo){
        super(vo);
    }
    @Override
    public PartProjectWBSOwnerVO getVo(){
        return (PartProjectWBSOwnerVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartProjectWBSOwner();
    }
    public void initializePartProjectWBSOwner(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartProjectWBSOwner[toString()=" + super.toString() + "]";
    }

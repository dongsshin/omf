 ...
 * Program ID : PartProjectWBSRev.java
 * ===================================================================
...
import rap.api.object.partproject.model.PartProjectWBSRevVO;
import com.rap.omc.api.object.dom.BusinessObject;


public class PartProjectWBSRev extends BusinessObject {
    public PartProjectWBSRev(String obid){
        super(obid);
    }
    public PartProjectWBSRev(PartProjectWBSRevVO vo){
        super(vo);
    }
    @Override
    public PartProjectWBSRevVO getVo(){
        return (PartProjectWBSRevVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartProjectWBSRev();
    }
    public void initializePartProjectWBSRev(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartProjectWBSRev[toString()=" + super.toString() + "]";
    }

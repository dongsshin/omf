 ...
 * Program ID : PartDevelopmentRequest.java
 * ===================================================================
...
import rap.api.object.partproject.model.PartDevelopmentRequestVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PartDevelopmentRequest extends BusinessObjectMaster {
    public PartDevelopmentRequest(String obid){
        super(obid);
    }
    public PartDevelopmentRequest(PartDevelopmentRequestVO vo){
        super(vo);
    }
    @Override
    public PartDevelopmentRequestVO getVo(){
        return (PartDevelopmentRequestVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartDevelopmentRequest();
    }
    public void initializePartDevelopmentRequest(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartDevelopmentRequest[toString()=" + super.toString() + "]";
    }

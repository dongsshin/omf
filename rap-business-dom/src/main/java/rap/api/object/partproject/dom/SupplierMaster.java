 ...
 * Program ID : SupplierMaster.java
 * ===================================================================
...
import rap.api.object.partproject.model.SupplierMasterVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class SupplierMaster extends BusinessObjectMaster {
    public SupplierMaster(String obid){
        super(obid);
    }
    public SupplierMaster(SupplierMasterVO vo){
        super(vo);
    }
    @Override
    public SupplierMasterVO getVo(){
        return (SupplierMasterVO)super.getVo();
    }
    @Override
    ...
    public void initializeSupplierMaster(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "SupplierMaster[toString()=" + super.toString() + "]";
    }

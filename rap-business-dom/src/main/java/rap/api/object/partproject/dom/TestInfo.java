...
import rap.api.object.partproject.model.TestInfoVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class TestInfo extends BusinessObjectMaster {
    public TestInfo(String obid){
        super(obid);
    }
    public TestInfo(TestInfoVO vo){
        super(vo);
    }
    @Override
    public TestInfoVO getVo(){
        return (TestInfoVO)super.getVo();
    }
    @Override
    ...
    public String toString() {
        return "TestInfo[toString()=" + super.toString() + "]";
    }

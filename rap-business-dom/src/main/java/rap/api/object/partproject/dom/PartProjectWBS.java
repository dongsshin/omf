 ...
 * Program ID : PartProjectWBS.java
 * ===================================================================
...
import rap.api.object.partproject.model.PartProjectWBSVO;
import com.rap.omc.api.object.dom.BusinessObject;


public class PartProjectWBS extends BusinessObject {
    public PartProjectWBS(String obid){
        super(obid);
    }
    public PartProjectWBS(PartProjectWBSVO vo){
        super(vo);
    }
    @Override
    public PartProjectWBSVO getVo(){
        return (PartProjectWBSVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartProjectWBS();
    }
    public void initializePartProjectWBS(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartProjectWBS[toString()=" + super.toString() + "]";
    }

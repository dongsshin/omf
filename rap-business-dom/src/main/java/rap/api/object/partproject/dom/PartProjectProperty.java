 ...
 * Program ID : PartProjectProperty.java
 * ===================================================================
...
import rap.api.object.partproject.model.PartProjectPropertyVO;
import com.rap.omc.api.object.dom.BusinessObject;


public class PartProjectProperty extends BusinessObject {
    public PartProjectProperty(String obid){
        super(obid);
    }
    public PartProjectProperty(PartProjectPropertyVO vo){
        super(vo);
    }
    @Override
    public PartProjectPropertyVO getVo(){
        return (PartProjectPropertyVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartProjectProperty();
    }
    public void initializePartProjectProperty(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartProjectProperty[toString()=" + super.toString() + "]";
    }

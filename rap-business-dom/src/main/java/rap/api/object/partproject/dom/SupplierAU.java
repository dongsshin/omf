...
import rap.api.object.partproject.model.SupplierAUVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class SupplierAU extends BusinessObjectMaster {
    public SupplierAU(String obid){
        super(obid);
    }
    public SupplierAU(SupplierAUVO vo){
        super(vo);
    }
    @Override
    public SupplierAUVO getVo(){
        return (SupplierAUVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeSupplierAU();
    }
    public void initializeSupplierAU(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "SupplierAU[toString()=" + super.toString() + "]";
    }

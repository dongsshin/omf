 ...
 * Program ID : PartProjectMembers.java
 * ===================================================================
...
import rap.api.object.partproject.model.PartProjectMembersVO;
import com.rap.omc.api.object.dom.BusinessObject;


public class PartProjectMembers extends BusinessObject {
    public PartProjectMembers(String obid){
        super(obid);
    }
    public PartProjectMembers(PartProjectMembersVO vo){
        super(vo);
    }
    @Override
    public PartProjectMembersVO getVo(){
        return (PartProjectMembersVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartProjectMembers();
    }
    public void initializePartProjectMembers(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartProjectMembers[toString()=" + super.toString() + "]";
    }

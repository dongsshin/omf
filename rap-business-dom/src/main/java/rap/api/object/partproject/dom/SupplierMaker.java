...
import rap.api.object.partproject.model.SupplierMakerVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class SupplierMaker extends BusinessObjectMaster {
    public SupplierMaker(String obid){
        super(obid);
    }
    public SupplierMaker(SupplierMakerVO vo){
        super(vo);
    }
    @Override
    public SupplierMakerVO getVo(){
        return (SupplierMakerVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeSupplierMaker();
    }
    public void initializeSupplierMaker(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "SupplierMaker[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.partproject.model.MoldScheduleVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class MoldSchedule extends BusinessObjectMaster {
    public MoldSchedule(String obid){
        super(obid);
    }
    public MoldSchedule(MoldScheduleVO vo){
        super(vo);
    }
    @Override
    public MoldScheduleVO getVo(){
        return (MoldScheduleVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeMoldSchedule();
    }
    public void initializeMoldSchedule(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "MoldSchedule[toString()=" + super.toString() + "]";
    }

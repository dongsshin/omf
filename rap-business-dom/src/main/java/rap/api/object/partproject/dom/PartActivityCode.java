 ...
 * Program ID : PartActivityCode.java
 * ===================================================================
...
import rap.api.object.partproject.model.PartActivityCodeVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PartActivityCode extends BusinessObjectMaster {
    public PartActivityCode(String obid){
        super(obid);
    }
    public PartActivityCode(PartActivityCodeVO vo){
        super(vo);
    }
    @Override
    public PartActivityCodeVO getVo(){
        return (PartActivityCodeVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartActivityCode();
    }
    public void initializePartActivityCode(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartActivityCode[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.partproject.model.PartProjectsVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PartProjects extends BusinessObjectMaster {
    public PartProjects(String obid){
        super(obid);
    }
    public PartProjects(PartProjectsVO vo){
        super(vo);
    }
    @Override
    public PartProjectsVO getVo(){
        return (PartProjectsVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartProjects();
    }
    public void initializePartProjects(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartProjects[toString()=" + super.toString() + "]";
    }

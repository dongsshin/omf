 ...
 * Program ID : PartProjectIssue.java
 * ===================================================================
...
import rap.api.object.partproject.model.PartProjectIssueVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PartProjectIssue extends BusinessObjectMaster {
    public PartProjectIssue(String obid){
        super(obid);
    }
    public PartProjectIssue(PartProjectIssueVO vo){
        super(vo);
    }
    @Override
    public PartProjectIssueVO getVo(){
        return (PartProjectIssueVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartProjectIssue();
    }
    public void initializePartProjectIssue(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartProjectIssue[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : PartProjectExcel.java
 * ===================================================================
...
import rap.api.object.partproject.model.PartProjectExcelVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PartProjectExcel extends BusinessObjectMaster {
    public PartProjectExcel(String obid){
        super(obid);
    }
    public PartProjectExcel(PartProjectExcelVO vo){
        super(vo);
    }
    @Override
    public PartProjectExcelVO getVo(){
        return (PartProjectExcelVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartProjectExcel();
    }
    public void initializePartProjectExcel(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartProjectExcel[toString()=" + super.toString() + "]";
    }

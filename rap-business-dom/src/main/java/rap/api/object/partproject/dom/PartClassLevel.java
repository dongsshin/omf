 ...
 * Program ID : PartClassLevel.java
 * ===================================================================
...
import rap.api.object.partproject.model.PartClassLevelVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PartClassLevel extends BusinessObjectMaster {
    public PartClassLevel(String obid){
        super(obid);
    }
    public PartClassLevel(PartClassLevelVO vo){
        super(vo);
    }
    @Override
    public PartClassLevelVO getVo(){
        return (PartClassLevelVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartClassLevel();
    }
    public void initializePartClassLevel(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartClassLevel[toString()=" + super.toString() + "]";
    }

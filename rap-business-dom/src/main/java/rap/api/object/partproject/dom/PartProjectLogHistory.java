 ...
 * Program ID : PartProjectLogHistory.java
 * ===================================================================
...
import rap.api.object.partproject.model.PartProjectLogHistoryVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PartProjectLogHistory extends BusinessObjectMaster {
    public PartProjectLogHistory(String obid){
        super(obid);
    }
    public PartProjectLogHistory(PartProjectLogHistoryVO vo){
        super(vo);
    }
    @Override
    public PartProjectLogHistoryVO getVo(){
        return (PartProjectLogHistoryVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartProjectLogHistory();
    }
    public void initializePartProjectLogHistory(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartProjectLogHistory[toString()=" + super.toString() + "]";
    }

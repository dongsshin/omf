 ...
 * Program ID : PartProdActivityCode.java
 * ===================================================================
...
import rap.api.object.partproject.model.PartProdActivityCodeVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PartProdActivityCode extends BusinessObjectMaster {
    public PartProdActivityCode(String obid){
        super(obid);
    }
    public PartProdActivityCode(PartProdActivityCodeVO vo){
        super(vo);
    }
    @Override
    public PartProdActivityCodeVO getVo(){
        return (PartProdActivityCodeVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartProdActivityCode();
    }
    public void initializePartProdActivityCode(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartProdActivityCode[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : PartProjectIssueFollowUp.java
 * ===================================================================
 *  Modification Date      Modifier           Description
 *      2017.04.??       DS Shin            Initial
 * ===================================================================
 */
package rap.api.object.partproject.dom;


import java.util.Map;
import rap.api.object.partproject.model.PartProjectIssueFollowUpVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PartProjectIssueFollowUp extends BusinessObjectMaster {
    public PartProjectIssueFollowUp(String obid){
        super(obid);
    }
    public PartProjectIssueFollowUp(PartProjectIssueFollowUpVO vo){
        super(vo);
    }
    @Override
    public PartProjectIssueFollowUpVO getVo(){
        return (PartProjectIssueFollowUpVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartProjectIssueFollowUp();
    }
    public void initializePartProjectIssueFollowUp(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartProjectIssueFollowUp[toString()=" + super.toString() + "]";
    }

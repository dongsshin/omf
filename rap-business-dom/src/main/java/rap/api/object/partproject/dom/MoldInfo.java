...
import rap.api.object.partproject.model.MoldInfoVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class MoldInfo extends BusinessObjectMaster {
    public MoldInfo(String obid){
        super(obid);
    }
    public MoldInfo(MoldInfoVO vo){
        super(vo);
    }
    @Override
    public MoldInfoVO getVo(){
        return (MoldInfoVO)super.getVo();
    }
    @Override
    ...
    public void initializeMoldInfo(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "MoldInfo[toString()=" + super.toString() + "]";
    }

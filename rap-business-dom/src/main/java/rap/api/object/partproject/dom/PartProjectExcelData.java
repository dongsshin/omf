 ...
 * Program ID : PartProjectExcelData.java
 * ===================================================================
...
import rap.api.object.partproject.model.PartProjectExcelDataVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PartProjectExcelData extends BusinessObjectMaster {
    public PartProjectExcelData(String obid){
        super(obid);
    }
    public PartProjectExcelData(PartProjectExcelDataVO vo){
        super(vo);
    }
    @Override
    public PartProjectExcelDataVO getVo(){
        return (PartProjectExcelDataVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartProjectExcelData();
    }
    public void initializePartProjectExcelData(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartProjectExcelData[toString()=" + super.toString() + "]";
    }

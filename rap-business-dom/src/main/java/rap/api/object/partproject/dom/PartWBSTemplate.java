 ...
 * Program ID : PartWBSTemplate.java
 * ===================================================================
...
import rap.api.object.partproject.model.PartWBSTemplateVO;
import com.rap.omc.api.object.dom.BusinessObject;


public class PartWBSTemplate extends BusinessObject {
    public PartWBSTemplate(String obid){
        super(obid);
    }
    public PartWBSTemplate(PartWBSTemplateVO vo){
        super(vo);
    }
    @Override
    public PartWBSTemplateVO getVo(){
        return (PartWBSTemplateVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartWBSTemplate();
    }
    public void initializePartWBSTemplate(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartWBSTemplate[toString()=" + super.toString() + "]";
    }

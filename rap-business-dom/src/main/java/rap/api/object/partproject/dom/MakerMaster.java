...
import rap.api.object.partproject.model.MakerMasterVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class MakerMaster extends BusinessObjectMaster {
    public MakerMaster(String obid){
        super(obid);
    }
    public MakerMaster(MakerMasterVO vo){
        super(vo);
    }
    @Override
    public MakerMasterVO getVo(){
        return (MakerMasterVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeMakerMaster();
    }
    public void initializeMakerMaster(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "MakerMaster[toString()=" + super.toString() + "]";
    }

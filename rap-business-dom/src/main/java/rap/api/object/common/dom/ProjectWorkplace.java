 ...
 * Program ID : ProjectWorkplace.java
 * ===================================================================
...
public class ProjectWorkplace extends Workplace {
    public ProjectWorkplace(String obid){
        super(obid);
    }
    public ProjectWorkplace(ProjectWorkplaceVO vo){
        super(vo);
    }
    @Override
    public ProjectWorkplaceVO getVo(){
        return (ProjectWorkplaceVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectWorkplace();
    }
    public void initializeProjectWorkplace(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectWorkplace[toString()=" + super.toString() + "]";
    }

...
public class MailSendLog extends BusinessObjectMaster {
    public MailSendLog(String obid){
        super(obid);
    }
    public MailSendLog(MailSendLogVO vo){
        super(vo);
    }
    @Override
    public MailSendLogVO getVo(){
        return (MailSendLogVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeMailSendLog();
    }
    public void initializeMailSendLog(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "MailSendLog[toString()=" + super.toString() + "]";
    }

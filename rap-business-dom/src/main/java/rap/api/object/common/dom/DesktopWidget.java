...
import rap.api.object.common.dom.DesktopItem;


public class DesktopWidget extends DesktopItem {
    public DesktopWidget(String obid){
        super(obid);
    }
    public DesktopWidget(DesktopWidgetVO vo){
        super(vo);
    }
    @Override
    public DesktopWidgetVO getVo(){
        return (DesktopWidgetVO)super.getVo();
    }
    @Override
    ...
    public void initializeDesktopWidget(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DesktopWidget[toString()=" + super.toString() + "]";
    }

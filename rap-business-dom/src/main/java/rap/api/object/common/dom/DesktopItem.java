...
public class DesktopItem extends BusinessObjectMaster {
    public DesktopItem(String obid){
        super(obid);
    }
    public DesktopItem(DesktopItemVO vo){
        super(vo);
    }
    @Override
    public DesktopItemVO getVo(){
        return (DesktopItemVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDesktopItem();
    }
    public void initializeDesktopItem(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DesktopItem[toString()=" + super.toString() + "]";
    }

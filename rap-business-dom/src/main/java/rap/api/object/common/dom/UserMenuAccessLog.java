 ...
 * Program ID : UserMenuAccessLog.java
 * ===================================================================
...
import rap.api.object.common.model.UserMenuAccessLogVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class UserMenuAccessLog extends BusinessObjectMaster {
    public UserMenuAccessLog(String obid){
        super(obid);
    }
    public UserMenuAccessLog(UserMenuAccessLogVO vo){
        super(vo);
    }
    @Override
    public UserMenuAccessLogVO getVo(){
        return (UserMenuAccessLogVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeUserMenuAccessLog();
    }
    public void initializeUserMenuAccessLog(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "UserMenuAccessLog[toString()=" + super.toString() + "]";
    }

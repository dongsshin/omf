...
import rap.api.object.common.model.CountryVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class Country extends BusinessObjectMaster {
    public Country(String obid){
        super(obid);
    }
    public Country(CountryVO vo){
        super(vo);
    }
    @Override

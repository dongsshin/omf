...
import rap.api.object.common.model.TemplateVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class Template extends BusinessObjectMaster {
    public Template(String obid){
        super(obid);
    }
    public Template(TemplateVO vo){
        super(vo);
    }
    @Override
    public TemplateVO getVo(){
        return (TemplateVO)super.getVo();
    }
    @Override
    ...
    public String toString() {
        return "Template[toString()=" + super.toString() + "]";
    }

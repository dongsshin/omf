 ...
 * Program ID : ProgramContextProject.java
 * ===================================================================
...
import rap.api.object.common.model.ProgramContextProjectVO;
import rap.api.object.common.dom.Workplace;


public class ProgramContextProject extends Workplace {
    public ProgramContextProject(String obid){
        super(obid);
    }
    public ProgramContextProject(ProgramContextProjectVO vo){
        super(vo);
    }
    @Override
    public ProgramContextProjectVO getVo(){
        return (ProgramContextProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProgramContextProject();
    }
    public void initializeProgramContextProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProgramContextProject[toString()=" + super.toString() + "]";
    }

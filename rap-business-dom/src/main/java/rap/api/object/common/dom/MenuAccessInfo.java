 ...
 * Program ID : MenuAccessInfo.java
 * ===================================================================
...
import rap.api.object.common.model.MenuAccessInfoVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class MenuAccessInfo extends BusinessObjectMaster {
    public MenuAccessInfo(String obid){
        super(obid);
    }
    public MenuAccessInfo(MenuAccessInfoVO vo){
        super(vo);
    }
    @Override
    public MenuAccessInfoVO getVo(){
        return (MenuAccessInfoVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeMenuAccessInfo();
    }
    public void initializeMenuAccessInfo(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "MenuAccessInfo[toString()=" + super.toString() + "]";
    }

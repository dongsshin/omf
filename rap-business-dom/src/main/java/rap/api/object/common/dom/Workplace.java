...
import rap.api.object.common.model.WorkplaceVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class Workplace extends BusinessObjectMaster {
    public Workplace(String obid){
        super(obid);
    }
    public Workplace(WorkplaceVO vo){
        super(vo);
    }
    @Override
    public WorkplaceVO getVo(){
        return (WorkplaceVO)super.getVo();
    }
    @Override
    ...
    public String toString() {
        return "Workplace[toString()=" + super.toString() + "]";
    }

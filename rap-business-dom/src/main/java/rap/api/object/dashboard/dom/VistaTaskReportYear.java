 ...
 * Program ID : VistaTaskReportYear.java
 * ===================================================================
 *  Modification Date      Modifier           Description
 *      2017.04.??       DS Shin            Initial
 * ===================================================================
 */
package rap.api.object.dashboard.dom;


import java.util.Map;
import rap.api.object.dashboard.model.VistaTaskReportYearVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class VistaTaskReportYear extends BusinessObjectMaster {
    public VistaTaskReportYear(String obid){
        super(obid);
    }
    public VistaTaskReportYear(VistaTaskReportYearVO vo){
        super(vo);
    }
    @Override
    public VistaTaskReportYearVO getVo(){
        return (VistaTaskReportYearVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeVistaTaskReportYear();
    }
    public void initializeVistaTaskReportYear(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "VistaTaskReportYear[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : DocumentLibrary.java
 * ===================================================================
 *  Modification Date      Modifier           Description
 *      2017.04.??       DS Shin            Initial
 * ===================================================================
 */
package rap.api.object.classification.dom;


import java.util.Map;
import rap.api.object.classification.model.DocumentLibraryVO;
import rap.api.object.classification.dom.Classifications;


public class DocumentLibrary extends Classifications {
    public DocumentLibrary(String obid){
        super(obid);
    }
    public DocumentLibrary(DocumentLibraryVO vo){
        super(vo);
    }
    @Override
    public DocumentLibraryVO getVo(){
        return (DocumentLibraryVO)super.getVo();
    }
    @Override
    ...
    public void initializeDocumentLibrary(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DocumentLibrary[toString()=" + super.toString() + "]";
    }

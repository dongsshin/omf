...
import rap.api.object.classification.model.LibrariesVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class Libraries extends BusinessObjectMaster {
    public Libraries(String obid){
        super(obid);
    }
    public Libraries(LibrariesVO vo){
        super(vo);
    }
    @Override
    public LibrariesVO getVo(){
        return (LibrariesVO)super.getVo();
    }
    @Override
    ...
    public String toString() {
        return "Libraries[toString()=" + super.toString() + "]";
    }

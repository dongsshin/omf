...
import rap.api.object.classification.model.BookShelfVO;
import rap.api.object.classification.dom.Libraries;


public class BookShelf extends Libraries {
    public BookShelf(String obid){
        super(obid);
    }
    public BookShelf(BookShelfVO vo){
        super(vo);
    }
    @Override
    public BookShelfVO getVo(){
        return (BookShelfVO)super.getVo();
    }
    @Override
    ...
    public String toString() {
        return "BookShelf[toString()=" + super.toString() + "]";
    }

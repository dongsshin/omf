 ...
 * Program ID : Classifications.java
 * ===================================================================
...
import rap.api.object.classification.model.ClassificationsVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class Classifications extends BusinessObjectMaster {
    public Classifications(String obid){
        super(obid);
    }
    public Classifications(ClassificationsVO vo){
        super(vo);
    }
    @Override
    public ClassificationsVO getVo(){
        return (ClassificationsVO)super.getVo();
    }
    @Override
    ...
    public String toString() {
        return "Classifications[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : DesignRequestsSchedule.java
 * ===================================================================
...
import rap.api.object.requests.model.DesignRequestsScheduleVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class DesignRequestsSchedule extends BusinessObjectMaster {
    public DesignRequestsSchedule(String obid){
        super(obid);
    }
    public DesignRequestsSchedule(DesignRequestsScheduleVO vo){
        super(vo);
    }
    @Override
    public DesignRequestsScheduleVO getVo(){
        return (DesignRequestsScheduleVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDesignRequestsSchedule();
    }
    public void initializeDesignRequestsSchedule(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DesignRequestsSchedule[toString()=" + super.toString() + "]";
    }

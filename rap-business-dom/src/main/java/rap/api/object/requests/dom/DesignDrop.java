...
import rap.api.object.requests.model.DesignDropVO;
import rap.api.object.requests.dom.DesignChangeDrop;


public class DesignDrop extends DesignChangeDrop {
    public DesignDrop(String obid){
        super(obid);
    }
    public DesignDrop(DesignDropVO vo){
        super(vo);
    }
    @Override
    public DesignDropVO getVo(){
        return (DesignDropVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDesignDrop();
    }
    public void initializeDesignDrop(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DesignDrop[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : DesignRequestsSpeakerInfo.java
 * ===================================================================
 *  Modification Date      Modifier           Description
 *      2017.04.??       DS Shin            Initial
 * ===================================================================
 */
package rap.api.object.requests.dom;


import java.util.Map;
import rap.api.object.requests.model.DesignRequestsSpeakerInfoVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class DesignRequestsSpeakerInfo extends BusinessObjectMaster {
    public DesignRequestsSpeakerInfo(String obid){
        super(obid);
    }
    public DesignRequestsSpeakerInfo(DesignRequestsSpeakerInfoVO vo){
        super(vo);
    }
    @Override
    public DesignRequestsSpeakerInfoVO getVo(){
        return (DesignRequestsSpeakerInfoVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDesignRequestsSpeakerInfo();
    }
    public void initializeDesignRequestsSpeakerInfo(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DesignRequestsSpeakerInfo[toString()=" + super.toString() + "]";
    }

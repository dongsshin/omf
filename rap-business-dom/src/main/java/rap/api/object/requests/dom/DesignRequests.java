 ...
 * Program ID : DesignRequests.java
 * ===================================================================
...
import rap.api.object.requests.model.DesignRequestsVO;
import rap.api.object.requests.dom.DesignProcess;


public class DesignRequests extends DesignProcess {
    public DesignRequests(String obid){
        super(obid);
    }
    public DesignRequests(DesignRequestsVO vo){
        super(vo);
    }
    @Override
    public DesignRequestsVO getVo(){
        return (DesignRequestsVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDesignRequests();
    }
    public void initializeDesignRequests(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DesignRequests[toString()=" + super.toString() + "]";
    }

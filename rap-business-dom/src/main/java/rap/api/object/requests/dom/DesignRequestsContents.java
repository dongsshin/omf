 ...
 * Program ID : DesignRequestsContents.java
 * ===================================================================
...
import rap.api.object.requests.model.DesignRequestsContentsVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class DesignRequestsContents extends BusinessObjectMaster {
    public DesignRequestsContents(String obid){
        super(obid);
    }
    public DesignRequestsContents(DesignRequestsContentsVO vo){
        super(vo);
    }
    @Override
    public DesignRequestsContentsVO getVo(){
        return (DesignRequestsContentsVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDesignRequestsContents();
    }
    public void initializeDesignRequestsContents(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DesignRequestsContents[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.requests.model.DesignChangeVO;
import rap.api.object.requests.dom.DesignChangeDrop;


public class DesignChange extends DesignChangeDrop {
    public DesignChange(String obid){
        super(obid);
    }
    public DesignChange(DesignChangeVO vo){
        super(vo);
    }
    @Override
    public DesignChangeVO getVo(){
        return (DesignChangeVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDesignChange();
    }
    public void initializeDesignChange(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DesignChange[toString()=" + super.toString() + "]";
    }

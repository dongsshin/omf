...
public class Requests extends BusinessObjectMaster {
    public Requests(String obid){
        super(obid);
    }
    public Requests(RequestsVO vo){
        super(vo);
    }
    @Override
    public RequestsVO getVo(){
        return (RequestsVO)super.getVo();
    }
    @Override
    ...
    public String toString() {
        return "Requests[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.requests.dom.Requests;


public class DesignProcess extends Requests {
    public DesignProcess(String obid){
        super(obid);
    }
    public DesignProcess(DesignProcessVO vo){
        super(vo);
    }
    @Override
    public DesignProcessVO getVo(){
        return (DesignProcessVO)super.getVo();
    }
    @Override
    ...
    public void initializeDesignProcess(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DesignProcess[toString()=" + super.toString() + "]";
    }

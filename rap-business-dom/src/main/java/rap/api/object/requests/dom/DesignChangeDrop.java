 ...
 * Program ID : DesignChangeDrop.java
 * ===================================================================
...
import rap.api.object.requests.model.DesignChangeDropVO;
import rap.api.object.requests.dom.DesignProcess;


public class DesignChangeDrop extends DesignProcess {
    public DesignChangeDrop(String obid){
        super(obid);
    }
    public DesignChangeDrop(DesignChangeDropVO vo){
        super(vo);
    }
    @Override
    public DesignChangeDropVO getVo(){
        return (DesignChangeDropVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDesignChangeDrop();
    }
    public void initializeDesignChangeDrop(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DesignChangeDrop[toString()=" + super.toString() + "]";
    }

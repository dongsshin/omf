...
import rap.api.object.project.model.ReviewMeetingVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ReviewMeeting extends BusinessObjectMaster {
    public ReviewMeeting(String obid){
        super(obid);
    }
    public ReviewMeeting(ReviewMeetingVO vo){
        super(vo);
    }
    @Override
    public ReviewMeetingVO getVo(){
        return (ReviewMeetingVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeReviewMeeting();
    }
    public void initializeReviewMeeting(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ReviewMeeting[toString()=" + super.toString() + "]";
    }

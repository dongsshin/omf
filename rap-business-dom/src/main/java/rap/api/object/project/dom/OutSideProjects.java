 ...
 * Program ID : OutSideProjects.java
 * ===================================================================
...
public class OutSideProjects extends Projects {
    public OutSideProjects(String obid){
        super(obid);
    }
    public OutSideProjects(OutSideProjectsVO vo){
        super(vo);
    }
    @Override
    public OutSideProjectsVO getVo(){
        return (OutSideProjectsVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeOutSideProjects();
    }
    public void initializeOutSideProjects(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "OutSideProjects[toString()=" + super.toString() + "]";
    }

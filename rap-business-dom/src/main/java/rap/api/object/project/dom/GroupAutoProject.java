 ...
 * Program ID : GroupAutoProject.java
 * ===================================================================
...
import rap.api.object.project.model.GroupAutoProjectVO;
import rap.api.object.project.dom.OEMProject;


public class GroupAutoProject extends OEMProject {
    public GroupAutoProject(String obid){
        super(obid);
    }
    public GroupAutoProject(GroupAutoProjectVO vo){
        super(vo);
    }
    @Override
    public GroupAutoProjectVO getVo(){
        return (GroupAutoProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeGroupAutoProject();
    }
    public void initializeGroupAutoProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "GroupAutoProject[toString()=" + super.toString() + "]";
    }

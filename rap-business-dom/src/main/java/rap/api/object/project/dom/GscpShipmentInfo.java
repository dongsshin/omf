 ...
 * Program ID : GscpShipmentInfo.java
 * ===================================================================
...
import rap.api.object.project.model.GscpShipmentInfoVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class GscpShipmentInfo extends BusinessObjectMaster {
    public GscpShipmentInfo(String obid){
        super(obid);
    }
    public GscpShipmentInfo(GscpShipmentInfoVO vo){
        super(vo);
    }
    @Override
    public GscpShipmentInfoVO getVo(){
        return (GscpShipmentInfoVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeGscpShipmentInfo();
    }
    public void initializeGscpShipmentInfo(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "GscpShipmentInfo[toString()=" + super.toString() + "]";
    }

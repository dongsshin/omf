 ...
 * Program ID : WBSGateActivity.java
 * ===================================================================
...
import rap.api.object.project.model.WBSGateActivityVO;
import rap.api.object.project.dom.WBSRegularActivity;


public class WBSGateActivity extends WBSRegularActivity {
    public WBSGateActivity(String obid){
        super(obid);
    }
    public WBSGateActivity(WBSGateActivityVO vo){
        super(vo);
    }
    @Override
    public WBSGateActivityVO getVo(){
        return (WBSGateActivityVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeWBSGateActivity();
    }
    public void initializeWBSGateActivity(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "WBSGateActivity[toString()=" + super.toString() + "]";
    }

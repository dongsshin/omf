...
import rap.api.object.project.model.ECMSExRateVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ECMSExRate extends BusinessObjectMaster {
    public ECMSExRate(String obid){
        super(obid);
    }
    public ECMSExRate(ECMSExRateVO vo){
        super(vo);
    }
    @Override
    public ECMSExRateVO getVo(){
        return (ECMSExRateVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeECMSExRate();
    }
    public void initializeECMSExRate(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ECMSExRate[toString()=" + super.toString() + "]";
    }

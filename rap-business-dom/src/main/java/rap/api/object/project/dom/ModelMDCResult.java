 ...
 * Program ID : ModelMDCResult.java
 * ===================================================================
...
import rap.api.object.project.model.ModelMDCResultVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ModelMDCResult extends BusinessObjectMaster {
    public ModelMDCResult(String obid){
        super(obid);
    }
    public ModelMDCResult(ModelMDCResultVO vo){
        super(vo);
    }
    @Override
    public ModelMDCResultVO getVo(){
        return (ModelMDCResultVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeModelMDCResult();
    }
    public void initializeModelMDCResult(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ModelMDCResult[toString()=" + super.toString() + "]";
    }

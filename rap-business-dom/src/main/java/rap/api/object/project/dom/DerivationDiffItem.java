 ...
 * Program ID : DerivationDiffItem.java
 * ===================================================================
...
import rap.api.object.project.model.DerivationDiffItemVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class DerivationDiffItem extends BusinessObjectMaster {
    public DerivationDiffItem(String obid){
        super(obid);
    }
    public DerivationDiffItem(DerivationDiffItemVO vo){
        super(vo);
    }
    @Override
    public DerivationDiffItemVO getVo(){
        return (DerivationDiffItemVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDerivationDiffItem();
    }
    public void initializeDerivationDiffItem(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DerivationDiffItem[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : SWMaintenanceCommon.java
 * ===================================================================
...
import rap.api.object.project.model.SWMaintenanceCommonVO;
import rap.api.object.project.dom.SoftwareMaintenanceProject;


public class SWMaintenanceCommon extends SoftwareMaintenanceProject {
    public SWMaintenanceCommon(String obid){
        super(obid);
    }
    public SWMaintenanceCommon(SWMaintenanceCommonVO vo){
        super(vo);
    }
    @Override
    public SWMaintenanceCommonVO getVo(){
        return (SWMaintenanceCommonVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeSWMaintenanceCommon();
    }
    public void initializeSWMaintenanceCommon(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "SWMaintenanceCommon[toString()=" + super.toString() + "]";
    }

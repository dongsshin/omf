 ...
 * Program ID : ECMSTravelExpenses.java
 * ===================================================================
...
import rap.api.object.project.model.ECMSTravelExpensesVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ECMSTravelExpenses extends BusinessObjectMaster {
    public ECMSTravelExpenses(String obid){
        super(obid);
    }
    public ECMSTravelExpenses(ECMSTravelExpensesVO vo){
        super(vo);
    }
    @Override
    public ECMSTravelExpensesVO getVo(){
        return (ECMSTravelExpensesVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeECMSTravelExpenses();
    }
    public void initializeECMSTravelExpenses(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ECMSTravelExpenses[toString()=" + super.toString() + "]";
    }

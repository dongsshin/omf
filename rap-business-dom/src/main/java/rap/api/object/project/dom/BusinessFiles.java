...
import rap.api.object.project.model.BusinessFilesVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class BusinessFiles extends BusinessObjectMaster {
    public BusinessFiles(String obid){
        super(obid);
    }
    public BusinessFiles(BusinessFilesVO vo){
        super(vo);
    }
    @Override
    public BusinessFilesVO getVo(){
        return (BusinessFilesVO)super.getVo();
    }
    @Override
    ...
    public void initializeBusinessFiles(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BusinessFiles[toString()=" + super.toString() + "]";
    }

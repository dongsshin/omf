...
import rap.api.object.project.model.SubProjectVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class SubProject extends BusinessObjectMaster {
    public SubProject(String obid){
        super(obid);
    }
    public SubProject(SubProjectVO vo){
        super(vo);
    }
    @Override
    public SubProjectVO getVo(){
        return (SubProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeSubProject();
    }
    public void initializeSubProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "SubProject[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.project.model.ECMSDevTypeVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ECMSDevType extends BusinessObjectMaster {
    public ECMSDevType(String obid){
        super(obid);
    }
    public ECMSDevType(ECMSDevTypeVO vo){
        super(vo);
    }
    @Override
    public ECMSDevTypeVO getVo(){
        return (ECMSDevTypeVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeECMSDevType();
    }
    public void initializeECMSDevType(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ECMSDevType[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ProjectImageNoncd.java
 * ===================================================================
...
import rap.api.object.project.model.ProjectImageNoncdVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectImageNoncd extends BusinessObjectMaster {
    public ProjectImageNoncd(String obid){
        super(obid);
    }
    public ProjectImageNoncd(ProjectImageNoncdVO vo){
        super(vo);
    }
    @Override
    public ProjectImageNoncdVO getVo(){
        return (ProjectImageNoncdVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectImageNoncd();
    }
    public void initializeProjectImageNoncd(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectImageNoncd[toString()=" + super.toString() + "]";
    }

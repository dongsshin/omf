 ...
 * Program ID : ECMSSummaryScenario.java
 * ===================================================================
...
import rap.api.object.project.model.ECMSSummaryScenarioVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ECMSSummaryScenario extends BusinessObjectMaster {
    public ECMSSummaryScenario(String obid){
        super(obid);
    }
    public ECMSSummaryScenario(ECMSSummaryScenarioVO vo){
        super(vo);
    }
    @Override
    public ECMSSummaryScenarioVO getVo(){
        return (ECMSSummaryScenarioVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeECMSSummaryScenario();
    }
    public void initializeECMSSummaryScenario(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ECMSSummaryScenario[toString()=" + super.toString() + "]";
    }

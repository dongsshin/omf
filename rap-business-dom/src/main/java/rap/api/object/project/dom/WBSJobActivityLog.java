 ...
 * Program ID : WBSJobActivityLog.java
 * ===================================================================
...
public class WBSJobActivityLog extends BusinessObjectMaster {
    public WBSJobActivityLog(String obid){
        super(obid);
    }
    public WBSJobActivityLog(WBSJobActivityLogVO vo){
        super(vo);
    }
    @Override
    public WBSJobActivityLogVO getVo(){
        return (WBSJobActivityLogVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeWBSJobActivityLog();
    }
    public void initializeWBSJobActivityLog(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "WBSJobActivityLog[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : WBSGeneralActivity.java
 * ===================================================================
...
public class WBSGeneralActivity extends WBSRegularActivity {
    public WBSGeneralActivity(String obid){
        super(obid);
    }
    public WBSGeneralActivity(WBSGeneralActivityVO vo){
        super(vo);
    }
    @Override
    public WBSGeneralActivityVO getVo(){
        return (WBSGeneralActivityVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeWBSGeneralActivity();
    }
    public void initializeWBSGeneralActivity(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "WBSGeneralActivity[toString()=" + super.toString() + "]";
    }

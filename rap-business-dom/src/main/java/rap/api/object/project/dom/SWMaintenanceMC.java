 ...
 * Program ID : SWMaintenanceMC.java
 * ===================================================================
...
import rap.api.object.project.model.SWMaintenanceMCVO;
import rap.api.object.project.dom.SoftwareMaintenanceProject;


public class SWMaintenanceMC extends SoftwareMaintenanceProject {
    public SWMaintenanceMC(String obid){
        super(obid);
    }
    public SWMaintenanceMC(SWMaintenanceMCVO vo){
        super(vo);
    }
    @Override
    public SWMaintenanceMCVO getVo(){
        return (SWMaintenanceMCVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeSWMaintenanceMC();
    }
    public void initializeSWMaintenanceMC(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "SWMaintenanceMC[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : WBSRegularActivity.java
 * ===================================================================
...
public class WBSRegularActivity extends WBSActivities {
    public WBSRegularActivity(String obid){
        super(obid);
    }
    public WBSRegularActivity(WBSRegularActivityVO vo){
        super(vo);
    }
    @Override
    public WBSRegularActivityVO getVo(){
        return (WBSRegularActivityVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeWBSRegularActivity();
    }
    public void initializeWBSRegularActivity(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "WBSRegularActivity[toString()=" + super.toString() + "]";
    }

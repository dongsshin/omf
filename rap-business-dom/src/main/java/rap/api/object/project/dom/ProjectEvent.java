...
import rap.api.object.project.model.ProjectEventVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectEvent extends BusinessObjectMaster {
    public ProjectEvent(String obid){
        super(obid);
    }
    public ProjectEvent(ProjectEventVO vo){
        super(vo);
    }
    @Override
    public ProjectEventVO getVo(){
        return (ProjectEventVO)super.getVo();
    }
    @Override
    ...
    public void initializeProjectEvent(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectEvent[toString()=" + super.toString() + "]";
    }

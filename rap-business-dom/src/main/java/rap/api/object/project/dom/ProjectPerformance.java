 ...
 * Program ID : ProjectPerformance.java
 * ===================================================================
...
import rap.api.object.project.model.ProjectPerformanceVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectPerformance extends BusinessObjectMaster {
    public ProjectPerformance(String obid){
        super(obid);
    }
    public ProjectPerformance(ProjectPerformanceVO vo){
        super(vo);
    }
    @Override
    public ProjectPerformanceVO getVo(){
        return (ProjectPerformanceVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectPerformance();
    }
    public void initializeProjectPerformance(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectPerformance[toString()=" + super.toString() + "]";
    }

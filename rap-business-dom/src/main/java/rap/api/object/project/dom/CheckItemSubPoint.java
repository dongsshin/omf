 ...
 * Program ID : CheckItemSubPoint.java
 * ===================================================================
...
import rap.api.object.project.model.CheckItemSubPointVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class CheckItemSubPoint extends BusinessObjectMaster {
    public CheckItemSubPoint(String obid){
        super(obid);
    }
    public CheckItemSubPoint(CheckItemSubPointVO vo){
        super(vo);
    }
    @Override
    public CheckItemSubPointVO getVo(){
        return (CheckItemSubPointVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeCheckItemSubPoint();
    }
    public void initializeCheckItemSubPoint(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "CheckItemSubPoint[toString()=" + super.toString() + "]";
    }

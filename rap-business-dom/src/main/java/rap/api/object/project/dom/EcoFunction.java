...
import rap.api.object.project.model.EcoFunctionVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class EcoFunction extends BusinessObjectMaster {
    public EcoFunction(String obid){
        super(obid);
    }
    public EcoFunction(EcoFunctionVO vo){
        super(vo);
    }
    @Override
    public EcoFunctionVO getVo(){
        return (EcoFunctionVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeEcoFunction();
    }
    public void initializeEcoFunction(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "EcoFunction[toString()=" + super.toString() + "]";
    }

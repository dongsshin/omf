...
import rap.api.object.project.model.CTOReportVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class CTOReport extends BusinessObjectMaster {
    public CTOReport(String obid){
        super(obid);
    }
    public CTOReport(CTOReportVO vo){
        super(vo);
    }
    @Override
    public CTOReportVO getVo(){
        return (CTOReportVO)super.getVo();
    }
    @Override
    ...
    public void initializeCTOReport(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "CTOReport[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.project.model.CommonProjectVO;
import rap.api.object.project.dom.Projects;


public class CommonProject extends Projects {
    public CommonProject(String obid){
        super(obid);
    }
    public CommonProject(CommonProjectVO vo){
        super(vo);
    }
    @Override
    public CommonProjectVO getVo(){
        return (CommonProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeCommonProject();
    }
    public void initializeCommonProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "CommonProject[toString()=" + super.toString() + "]";
    }

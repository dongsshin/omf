 ...
 * Program ID : ProjectEventQuantity.java
 * ===================================================================
...
import rap.api.object.project.model.ProjectEventQuantityVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectEventQuantity extends BusinessObjectMaster {
    public ProjectEventQuantity(String obid){
        super(obid);
    }
    public ProjectEventQuantity(ProjectEventQuantityVO vo){
        super(vo);
    }
    @Override
    public ProjectEventQuantityVO getVo(){
        return (ProjectEventQuantityVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectEventQuantity();
    }
    public void initializeProjectEventQuantity(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectEventQuantity[toString()=" + super.toString() + "]";
    }

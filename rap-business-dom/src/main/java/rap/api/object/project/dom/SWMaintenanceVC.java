 ...
 * Program ID : SWMaintenanceVC.java
 * ===================================================================
...
import rap.api.object.project.model.SWMaintenanceVCVO;
import rap.api.object.project.dom.SoftwareMaintenanceProject;


public class SWMaintenanceVC extends SoftwareMaintenanceProject {
    public SWMaintenanceVC(String obid){
        super(obid);
    }
    public SWMaintenanceVC(SWMaintenanceVCVO vo){
        super(vo);
    }
    @Override
    public SWMaintenanceVCVO getVo(){
        return (SWMaintenanceVCVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeSWMaintenanceVC();
    }
    public void initializeSWMaintenanceVC(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "SWMaintenanceVC[toString()=" + super.toString() + "]";
    }

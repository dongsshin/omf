 ...
 * Program ID : SWMaintenanceTV.java
 * ===================================================================
...
import rap.api.object.project.model.SWMaintenanceTVVO;
import rap.api.object.project.dom.SoftwareMaintenanceProject;


public class SWMaintenanceTV extends SoftwareMaintenanceProject {
    public SWMaintenanceTV(String obid){
        super(obid);
    }
    public SWMaintenanceTV(SWMaintenanceTVVO vo){
        super(vo);
    }
    @Override
    public SWMaintenanceTVVO getVo(){
        return (SWMaintenanceTVVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeSWMaintenanceTV();
    }
    public void initializeSWMaintenanceTV(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "SWMaintenanceTV[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : PmsWbsActivity.java
 * ===================================================================
...
import rap.api.object.project.model.PmsWbsActivityVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PmsWbsActivity extends BusinessObjectMaster {
    public PmsWbsActivity(String obid){
        super(obid);
    }
    public PmsWbsActivity(PmsWbsActivityVO vo){
        super(vo);
    }
    @Override
    public PmsWbsActivityVO getVo(){
        return (PmsWbsActivityVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePmsWbsActivity();
    }
    public void initializePmsWbsActivity(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PmsWbsActivity[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.project.model.WeeklyReportVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class WeeklyReport extends BusinessObjectMaster {
    public WeeklyReport(String obid){
        super(obid);
    }
    public WeeklyReport(WeeklyReportVO vo){
        super(vo);
    }
    @Override
    public WeeklyReportVO getVo(){
        return (WeeklyReportVO)super.getVo();
    }
    @Override
    ...
    public void initializeWeeklyReport(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "WeeklyReport[toString()=" + super.toString() + "]";
    }

...
public class ECMSStdAuthVO extends BusinessObjectMasterVO {
    ...
    public void    setCertificationSubject(String certificationSubject){
        this.certificationSubject = certificationSubject;
    }

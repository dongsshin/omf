 ...
 * Program ID : ProjectTaskExecute.java
 * ===================================================================
...
import rap.api.object.project.model.ProjectTaskExecuteVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectTaskExecute extends BusinessObjectMaster {
    public ProjectTaskExecute(String obid){
        super(obid);
    }
    public ProjectTaskExecute(ProjectTaskExecuteVO vo){
        super(vo);
    }
    @Override
    public ProjectTaskExecuteVO getVo(){
        return (ProjectTaskExecuteVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectTaskExecute();
    }
    public void initializeProjectTaskExecute(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectTaskExecute[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.project.model.PmsWbsMasterVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PmsWbsMaster extends BusinessObjectMaster {
    public PmsWbsMaster(String obid){
        super(obid);
    }
    public PmsWbsMaster(PmsWbsMasterVO vo){
        super(vo);
    }
    @Override
    public PmsWbsMasterVO getVo(){
        return (PmsWbsMasterVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePmsWbsMaster();
    }
    public void initializePmsWbsMaster(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PmsWbsMaster[toString()=" + super.toString() + "]";
    }

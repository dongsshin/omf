 ...
 * Program ID : InteroperationApplicationProject.java
 * ===================================================================
...
import rap.api.object.project.model.InteroperationApplicationProjectVO;
import rap.api.object.project.dom.ProductProjects;


public class InteroperationApplicationProject extends ProductProjects {
    public InteroperationApplicationProject(String obid){
        super(obid);
    }
    public InteroperationApplicationProject(InteroperationApplicationProjectVO vo){
        super(vo);
    }
    @Override
    public InteroperationApplicationProjectVO getVo(){
        return (InteroperationApplicationProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeInteroperationApplicationProject();
    }
    public void initializeInteroperationApplicationProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "InteroperationApplicationProject[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.project.model.ECMSLaberCostVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ECMSLaberCost extends BusinessObjectMaster {
    public ECMSLaberCost(String obid){
        super(obid);
    }
    public ECMSLaberCost(ECMSLaberCostVO vo){
        super(vo);
    }
    @Override
    public ECMSLaberCostVO getVo(){
        return (ECMSLaberCostVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeECMSLaberCost();
    }
    public void initializeECMSLaberCost(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ECMSLaberCost[toString()=" + super.toString() + "]";
    }

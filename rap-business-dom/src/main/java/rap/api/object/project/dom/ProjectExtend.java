...
import rap.api.object.project.model.ProjectExtendVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectExtend extends BusinessObjectMaster {
    public ProjectExtend(String obid){
        super(obid);
    }
    public ProjectExtend(ProjectExtendVO vo){
        super(vo);
    }
    @Override
    public ProjectExtendVO getVo(){
        return (ProjectExtendVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectExtend();
    }
    public void initializeProjectExtend(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectExtend[toString()=" + super.toString() + "]";
    }

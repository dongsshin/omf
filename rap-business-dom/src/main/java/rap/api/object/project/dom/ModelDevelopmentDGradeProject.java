 ...
 * Program ID : ModelDevelopmentDGradeProject.java
 * ===================================================================
...
import rap.api.object.project.model.ModelDevelopmentDGradeProjectVO;
import rap.api.object.project.dom.ModelDevelopmentProjects;


public class ModelDevelopmentDGradeProject extends ModelDevelopmentProjects {
    public ModelDevelopmentDGradeProject(String obid){
        super(obid);
    }
    public ModelDevelopmentDGradeProject(ModelDevelopmentDGradeProjectVO vo){
        super(vo);
    }
    @Override
    public ModelDevelopmentDGradeProjectVO getVo(){
        return (ModelDevelopmentDGradeProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeModelDevelopmentDGradeProject();
    }
    public void initializeModelDevelopmentDGradeProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ModelDevelopmentDGradeProject[toString()=" + super.toString() + "]";
    }

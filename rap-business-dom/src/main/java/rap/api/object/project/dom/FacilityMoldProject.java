 ...
 * Program ID : FacilityMoldProject.java
 * ===================================================================
...
import rap.api.object.project.model.FacilityMoldProjectVO;
import rap.api.object.project.dom.FacilityProjects;


public class FacilityMoldProject extends FacilityProjects {
    public FacilityMoldProject(String obid){
        super(obid);
    }
    public FacilityMoldProject(FacilityMoldProjectVO vo){
        super(vo);
    }
    @Override
    public FacilityMoldProjectVO getVo(){
        return (FacilityMoldProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeFacilityMoldProject();
    }
    public void initializeFacilityMoldProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "FacilityMoldProject[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : FacilityProject.java
 * ===================================================================
...
import rap.api.object.project.model.FacilityProjectVO;
import rap.api.object.project.dom.FacilityProjects;


public class FacilityProject extends FacilityProjects {
    public FacilityProject(String obid){
        super(obid);
    }
    public FacilityProject(FacilityProjectVO vo){
        super(vo);
    }
    @Override
    public FacilityProjectVO getVo(){
        return (FacilityProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeFacilityProject();
    }
    public void initializeFacilityProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "FacilityProject[toString()=" + super.toString() + "]";
    }

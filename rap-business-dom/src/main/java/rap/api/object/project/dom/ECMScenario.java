...
import rap.api.object.project.model.ECMScenarioVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ECMScenario extends BusinessObjectMaster {
    public ECMScenario(String obid){
        super(obid);
    }
    public ECMScenario(ECMScenarioVO vo){
        super(vo);
    }
    @Override
    public ECMScenarioVO getVo(){
        return (ECMScenarioVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeECMScenario();
    }
    public void initializeECMScenario(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ECMScenario[toString()=" + super.toString() + "]";
    }

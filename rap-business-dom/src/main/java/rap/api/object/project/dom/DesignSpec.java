...
import rap.api.object.project.model.DesignSpecVO;
import com.rap.omc.api.object.dom.BusinessObject;


public class DesignSpec extends BusinessObject {
    public DesignSpec(String obid){
        super(obid);
    }
    public DesignSpec(DesignSpecVO vo){
        super(vo);
    }
    @Override
    public DesignSpecVO getVo(){
        return (DesignSpecVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDesignSpec();
    }
    public void initializeDesignSpec(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DesignSpec[toString()=" + super.toString() + "]";
    }

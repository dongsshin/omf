 ...
 * Program ID : WBSDucumentBasedActivity.java
 * ===================================================================
...
import rap.api.object.project.model.WBSDucumentBasedActivityVO;
import rap.api.object.project.dom.WBSRegularActivity;


public class WBSDucumentBasedActivity extends WBSRegularActivity {
    public WBSDucumentBasedActivity(String obid){
        super(obid);
    }
    public WBSDucumentBasedActivity(WBSDucumentBasedActivityVO vo){
        super(vo);
    }
    @Override
    public WBSDucumentBasedActivityVO getVo(){
        return (WBSDucumentBasedActivityVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeWBSDucumentBasedActivity();
    }
    public void initializeWBSDucumentBasedActivity(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "WBSDucumentBasedActivity[toString()=" + super.toString() + "]";
    }

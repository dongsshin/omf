 ...
 * Program ID : DerivationCheckListUser.java
 * ===================================================================
...
import rap.api.object.project.model.DerivationCheckListUserVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class DerivationCheckListUser extends BusinessObjectMaster {
    public DerivationCheckListUser(String obid){
        super(obid);
    }
    public DerivationCheckListUser(DerivationCheckListUserVO vo){
        super(vo);
    }
    @Override
    public DerivationCheckListUserVO getVo(){
        return (DerivationCheckListUserVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDerivationCheckListUser();
    }
    public void initializeDerivationCheckListUser(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DerivationCheckListUser[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : WBSMilesStoneActivity.java
 * ===================================================================
...
import rap.api.object.project.model.WBSMilesStoneActivityVO;
import rap.api.object.project.dom.WBSActivities;


public class WBSMilesStoneActivity extends WBSActivities {
    public WBSMilesStoneActivity(String obid){
        super(obid);
    }
    public WBSMilesStoneActivity(WBSMilesStoneActivityVO vo){
        super(vo);
    }
    @Override
    public WBSMilesStoneActivityVO getVo(){
        return (WBSMilesStoneActivityVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeWBSMilesStoneActivity();
    }
    public void initializeWBSMilesStoneActivity(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "WBSMilesStoneActivity[toString()=" + super.toString() + "]";
    }

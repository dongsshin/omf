...
import rap.api.object.project.model.ProjectIssueVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectIssue extends BusinessObjectMaster {
    public ProjectIssue(String obid){
        super(obid);
    }
    public ProjectIssue(ProjectIssueVO vo){
        super(vo);
    }
    @Override
    public ProjectIssueVO getVo(){
        return (ProjectIssueVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectIssue();
    }
    public void initializeProjectIssue(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectIssue[toString()=" + super.toString() + "]";
    }

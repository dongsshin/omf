...
import rap.api.object.project.model.GcrcCostVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class GcrcCost extends BusinessObjectMaster {
    public GcrcCost(String obid){
        super(obid);
    }
    public GcrcCost(GcrcCostVO vo){
        super(vo);
    }
    @Override
    public GcrcCostVO getVo(){
        return (GcrcCostVO)super.getVo();
    }
    @Override
    ...
    public void initializeGcrcCost(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "GcrcCost[toString()=" + super.toString() + "]";
    }

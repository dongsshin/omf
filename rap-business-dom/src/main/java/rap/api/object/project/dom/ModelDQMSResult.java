 ...
 * Program ID : ModelDQMSResult.java
 * ===================================================================
...
import rap.api.object.project.model.ModelDQMSResultVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ModelDQMSResult extends BusinessObjectMaster {
    public ModelDQMSResult(String obid){
        super(obid);
    }
    public ModelDQMSResult(ModelDQMSResultVO vo){
        super(vo);
    }
    @Override
    public ModelDQMSResultVO getVo(){
        return (ModelDQMSResultVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeModelDQMSResult();
    }
    public void initializeModelDQMSResult(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ModelDQMSResult[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : WBSLegacyRelatedActivity.java
 * ===================================================================
...
import rap.api.object.project.model.WBSLegacyRelatedActivityVO;
import rap.api.object.project.dom.WBSRegularActivity;


public class WBSLegacyRelatedActivity extends WBSRegularActivity {
    public WBSLegacyRelatedActivity(String obid){
        super(obid);
    }
    public WBSLegacyRelatedActivity(WBSLegacyRelatedActivityVO vo){
        super(vo);
    }
    @Override
    public WBSLegacyRelatedActivityVO getVo(){
        return (WBSLegacyRelatedActivityVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeWBSLegacyRelatedActivity();
    }
    public void initializeWBSLegacyRelatedActivity(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "WBSLegacyRelatedActivity[toString()=" + super.toString() + "]";
    }

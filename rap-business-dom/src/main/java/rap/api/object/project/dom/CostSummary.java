...
import rap.api.object.project.model.CostSummaryVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class CostSummary extends BusinessObjectMaster {
    public CostSummary(String obid){
        super(obid);
    }
    public CostSummary(CostSummaryVO vo){
        super(vo);
    }
    @Override
    public CostSummaryVO getVo(){
        return (CostSummaryVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeCostSummary();
    }
    public void initializeCostSummary(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "CostSummary[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.project.model.GrandProjectVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class GrandProject extends BusinessObjectMaster {
    public GrandProject(String obid){
        super(obid);
    }
    public GrandProject(GrandProjectVO vo){
        super(vo);
    }
    @Override
    public GrandProjectVO getVo(){
        return (GrandProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeGrandProject();
    }
    public void initializeGrandProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "GrandProject[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : OEMAutoProject.java
 * ===================================================================
...
import rap.api.object.project.model.OEMAutoProjectVO;
import rap.api.object.project.dom.OEMProject;


public class OEMAutoProject extends OEMProject {
    public OEMAutoProject(String obid){
        super(obid);
    }
    public OEMAutoProject(OEMAutoProjectVO vo){
        super(vo);
    }
    @Override
    public OEMAutoProjectVO getVo(){
        return (OEMAutoProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeOEMAutoProject();
    }
    public void initializeOEMAutoProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "OEMAutoProject[toString()=" + super.toString() + "]";
    }

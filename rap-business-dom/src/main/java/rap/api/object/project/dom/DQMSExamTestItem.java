 ...
 * Program ID : DQMSExamTestItem.java
 * ===================================================================
...
import rap.api.object.project.model.DQMSExamTestItemVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class DQMSExamTestItem extends BusinessObjectMaster {
    public DQMSExamTestItem(String obid){
        super(obid);
    }
    public DQMSExamTestItem(DQMSExamTestItemVO vo){
        super(vo);
    }
    @Override
    public DQMSExamTestItemVO getVo(){
        return (DQMSExamTestItemVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDQMSExamTestItem();
    }
    public void initializeDQMSExamTestItem(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DQMSExamTestItem[toString()=" + super.toString() + "]";
    }

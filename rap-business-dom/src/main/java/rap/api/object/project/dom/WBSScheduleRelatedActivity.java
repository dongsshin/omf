 ...
 * Program ID : WBSScheduleRelatedActivity.java
 * ===================================================================
...
import rap.api.object.project.model.WBSScheduleRelatedActivityVO;
import rap.api.object.project.dom.WBSRegularActivity;


public class WBSScheduleRelatedActivity extends WBSRegularActivity {
    public WBSScheduleRelatedActivity(String obid){
        super(obid);
    }
    public WBSScheduleRelatedActivity(WBSScheduleRelatedActivityVO vo){
        super(vo);
    }
    @Override
    public WBSScheduleRelatedActivityVO getVo(){
        return (WBSScheduleRelatedActivityVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeWBSScheduleRelatedActivity();
    }
    public void initializeWBSScheduleRelatedActivity(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "WBSScheduleRelatedActivity[toString()=" + super.toString() + "]";
    }

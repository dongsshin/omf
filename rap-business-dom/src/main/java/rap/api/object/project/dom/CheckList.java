...
import rap.api.object.project.model.CheckListVO;
import com.rap.omc.api.object.dom.BusinessObject;


public class CheckList extends BusinessObject {
    public CheckList(String obid){
        super(obid);
    }
    public CheckList(CheckListVO vo){
        super(vo);
    }
    @Override
    public CheckListVO getVo(){
        return (CheckListVO)super.getVo();
    }
    @Override
    ...
    public String toString() {
        return "CheckList[toString()=" + super.toString() + "]";
    }

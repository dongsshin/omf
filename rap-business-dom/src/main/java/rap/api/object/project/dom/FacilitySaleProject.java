 ...
 * Program ID : FacilitySaleProject.java
 * ===================================================================
...
import rap.api.object.project.model.FacilitySaleProjectVO;
import rap.api.object.project.dom.FacilityProjects;


public class FacilitySaleProject extends FacilityProjects {
    public FacilitySaleProject(String obid){
        super(obid);
    }
    public FacilitySaleProject(FacilitySaleProjectVO vo){
        super(vo);
    }
    @Override
    public FacilitySaleProjectVO getVo(){
        return (FacilitySaleProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeFacilitySaleProject();
    }
    public void initializeFacilitySaleProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "FacilitySaleProject[toString()=" + super.toString() + "]";
    }

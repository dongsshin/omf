 ...
 * Program ID : ProjectModelChangeLog.java
 * ===================================================================
...
import rap.api.object.project.model.ProjectModelChangeLogVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectModelChangeLog extends BusinessObjectMaster {
    public ProjectModelChangeLog(String obid){
        super(obid);
    }
    public ProjectModelChangeLog(ProjectModelChangeLogVO vo){
        super(vo);
    }
    @Override
    public ProjectModelChangeLogVO getVo(){
        return (ProjectModelChangeLogVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectModelChangeLog();
    }
    public void initializeProjectModelChangeLog(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectModelChangeLog[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.project.model.PIMSModuleVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PIMSModule extends BusinessObjectMaster {
    public PIMSModule(String obid){
        super(obid);
    }
    public PIMSModule(PIMSModuleVO vo){
        super(vo);
    }
    @Override
    public PIMSModuleVO getVo(){
        return (PIMSModuleVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePIMSModule();
    }
    public void initializePIMSModule(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PIMSModule[toString()=" + super.toString() + "]";
    }

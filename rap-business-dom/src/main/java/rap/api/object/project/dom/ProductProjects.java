 ...
 * Program ID : ProductProjects.java
 * ===================================================================
...
public class ProductProjects extends Projects {
    public ProductProjects(String obid){
        super(obid);
    }
    public ProductProjects(ProductProjectsVO vo){
        super(vo);
    }
    @Override
    public ProductProjectsVO getVo(){
        return (ProductProjectsVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProductProjects();
    }
    public void initializeProductProjects(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProductProjects[toString()=" + super.toString() + "]";
    }

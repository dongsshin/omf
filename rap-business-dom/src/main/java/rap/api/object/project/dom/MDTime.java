...
import rap.api.object.project.model.MDTimeVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class MDTime extends BusinessObjectMaster {
    public MDTime(String obid){
        super(obid);
    }
    public MDTime(MDTimeVO vo){
        super(vo);
    }
    @Override
    public MDTimeVO getVo(){
        return (MDTimeVO)super.getVo();
    }
    @Override
    ...
    public void initializeMDTime(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "MDTime[toString()=" + super.toString() + "]";
    }

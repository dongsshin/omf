 ...
 * Program ID : DesignSpecFinish.java
 * ===================================================================
...
import rap.api.object.project.model.DesignSpecFinishVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class DesignSpecFinish extends BusinessObjectMaster {
    public DesignSpecFinish(String obid){
        super(obid);
    }
    public DesignSpecFinish(DesignSpecFinishVO vo){
        super(vo);
    }
    @Override
    public DesignSpecFinishVO getVo(){
        return (DesignSpecFinishVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDesignSpecFinish();
    }
    public void initializeDesignSpecFinish(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DesignSpecFinish[toString()=" + super.toString() + "]";
    }

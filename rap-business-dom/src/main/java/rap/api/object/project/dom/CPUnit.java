...
import rap.api.object.project.model.CPUnitVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class CPUnit extends BusinessObjectMaster {
    public CPUnit(String obid){
        super(obid);
    }
    public CPUnit(CPUnitVO vo){
        super(vo);
    }
    @Override
    public CPUnitVO getVo(){
        return (CPUnitVO)super.getVo();
    }
    @Override
    ...
    public void initializeCPUnit(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "CPUnit[toString()=" + super.toString() + "]";
    }

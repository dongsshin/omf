 ...
 * Program ID : ProjectMembers.java
 * ===================================================================
...
public class ProjectMembers extends BusinessObjectMaster {
    public ProjectMembers(String obid){
        super(obid);
    }
    public ProjectMembers(ProjectMembersVO vo){
        super(vo);
    }
    @Override
    public ProjectMembersVO getVo(){
        return (ProjectMembersVO)super.getVo();
    }
    @Override
    ...
    public void initializeProjectMembers(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectMembers[toString()=" + super.toString() + "]";
    }

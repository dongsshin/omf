...
import rap.api.object.project.model.OemMasterVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class OemMaster extends BusinessObjectMaster {
    public OemMaster(String obid){
        super(obid);
    }
    public OemMaster(OemMasterVO vo){
        super(vo);
    }
    @Override
    public OemMasterVO getVo(){
        return (OemMasterVO)super.getVo();
    }
    @Override
    ...
    public void initializeOemMaster(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "OemMaster[toString()=" + super.toString() + "]";
    }

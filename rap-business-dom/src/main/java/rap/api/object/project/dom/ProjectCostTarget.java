 ...
 * Program ID : ProjectCostTarget.java
 * ===================================================================
...
import rap.api.object.project.model.ProjectCostTargetVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectCostTarget extends BusinessObjectMaster {
    public ProjectCostTarget(String obid){
        super(obid);
    }
    public ProjectCostTarget(ProjectCostTargetVO vo){
        super(vo);
    }
    @Override
    public ProjectCostTargetVO getVo(){
        return (ProjectCostTargetVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectCostTarget();
    }
    public void initializeProjectCostTarget(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectCostTarget[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.project.model.DesignProjectVO;
import rap.api.object.project.dom.Projects;


public class DesignProject extends Projects {
    public DesignProject(String obid){
        super(obid);
    }
    public DesignProject(DesignProjectVO vo){
        super(vo);
    }
    @Override
    public DesignProjectVO getVo(){
        return (DesignProjectVO)super.getVo();
    }
    @Override
    ...
    public void initializeDesignProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DesignProject[toString()=" + super.toString() + "]";
    }

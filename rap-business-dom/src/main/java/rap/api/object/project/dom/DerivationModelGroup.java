 ...
 * Program ID : DerivationModelGroup.java
 * ===================================================================
...
import rap.api.object.project.model.DerivationModelGroupVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class DerivationModelGroup extends BusinessObjectMaster {
    public DerivationModelGroup(String obid){
        super(obid);
    }
    public DerivationModelGroup(DerivationModelGroupVO vo){
        super(vo);
    }
    @Override
    public DerivationModelGroupVO getVo(){
        return (DerivationModelGroupVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDerivationModelGroup();
    }
    public void initializeDerivationModelGroup(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DerivationModelGroup[toString()=" + super.toString() + "]";
    }

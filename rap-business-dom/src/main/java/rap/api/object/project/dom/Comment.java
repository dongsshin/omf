...
import rap.api.object.project.model.CommentVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class Comment extends BusinessObjectMaster {
    public Comment(String obid){
        super(obid);
    }

 ...
 * Program ID : ProjectSWGovernance.java
 * ===================================================================
...
import rap.api.object.project.model.ProjectSWGovernanceVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectSWGovernance extends BusinessObjectMaster {
    public ProjectSWGovernance(String obid){
        super(obid);
    }
    public ProjectSWGovernance(ProjectSWGovernanceVO vo){
        super(vo);
    }
    @Override
    public ProjectSWGovernanceVO getVo(){
        return (ProjectSWGovernanceVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectSWGovernance();
    }
    public void initializeProjectSWGovernance(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectSWGovernance[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.project.model.MDTopDeptVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class MDTopDept extends BusinessObjectMaster {
    public MDTopDept(String obid){
        super(obid);
    }
    public MDTopDept(MDTopDeptVO vo){
        super(vo);
    }
    @Override
    public MDTopDeptVO getVo(){
        return (MDTopDeptVO)super.getVo();
    }
    @Override
    ...
    public void initializeMDTopDept(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "MDTopDept[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.project.model.ProjectImageVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectImage extends BusinessObjectMaster {
    public ProjectImage(String obid){
        super(obid);
    }
    public ProjectImage(ProjectImageVO vo){
        super(vo);
    }
    @Override
    public ProjectImageVO getVo(){
        return (ProjectImageVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectImage();
    }
    public void initializeProjectImage(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectImage[toString()=" + super.toString() + "]";
    }

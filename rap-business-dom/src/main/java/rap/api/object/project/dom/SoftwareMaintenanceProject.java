 ...
 * Program ID : SoftwareMaintenanceProject.java
 * ===================================================================
...
public class SoftwareMaintenanceProject extends ProductProjects {
    public SoftwareMaintenanceProject(String obid){
        super(obid);
    }
    public SoftwareMaintenanceProject(SoftwareMaintenanceProjectVO vo){
        super(vo);
    }
    @Override
    public SoftwareMaintenanceProjectVO getVo(){
        return (SoftwareMaintenanceProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeSoftwareMaintenanceProject();
    }
    public void initializeSoftwareMaintenanceProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "SoftwareMaintenanceProject[toString()=" + super.toString() + "]";
    }

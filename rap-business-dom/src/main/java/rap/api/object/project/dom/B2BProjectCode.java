 ...
 * Program ID : B2BProjectCode.java
 * ===================================================================
...
import rap.api.object.project.model.B2BProjectCodeVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class B2BProjectCode extends BusinessObjectMaster {
    public B2BProjectCode(String obid){
        super(obid);
    }
    public B2BProjectCode(B2BProjectCodeVO vo){
        super(vo);
    }
    @Override
    public B2BProjectCodeVO getVo(){
        return (B2BProjectCodeVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeB2BProjectCode();
    }
    public void initializeB2BProjectCode(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "B2BProjectCode[toString()=" + super.toString() + "]";
    }

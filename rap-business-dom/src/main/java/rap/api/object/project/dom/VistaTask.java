...
import rap.api.object.project.model.VistaTaskVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class VistaTask extends BusinessObjectMaster {
    public VistaTask(String obid){
        super(obid);
    }
    public VistaTask(VistaTaskVO vo){
        super(vo);
    }
    @Override
    public VistaTaskVO getVo(){
        return (VistaTaskVO)super.getVo();
    }
    @Override
    ...
    public void initializeVistaTask(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "VistaTask[toString()=" + super.toString() + "]";
    }

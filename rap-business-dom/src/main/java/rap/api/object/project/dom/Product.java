...
import rap.api.object.project.model.ProductVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class Product extends BusinessObjectMaster {
    public Product(String obid){
        super(obid);
    }

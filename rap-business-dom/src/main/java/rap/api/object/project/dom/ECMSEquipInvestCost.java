 ...
 * Program ID : ECMSEquipInvestCost.java
 * ===================================================================
...
import rap.api.object.project.model.ECMSEquipInvestCostVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ECMSEquipInvestCost extends BusinessObjectMaster {
    public ECMSEquipInvestCost(String obid){
        super(obid);
    }
    public ECMSEquipInvestCost(ECMSEquipInvestCostVO vo){
        super(vo);
    }
    @Override
    public ECMSEquipInvestCostVO getVo(){
        return (ECMSEquipInvestCostVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeECMSEquipInvestCost();
    }
    public void initializeECMSEquipInvestCost(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ECMSEquipInvestCost[toString()=" + super.toString() + "]";
    }

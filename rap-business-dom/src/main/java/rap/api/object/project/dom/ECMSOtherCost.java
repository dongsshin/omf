...
import rap.api.object.project.model.ECMSOtherCostVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ECMSOtherCost extends BusinessObjectMaster {
    public ECMSOtherCost(String obid){
        super(obid);
    }
    public ECMSOtherCost(ECMSOtherCostVO vo){
        super(vo);
    }
    @Override
    public ECMSOtherCostVO getVo(){
        return (ECMSOtherCostVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeECMSOtherCost();
    }
    public void initializeECMSOtherCost(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ECMSOtherCost[toString()=" + super.toString() + "]";
    }

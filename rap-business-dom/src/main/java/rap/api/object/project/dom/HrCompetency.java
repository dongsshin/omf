...
import rap.api.object.project.model.HrCompetencyVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class HrCompetency extends BusinessObjectMaster {
    public HrCompetency(String obid){
        super(obid);
    }
    public HrCompetency(HrCompetencyVO vo){
        super(vo);
    }
    @Override
    public HrCompetencyVO getVo(){
        return (HrCompetencyVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeHrCompetency();
    }
    public void initializeHrCompetency(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "HrCompetency[toString()=" + super.toString() + "]";
    }

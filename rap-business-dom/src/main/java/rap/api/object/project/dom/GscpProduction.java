 ...
 * Program ID : GscpProduction.java
 * ===================================================================
...
import rap.api.object.project.model.GscpProductionVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class GscpProduction extends BusinessObjectMaster {
    public GscpProduction(String obid){
        super(obid);
    }
    public GscpProduction(GscpProductionVO vo){
        super(vo);
    }
    @Override
    public GscpProductionVO getVo(){
        return (GscpProductionVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeGscpProduction();
    }
    public void initializeGscpProduction(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "GscpProduction[toString()=" + super.toString() + "]";
    }

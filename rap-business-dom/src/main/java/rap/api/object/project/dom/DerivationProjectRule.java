 ...
 * Program ID : DerivationProjectRule.java
 * ===================================================================
...
import rap.api.object.project.model.DerivationProjectRuleVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class DerivationProjectRule extends BusinessObjectMaster {
    public DerivationProjectRule(String obid){
        super(obid);
    }
    public DerivationProjectRule(DerivationProjectRuleVO vo){
        super(vo);
    }
    @Override
    public DerivationProjectRuleVO getVo(){
        return (DerivationProjectRuleVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDerivationProjectRule();
    }
    public void initializeDerivationProjectRule(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DerivationProjectRule[toString()=" + super.toString() + "]";
    }

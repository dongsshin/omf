 ...
 * Program ID : OemEventTemplate.java
 * ===================================================================
...
import rap.api.object.project.model.OemEventTemplateVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class OemEventTemplate extends BusinessObjectMaster {
    public OemEventTemplate(String obid){
        super(obid);
    }
    public OemEventTemplate(OemEventTemplateVO vo){
        super(vo);
    }
    @Override
    public OemEventTemplateVO getVo(){
        return (OemEventTemplateVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeOemEventTemplate();
    }
    public void initializeOemEventTemplate(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "OemEventTemplate[toString()=" + super.toString() + "]";
    }

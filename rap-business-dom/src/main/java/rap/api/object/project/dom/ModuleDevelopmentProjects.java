 ...
 * Program ID : ModuleDevelopmentProjects.java
 * ===================================================================
...
public class ModuleDevelopmentProjects extends ProductProjects {
    public ModuleDevelopmentProjects(String obid){
        super(obid);
    }
    public ModuleDevelopmentProjects(ModuleDevelopmentProjectsVO vo){
        super(vo);
    }
    @Override
    public ModuleDevelopmentProjectsVO getVo(){
        return (ModuleDevelopmentProjectsVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeModuleDevelopmentProjects();
    }
    public void initializeModuleDevelopmentProjects(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ModuleDevelopmentProjects[toString()=" + super.toString() + "]";
    }

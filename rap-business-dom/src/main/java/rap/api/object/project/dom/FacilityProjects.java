 ...
 * Program ID : FacilityProjects.java
 * ===================================================================
...
public class FacilityProjects extends Projects {
    public FacilityProjects(String obid){
        super(obid);
    }
    public FacilityProjects(FacilityProjectsVO vo){
        super(vo);
    }
    @Override
    public FacilityProjectsVO getVo(){
        return (FacilityProjectsVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeFacilityProjects();
    }
    public void initializeFacilityProjects(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "FacilityProjects[toString()=" + super.toString() + "]";
    }

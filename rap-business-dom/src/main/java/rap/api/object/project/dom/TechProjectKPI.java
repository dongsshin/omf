 ...
 * Program ID : TechProjectKPI.java
 * ===================================================================
...
import rap.api.object.project.model.TechProjectKPIVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class TechProjectKPI extends BusinessObjectMaster {
    public TechProjectKPI(String obid){
        super(obid);
    }
    public TechProjectKPI(TechProjectKPIVO vo){
        super(vo);
    }
    @Override
    public TechProjectKPIVO getVo(){
        return (TechProjectKPIVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeTechProjectKPI();
    }
    public void initializeTechProjectKPI(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "TechProjectKPI[toString()=" + super.toString() + "]";
    }

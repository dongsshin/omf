 ...
 * Program ID : CommonCheckItem.java
 * ===================================================================
...
import rap.api.object.project.model.CommonCheckItemVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class CommonCheckItem extends BusinessObjectMaster {
    public CommonCheckItem(String obid){
        super(obid);
    }
    public CommonCheckItem(CommonCheckItemVO vo){
        super(vo);
    }
    @Override
    public CommonCheckItemVO getVo(){
        return (CommonCheckItemVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeCommonCheckItem();
    }
    public void initializeCommonCheckItem(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "CommonCheckItem[toString()=" + super.toString() + "]";
    }

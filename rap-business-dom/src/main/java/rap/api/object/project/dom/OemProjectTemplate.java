 ...
 * Program ID : OemProjectTemplate.java
 * ===================================================================
...
import rap.api.object.project.model.OemProjectTemplateVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class OemProjectTemplate extends BusinessObjectMaster {
    public OemProjectTemplate(String obid){
        super(obid);
    }
    public OemProjectTemplate(OemProjectTemplateVO vo){
        super(vo);
    }
    @Override
    public OemProjectTemplateVO getVo(){
        return (OemProjectTemplateVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeOemProjectTemplate();
    }
    public void initializeOemProjectTemplate(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "OemProjectTemplate[toString()=" + super.toString() + "]";
    }

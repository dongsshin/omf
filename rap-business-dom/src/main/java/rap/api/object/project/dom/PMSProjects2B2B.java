 ...
 * Program ID : PMSProjects2B2B.java
 * ===================================================================
...
import rap.api.object.project.model.PMSProjects2B2BVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PMSProjects2B2B extends BusinessObjectMaster {
    public PMSProjects2B2B(String obid){
        super(obid);
    }
    public PMSProjects2B2B(PMSProjects2B2BVO vo){
        super(vo);
    }
    @Override
    public PMSProjects2B2BVO getVo(){
        return (PMSProjects2B2BVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePMSProjects2B2B();
    }
    public void initializePMSProjects2B2B(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PMSProjects2B2B[toString()=" + super.toString() + "]";
    }

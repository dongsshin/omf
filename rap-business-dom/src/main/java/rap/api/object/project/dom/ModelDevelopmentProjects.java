 ...
 * Program ID : ModelDevelopmentProjects.java
 * ===================================================================
...
public class ModelDevelopmentProjects extends ProductProjects {
    public ModelDevelopmentProjects(String obid){
        super(obid);
    }
    public ModelDevelopmentProjects(ModelDevelopmentProjectsVO vo){
        super(vo);
    }
    @Override
    public ModelDevelopmentProjectsVO getVo(){
        return (ModelDevelopmentProjectsVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeModelDevelopmentProjects();
    }
    public void initializeModelDevelopmentProjects(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ModelDevelopmentProjects[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.project.model.ECMSStdAuthVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ECMSStdAuth extends BusinessObjectMaster {
    public ECMSStdAuth(String obid){
        super(obid);
    }
    public ECMSStdAuth(ECMSStdAuthVO vo){
        super(vo);
    }
    @Override
    public ECMSStdAuthVO getVo(){
        return (ECMSStdAuthVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeECMSStdAuth();
    }
    public void initializeECMSStdAuth(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ECMSStdAuth[toString()=" + super.toString() + "]";
    }

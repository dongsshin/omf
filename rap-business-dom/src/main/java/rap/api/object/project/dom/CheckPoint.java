...
import rap.api.object.project.model.CheckPointVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class CheckPoint extends BusinessObjectMaster {
    public CheckPoint(String obid){
        super(obid);
    }
    public CheckPoint(CheckPointVO vo){
        super(vo);
    }
    @Override
    public CheckPointVO getVo(){
        return (CheckPointVO)super.getVo();
    }
    @Override
    ...
    public String toString() {
        return "CheckPoint[toString()=" + super.toString() + "]";
    }

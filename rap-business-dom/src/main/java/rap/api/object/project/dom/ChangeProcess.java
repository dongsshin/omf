...
public class ChangeProcess extends BusinessObjectMaster {
    public ChangeProcess(String obid){
        super(obid);
    }
    public ChangeProcess(ChangeProcessVO vo){
        super(vo);
    }
    @Override
    public ChangeProcessVO getVo(){
        return (ChangeProcessVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeChangeProcess();
    }
    public void initializeChangeProcess(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ChangeProcess[toString()=" + super.toString() + "]";
    }

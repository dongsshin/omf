...
public class ProjectPhase extends BusinessObjectMaster {
    public ProjectPhase(String obid){
        super(obid);
    }
    public ProjectPhase(ProjectPhaseVO vo){
        super(vo);
    }
    @Override
    public ProjectPhaseVO getVo(){
        return (ProjectPhaseVO)super.getVo();
    }
    @Override
    ...
    public void initializeProjectPhase(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectPhase[toString()=" + super.toString() + "]";
    }

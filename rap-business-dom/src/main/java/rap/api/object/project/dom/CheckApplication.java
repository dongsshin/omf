 ...
 * Program ID : CheckApplication.java
 * ===================================================================
...
import rap.api.object.project.model.CheckApplicationVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class CheckApplication extends BusinessObjectMaster {
    public CheckApplication(String obid){
        super(obid);
    }
    public CheckApplication(CheckApplicationVO vo){
        super(vo);
    }
    @Override
    public CheckApplicationVO getVo(){
        return (CheckApplicationVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeCheckApplication();
    }
    public void initializeCheckApplication(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "CheckApplication[toString()=" + super.toString() + "]";
    }

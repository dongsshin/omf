 ...
 * Program ID : MMScheduleMaster.java
 * ===================================================================
...
import rap.api.object.project.model.MMScheduleMasterVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class MMScheduleMaster extends BusinessObjectMaster {
    public MMScheduleMaster(String obid){
        super(obid);
    }
    public MMScheduleMaster(MMScheduleMasterVO vo){
        super(vo);
    }
    @Override
    public MMScheduleMasterVO getVo(){
        return (MMScheduleMasterVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeMMScheduleMaster();
    }
    public void initializeMMScheduleMaster(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "MMScheduleMaster[toString()=" + super.toString() + "]";
    }

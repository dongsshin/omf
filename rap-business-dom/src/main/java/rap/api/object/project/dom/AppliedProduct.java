 ...
 * Program ID : AppliedProduct.java
 * ===================================================================
...
import rap.api.object.project.model.AppliedProductVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class AppliedProduct extends BusinessObjectMaster {
    public AppliedProduct(String obid){
        super(obid);
    }
    public AppliedProduct(AppliedProductVO vo){
        super(vo);
    }
    @Override
    public AppliedProductVO getVo(){
        return (AppliedProductVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeAppliedProduct();
    }
    public void initializeAppliedProduct(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "AppliedProduct[toString()=" + super.toString() + "]";
    }

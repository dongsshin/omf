 ...
 * Program ID : ECMSExRateDetail.java
 * ===================================================================
...
import rap.api.object.project.model.ECMSExRateDetailVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ECMSExRateDetail extends BusinessObjectMaster {
    public ECMSExRateDetail(String obid){
        super(obid);
    }
    public ECMSExRateDetail(ECMSExRateDetailVO vo){
        super(vo);
    }
    @Override
    public ECMSExRateDetailVO getVo(){
        return (ECMSExRateDetailVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeECMSExRateDetail();
    }
    public void initializeECMSExRateDetail(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ECMSExRateDetail[toString()=" + super.toString() + "]";
    }

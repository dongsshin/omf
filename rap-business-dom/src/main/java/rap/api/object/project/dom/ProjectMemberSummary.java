 ...
 * Program ID : ProjectMemberSummary.java
 * ===================================================================
...
import rap.api.object.project.model.ProjectMemberSummaryVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectMemberSummary extends BusinessObjectMaster {
    public ProjectMemberSummary(String obid){
        super(obid);
    }
    public ProjectMemberSummary(ProjectMemberSummaryVO vo){
        super(vo);
    }
    @Override
    public ProjectMemberSummaryVO getVo(){
        return (ProjectMemberSummaryVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectMemberSummary();
    }
    public void initializeProjectMemberSummary(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectMemberSummary[toString()=" + super.toString() + "]";
    }

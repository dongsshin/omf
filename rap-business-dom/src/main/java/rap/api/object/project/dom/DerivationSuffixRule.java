 ...
 * Program ID : DerivationSuffixRule.java
 * ===================================================================
...
import rap.api.object.project.model.DerivationSuffixRuleVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class DerivationSuffixRule extends BusinessObjectMaster {
    public DerivationSuffixRule(String obid){
        super(obid);
    }
    public DerivationSuffixRule(DerivationSuffixRuleVO vo){
        super(vo);
    }
    @Override
    public DerivationSuffixRuleVO getVo(){
        return (DerivationSuffixRuleVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDerivationSuffixRule();
    }
    public void initializeDerivationSuffixRule(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DerivationSuffixRule[toString()=" + super.toString() + "]";
    }

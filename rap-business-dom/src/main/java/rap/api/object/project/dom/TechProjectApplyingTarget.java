 ...
 * Program ID : TechProjectApplyingTarget.java
 * ===================================================================
...
import rap.api.object.project.model.TechProjectApplyingTargetVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class TechProjectApplyingTarget extends BusinessObjectMaster {
    public TechProjectApplyingTarget(String obid){
        super(obid);
    }
    public TechProjectApplyingTarget(TechProjectApplyingTargetVO vo){
        super(vo);
    }
    @Override
    public TechProjectApplyingTargetVO getVo(){
        return (TechProjectApplyingTargetVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeTechProjectApplyingTarget();
    }
    public void initializeTechProjectApplyingTarget(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "TechProjectApplyingTarget[toString()=" + super.toString() + "]";
    }

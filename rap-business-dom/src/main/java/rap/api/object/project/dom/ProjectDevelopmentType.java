 ...
 * Program ID : ProjectDevelopmentType.java
 * ===================================================================
...
public class ProjectDevelopmentType extends BusinessObjectMaster {
    public ProjectDevelopmentType(String obid){
        super(obid);
    }
    public ProjectDevelopmentType(ProjectDevelopmentTypeVO vo){
        super(vo);
    }
    @Override
    public ProjectDevelopmentTypeVO getVo(){
        return (ProjectDevelopmentTypeVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectDevelopmentType();
    }
    public void initializeProjectDevelopmentType(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectDevelopmentType[toString()=" + super.toString() + "]";
    }

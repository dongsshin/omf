 ...
 * Program ID : RevisedProjects.java
 * ===================================================================
...
import rap.api.object.project.model.RevisedProjectsVO;
import com.rap.omc.api.object.dom.BusinessObject;


public class RevisedProjects extends BusinessObject {
    public RevisedProjects(String obid){
        super(obid);
    }
    public RevisedProjects(RevisedProjectsVO vo){
        super(vo);
    }
    @Override
    public RevisedProjectsVO getVo(){
        return (RevisedProjectsVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeRevisedProjects();
    }
    public void initializeRevisedProjects(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "RevisedProjects[toString()=" + super.toString() + "]";
    }

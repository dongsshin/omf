 ...
 * Program ID : ECMSSummaryDevType.java
 * ===================================================================
...
import rap.api.object.project.model.ECMSSummaryDevTypeVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ECMSSummaryDevType extends BusinessObjectMaster {
    public ECMSSummaryDevType(String obid){
        super(obid);
    }
    public ECMSSummaryDevType(ECMSSummaryDevTypeVO vo){
        super(vo);
    }
    @Override
    public ECMSSummaryDevTypeVO getVo(){
        return (ECMSSummaryDevTypeVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeECMSSummaryDevType();
    }
    public void initializeECMSSummaryDevType(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ECMSSummaryDevType[toString()=" + super.toString() + "]";
    }

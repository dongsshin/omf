...
import rap.api.object.project.model.ECMSResearchVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ECMSResearch extends BusinessObjectMaster {
    public ECMSResearch(String obid){
        super(obid);
    }
    public ECMSResearch(ECMSResearchVO vo){
        super(vo);
    }
    @Override
    public ECMSResearchVO getVo(){
        return (ECMSResearchVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeECMSResearch();
    }
    public void initializeECMSResearch(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ECMSResearch[toString()=" + super.toString() + "]";
    }

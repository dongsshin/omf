 ...
 * Program ID : FacilityProjectIncome.java
 * ===================================================================
...
import rap.api.object.project.model.FacilityProjectIncomeVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class FacilityProjectIncome extends BusinessObjectMaster {
    public FacilityProjectIncome(String obid){
        super(obid);
    }
    public FacilityProjectIncome(FacilityProjectIncomeVO vo){
        super(vo);
    }
    @Override
    public FacilityProjectIncomeVO getVo(){
        return (FacilityProjectIncomeVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeFacilityProjectIncome();
    }
    public void initializeFacilityProjectIncome(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "FacilityProjectIncome[toString()=" + super.toString() + "]";
    }

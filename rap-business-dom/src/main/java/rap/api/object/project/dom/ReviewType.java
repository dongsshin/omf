...
import rap.api.object.project.model.ReviewTypeVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ReviewType extends BusinessObjectMaster {
    public ReviewType(String obid){
        super(obid);
    }
    public ReviewType(ReviewTypeVO vo){
        super(vo);
    }
    @Override
    public ReviewTypeVO getVo(){
        return (ReviewTypeVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeReviewType();
    }
    public void initializeReviewType(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ReviewType[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : GripEventCheck.java
 * ===================================================================
...
public class GripEventCheck extends BusinessObjectMaster {
    public GripEventCheck(String obid){
        super(obid);
    }
    public GripEventCheck(GripEventCheckVO vo){
        super(vo);
    }
    @Override
    public GripEventCheckVO getVo(){
        return (GripEventCheckVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeGripEventCheck();
    }
    public void initializeGripEventCheck(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "GripEventCheck[toString()=" + super.toString() + "]";
    }

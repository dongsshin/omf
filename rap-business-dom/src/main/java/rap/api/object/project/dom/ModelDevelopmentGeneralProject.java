 ...
 * Program ID : ModelDevelopmentGeneralProject.java
 * ===================================================================
...
public class ModelDevelopmentGeneralProject extends ModelDevelopmentProjects {
    public ModelDevelopmentGeneralProject(String obid){
        super(obid);
    }
    public ModelDevelopmentGeneralProject(ModelDevelopmentGeneralProjectVO vo){
        super(vo);
    }
    @Override
    public ModelDevelopmentGeneralProjectVO getVo(){
        return (ModelDevelopmentGeneralProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeModelDevelopmentGeneralProject();
    }
    public void initializeModelDevelopmentGeneralProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ModelDevelopmentGeneralProject[toString()=" + super.toString() + "]";
    }

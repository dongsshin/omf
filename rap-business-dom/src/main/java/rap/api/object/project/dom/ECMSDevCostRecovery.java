 ...
 * Program ID : ECMSDevCostRecovery.java
 * ===================================================================
...
import rap.api.object.project.model.ECMSDevCostRecoveryVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ECMSDevCostRecovery extends BusinessObjectMaster {
    public ECMSDevCostRecovery(String obid){
        super(obid);
    }
    public ECMSDevCostRecovery(ECMSDevCostRecoveryVO vo){
        super(vo);
    }
    @Override
    public ECMSDevCostRecoveryVO getVo(){
        return (ECMSDevCostRecoveryVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeECMSDevCostRecovery();
    }
    public void initializeECMSDevCostRecovery(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ECMSDevCostRecovery[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.project.model.TechProjectVO;
import rap.api.object.project.dom.Projects;


public class TechProject extends Projects {
    public TechProject(String obid){
        super(obid);
    }
    public TechProject(TechProjectVO vo){
        super(vo);
    }
    @Override
    public TechProjectVO getVo(){
        return (TechProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeTechProject();
    }
    public void initializeTechProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "TechProject[toString()=" + super.toString() + "]";
    }

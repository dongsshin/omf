 ...
 * Program ID : ECMSSampleCost.java
 * ===================================================================
...
import rap.api.object.project.model.ECMSSampleCostVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ECMSSampleCost extends BusinessObjectMaster {
    public ECMSSampleCost(String obid){
        super(obid);
    }
    public ECMSSampleCost(ECMSSampleCostVO vo){
        super(vo);
    }
    @Override
    public ECMSSampleCostVO getVo(){
        return (ECMSSampleCostVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeECMSSampleCost();
    }
    public void initializeECMSSampleCost(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ECMSSampleCost[toString()=" + super.toString() + "]";
    }

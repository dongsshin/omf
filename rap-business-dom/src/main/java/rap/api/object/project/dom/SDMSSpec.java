...
import rap.api.object.project.model.SDMSSpecVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class SDMSSpec extends BusinessObjectMaster {
    public SDMSSpec(String obid){
        super(obid);
    }
    public SDMSSpec(SDMSSpecVO vo){
        super(vo);
    }
    @Override
    public SDMSSpecVO getVo(){
        return (SDMSSpecVO)super.getVo();
    }
    @Override
    ...
    public void initializeSDMSSpec(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "SDMSSpec[toString()=" + super.toString() + "]";
    }

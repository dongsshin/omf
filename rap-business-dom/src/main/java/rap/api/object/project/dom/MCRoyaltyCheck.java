 ...
 * Program ID : MCRoyaltyCheck.java
 * ===================================================================
...
import rap.api.object.project.model.MCRoyaltyCheckVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class MCRoyaltyCheck extends BusinessObjectMaster {
    public MCRoyaltyCheck(String obid){
        super(obid);
    }
    public MCRoyaltyCheck(MCRoyaltyCheckVO vo){
        super(vo);
    }
    @Override
    public MCRoyaltyCheckVO getVo(){
        return (MCRoyaltyCheckVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeMCRoyaltyCheck();
    }
    public void initializeMCRoyaltyCheck(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "MCRoyaltyCheck[toString()=" + super.toString() + "]";
    }

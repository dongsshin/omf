 ...
 * Program ID : ProjectPerformanceReportFile.java
 * ===================================================================
...
import rap.api.object.project.model.ProjectPerformanceReportFileVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectPerformanceReportFile extends BusinessObjectMaster {
    public ProjectPerformanceReportFile(String obid){
        super(obid);
    }
    public ProjectPerformanceReportFile(ProjectPerformanceReportFileVO vo){
        super(vo);
    }
    @Override
    public ProjectPerformanceReportFileVO getVo(){
        return (ProjectPerformanceReportFileVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectPerformanceReportFile();
    }
    public void initializeProjectPerformanceReportFile(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectPerformanceReportFile[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : PerformanceCategory.java
 * ===================================================================
...
import rap.api.object.project.model.PerformanceCategoryVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PerformanceCategory extends BusinessObjectMaster {
    public PerformanceCategory(String obid){
        super(obid);
    }
    public PerformanceCategory(PerformanceCategoryVO vo){
        super(vo);
    }
    @Override
    public PerformanceCategoryVO getVo(){
        return (PerformanceCategoryVO)super.getVo();
    }
    @Override
    ...
    public void initializePerformanceCategory(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PerformanceCategory[toString()=" + super.toString() + "]";
    }

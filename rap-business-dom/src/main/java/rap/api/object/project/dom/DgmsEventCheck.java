 ...
 * Program ID : DgmsEventCheck.java
 * ===================================================================
...
import rap.api.object.project.model.DgmsEventCheckVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class DgmsEventCheck extends BusinessObjectMaster {
    public DgmsEventCheck(String obid){
        super(obid);
    }
    public DgmsEventCheck(DgmsEventCheckVO vo){
        super(vo);
    }
    @Override
    public DgmsEventCheckVO getVo(){
        return (DgmsEventCheckVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDgmsEventCheck();
    }
    public void initializeDgmsEventCheck(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DgmsEventCheck[toString()=" + super.toString() + "]";
    }

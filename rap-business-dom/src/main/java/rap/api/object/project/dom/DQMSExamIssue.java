...
import rap.api.object.project.model.DQMSExamIssueVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class DQMSExamIssue extends BusinessObjectMaster {
    public DQMSExamIssue(String obid){
        super(obid);
    }
    public DQMSExamIssue(DQMSExamIssueVO vo){
        super(vo);
    }
    @Override
    public DQMSExamIssueVO getVo(){
        return (DQMSExamIssueVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDQMSExamIssue();
    }
    public void initializeDQMSExamIssue(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DQMSExamIssue[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.project.model.FinalDRFileVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class FinalDRFile extends BusinessObjectMaster {
    public FinalDRFile(String obid){
        super(obid);
    }
    public FinalDRFile(FinalDRFileVO vo){
        super(vo);
    }
    @Override
    public FinalDRFileVO getVo(){
        return (FinalDRFileVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeFinalDRFile();
    }
    public void initializeFinalDRFile(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "FinalDRFile[toString()=" + super.toString() + "]";
    }

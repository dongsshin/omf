 ...
 * Program ID : DerivationCheckList.java
 * ===================================================================
...
import rap.api.object.project.model.DerivationCheckListVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class DerivationCheckList extends BusinessObjectMaster {
    public DerivationCheckList(String obid){
        super(obid);
    }
    public DerivationCheckList(DerivationCheckListVO vo){
        super(vo);
    }
    @Override
    public DerivationCheckListVO getVo(){
        return (DerivationCheckListVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDerivationCheckList();
    }
    public void initializeDerivationCheckList(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DerivationCheckList[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : OemProjectActivitys.java
 * ===================================================================
...
import rap.api.object.project.model.OemProjectActivitysVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class OemProjectActivitys extends BusinessObjectMaster {
    public OemProjectActivitys(String obid){
        super(obid);
    }
    public OemProjectActivitys(OemProjectActivitysVO vo){
        super(vo);
    }
    @Override
    public OemProjectActivitysVO getVo(){
        return (OemProjectActivitysVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeOemProjectActivitys();
    }
    public void initializeOemProjectActivitys(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "OemProjectActivitys[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ECMSOtherCostVO.java
 * ===================================================================
...
public class ECMSOtherCostVO extends BusinessObjectMasterVO {
    private String        scenarioCode                                      ;
    private String        ecmsDevelopment                                   ;
    private String        ecmsItem                                          ;
    private String        ecmsItemDetail                                    ;
    ...
    public void    setEcmsItem(String ecmsItem){
        this.ecmsItem = ecmsItem;
    }
    public void    setEcmsItemDetail(String ecmsItemDetail){
        this.ecmsItemDetail = ecmsItemDetail;
    }
    ...
    public void    setEstimatedFrequency(Float estimatedFrequency){
    ...
    public String getEcmsItem(){
        return ecmsItem;
    }
    public String getEcmsItemDetail(){
        return ecmsItemDetail;
    }
    ...
    public Float getEstimatedFrequency(){

...
import rap.api.object.project.model.OEMProjectVO;
import rap.api.object.project.dom.OutSideProjects;


public class OEMProject extends OutSideProjects {
    public OEMProject(String obid){
        super(obid);
    }
    public OEMProject(OEMProjectVO vo){
        super(vo);
    }
    @Override
    public OEMProjectVO getVo(){
        return (OEMProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeOEMProject();
    }
    public void initializeOEMProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "OEMProject[toString()=" + super.toString() + "]";
    }

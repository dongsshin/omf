 ...
 * Program ID : ProjectIssueFollowUp.java
 * ===================================================================
...
import rap.api.object.project.model.ProjectIssueFollowUpVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectIssueFollowUp extends BusinessObjectMaster {
    public ProjectIssueFollowUp(String obid){
        super(obid);
    }
    public ProjectIssueFollowUp(ProjectIssueFollowUpVO vo){
        super(vo);
    }
    @Override
    public ProjectIssueFollowUpVO getVo(){
        return (ProjectIssueFollowUpVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectIssueFollowUp();
    }
    public void initializeProjectIssueFollowUp(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectIssueFollowUp[toString()=" + super.toString() + "]";
    }

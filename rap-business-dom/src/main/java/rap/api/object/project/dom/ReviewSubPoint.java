 ...
 * Program ID : ReviewSubPoint.java
 * ===================================================================
...
import rap.api.object.project.model.ReviewSubPointVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ReviewSubPoint extends BusinessObjectMaster {
    public ReviewSubPoint(String obid){
        super(obid);
    }
    public ReviewSubPoint(ReviewSubPointVO vo){
        super(vo);
    }
    @Override
    public ReviewSubPointVO getVo(){
        return (ReviewSubPointVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeReviewSubPoint();
    }
    public void initializeReviewSubPoint(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ReviewSubPoint[toString()=" + super.toString() + "]";
    }

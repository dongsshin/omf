...
import rap.api.object.project.model.ProjectTaskVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectTask extends BusinessObjectMaster {
    public ProjectTask(String obid){
        super(obid);
    }
    public ProjectTask(ProjectTaskVO vo){
        super(vo);
    }
    @Override
    public ProjectTaskVO getVo(){
        return (ProjectTaskVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectTask();
    }
    public void initializeProjectTask(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectTask[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : OemProjectDocuments.java
 * ===================================================================
...
import rap.api.object.project.model.OemProjectDocumentsVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class OemProjectDocuments extends BusinessObjectMaster {
    public OemProjectDocuments(String obid){
        super(obid);
    }
    public OemProjectDocuments(OemProjectDocumentsVO vo){
        super(vo);
    }
    @Override
    public OemProjectDocumentsVO getVo(){
        return (OemProjectDocumentsVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeOemProjectDocuments();
    }
    public void initializeOemProjectDocuments(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "OemProjectDocuments[toString()=" + super.toString() + "]";
    }

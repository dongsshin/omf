 ...
 * Program ID : WBSSubProjects.java
 * ===================================================================
...
public class WBSSubProjects extends WBSItems {
    public WBSSubProjects(String obid){
        super(obid);
    }
    public WBSSubProjects(WBSSubProjectsVO vo){
        super(vo);
    }
    @Override
    public WBSSubProjectsVO getVo(){
        return (WBSSubProjectsVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeWBSSubProjects();
    }
    public void initializeWBSSubProjects(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "WBSSubProjects[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : AccountDivision.java
 * ===================================================================
...
import rap.api.object.project.model.AccountDivisionVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class AccountDivision extends BusinessObjectMaster {
    public AccountDivision(String obid){
        super(obid);
    }
    public AccountDivision(AccountDivisionVO vo){
        super(vo);
    }
    @Override
    public AccountDivisionVO getVo(){
        return (AccountDivisionVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeAccountDivision();
    }
    public void initializeAccountDivision(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "AccountDivision[toString()=" + super.toString() + "]";
    }

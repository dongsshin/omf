...
import rap.api.object.project.model.CheckItemVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class CheckItem extends BusinessObjectMaster {
    public CheckItem(String obid){
        super(obid);
    }
    public CheckItem(CheckItemVO vo){
        super(vo);
    }
    @Override
    public CheckItemVO getVo(){
        return (CheckItemVO)super.getVo();
    }
    @Override
    ...
    public void initializeCheckItem(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "CheckItem[toString()=" + super.toString() + "]";
    }

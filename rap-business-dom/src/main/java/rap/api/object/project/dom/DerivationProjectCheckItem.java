 ...
 * Program ID : DerivationProjectCheckItem.java
 * ===================================================================
...
import rap.api.object.project.model.DerivationProjectCheckItemVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class DerivationProjectCheckItem extends BusinessObjectMaster {
    public DerivationProjectCheckItem(String obid){
        super(obid);
    }
    public DerivationProjectCheckItem(DerivationProjectCheckItemVO vo){
        super(vo);
    }
    @Override
    public DerivationProjectCheckItemVO getVo(){
        return (DerivationProjectCheckItemVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDerivationProjectCheckItem();
    }
    public void initializeDerivationProjectCheckItem(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DerivationProjectCheckItem[toString()=" + super.toString() + "]";
    }

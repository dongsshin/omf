...
import rap.api.object.project.model.WBSItemMasterVO;
import com.rap.omc.api.object.dom.BusinessStructuredObjectMaster;


public class WBSItemMaster extends BusinessStructuredObjectMaster {
    public WBSItemMaster(String obid){
        super(obid);
    }
    public WBSItemMaster(WBSItemMasterVO vo){
        super(vo);
    }
    @Override
    public WBSItemMasterVO getVo(){
        return (WBSItemMasterVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeWBSItemMaster();
    }
    public void initializeWBSItemMaster(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "WBSItemMaster[toString()=" + super.toString() + "]";
    }

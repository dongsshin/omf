 ...
 * Program ID : WBSSubProjectTemplate.java
 * ===================================================================
...
public class WBSSubProjectTemplate extends WBSItemTemplates {
    public WBSSubProjectTemplate(String obid){
        super(obid);
    }
    public WBSSubProjectTemplate(WBSSubProjectTemplateVO vo){
        super(vo);
    }
    @Override
    public WBSSubProjectTemplateVO getVo(){
        return (WBSSubProjectTemplateVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeWBSSubProjectTemplate();
    }
    public void initializeWBSSubProjectTemplate(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "WBSSubProjectTemplate[toString()=" + super.toString() + "]";
    }

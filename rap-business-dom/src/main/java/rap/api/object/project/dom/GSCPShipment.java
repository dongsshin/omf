...
import rap.api.object.project.model.GSCPShipmentVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class GSCPShipment extends BusinessObjectMaster {
    public GSCPShipment(String obid){
        super(obid);
    }
    public GSCPShipment(GSCPShipmentVO vo){
        super(vo);
    }
    @Override
    public GSCPShipmentVO getVo(){
        return (GSCPShipmentVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeGSCPShipment();
    }
    public void initializeGSCPShipment(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "GSCPShipment[toString()=" + super.toString() + "]";
    }

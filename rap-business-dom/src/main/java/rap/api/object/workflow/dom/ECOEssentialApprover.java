 ...
 * Program ID : ECOEssentialApprover.java
 * ===================================================================
...
import rap.api.object.workflow.model.ECOEssentialApproverVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ECOEssentialApprover extends BusinessObjectMaster {
    public ECOEssentialApprover(String obid){
        super(obid);
    }
    public ECOEssentialApprover(ECOEssentialApproverVO vo){
        super(vo);
    }
    @Override
    public ECOEssentialApproverVO getVo(){
        return (ECOEssentialApproverVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeECOEssentialApprover();
    }
    public void initializeECOEssentialApprover(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ECOEssentialApprover[toString()=" + super.toString() + "]";
    }

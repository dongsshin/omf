 ...
 * Program ID : ECOEssentialApproverItem.java
 * ===================================================================
...
import rap.api.object.workflow.model.ECOEssentialApproverItemVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ECOEssentialApproverItem extends BusinessObjectMaster {
    public ECOEssentialApproverItem(String obid){
        super(obid);
    }
    public ECOEssentialApproverItem(ECOEssentialApproverItemVO vo){
        super(vo);
    }
    @Override
    public ECOEssentialApproverItemVO getVo(){
        return (ECOEssentialApproverItemVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeECOEssentialApproverItem();
    }
    public void initializeECOEssentialApproverItem(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ECOEssentialApproverItem[toString()=" + super.toString() + "]";
    }

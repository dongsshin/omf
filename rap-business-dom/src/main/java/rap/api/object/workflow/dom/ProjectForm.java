...
import rap.api.object.workflow.model.ProjectFormVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectForm extends BusinessObjectMaster {
    public ProjectForm(String obid){
        super(obid);
    }
    public ProjectForm(ProjectFormVO vo){
        super(vo);
    }
    @Override
    public ProjectFormVO getVo(){
        return (ProjectFormVO)super.getVo();
    }
    @Override
    ...
    public void initializeProjectForm(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectForm[toString()=" + super.toString() + "]";
    }

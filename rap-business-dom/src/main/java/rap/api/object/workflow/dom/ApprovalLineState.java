 ...
 * Program ID : ApprovalLineState.java
 * ===================================================================
...
public class ApprovalLineState extends BusinessObject {
    public ApprovalLineState(String obid){
        super(obid);
    }
    public ApprovalLineState(ApprovalLineStateVO vo){
        super(vo);
    }
    @Override
    public ApprovalLineStateVO getVo(){
        return (ApprovalLineStateVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeApprovalLineState();
    }
    public void initializeApprovalLineState(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ApprovalLineState[toString()=" + super.toString() + "]";
    }

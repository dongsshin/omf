 ...
 * Program ID : ECOEssentialApproverLog.java
 * ===================================================================
...
import rap.api.object.workflow.model.ECOEssentialApproverLogVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ECOEssentialApproverLog extends BusinessObjectMaster {
    public ECOEssentialApproverLog(String obid){
        super(obid);
    }
    public ECOEssentialApproverLog(ECOEssentialApproverLogVO vo){
        super(vo);
    }
    @Override
    public ECOEssentialApproverLogVO getVo(){
        return (ECOEssentialApproverLogVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeECOEssentialApproverLog();
    }
    public void initializeECOEssentialApproverLog(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ECOEssentialApproverLog[toString()=" + super.toString() + "]";
    }

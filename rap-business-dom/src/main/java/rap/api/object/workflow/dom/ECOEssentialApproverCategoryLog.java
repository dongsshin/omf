 ...
 * Program ID : ECOEssentialApproverCategoryLog.java
 * ===================================================================
...
import rap.api.object.workflow.model.ECOEssentialApproverCategoryLogVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ECOEssentialApproverCategoryLog extends BusinessObjectMaster {
    public ECOEssentialApproverCategoryLog(String obid){
        super(obid);
    }
    public ECOEssentialApproverCategoryLog(ECOEssentialApproverCategoryLogVO vo){
        super(vo);
    }
    @Override
    public ECOEssentialApproverCategoryLogVO getVo(){
        return (ECOEssentialApproverCategoryLogVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeECOEssentialApproverCategoryLog();
    }
    public void initializeECOEssentialApproverCategoryLog(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ECOEssentialApproverCategoryLog[toString()=" + super.toString() + "]";
    }

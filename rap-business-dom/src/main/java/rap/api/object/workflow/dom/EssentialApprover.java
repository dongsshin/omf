 ...
 * Program ID : EssentialApprover.java
 * ===================================================================
...
import rap.api.object.workflow.model.EssentialApproverVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class EssentialApprover extends BusinessObjectMaster {
    public EssentialApprover(String obid){
        super(obid);
    }
    public EssentialApprover(EssentialApproverVO vo){
        super(vo);
    }
    @Override
    public EssentialApproverVO getVo(){
        return (EssentialApproverVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeEssentialApprover();
    }
    public void initializeEssentialApprover(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "EssentialApprover[toString()=" + super.toString() + "]";
    }

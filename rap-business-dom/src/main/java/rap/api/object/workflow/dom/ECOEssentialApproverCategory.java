 ...
 * Program ID : ECOEssentialApproverCategory.java
 * ===================================================================
...
import rap.api.object.workflow.model.ECOEssentialApproverCategoryVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ECOEssentialApproverCategory extends BusinessObjectMaster {
    public ECOEssentialApproverCategory(String obid){
        super(obid);
    }
    public ECOEssentialApproverCategory(ECOEssentialApproverCategoryVO vo){
        super(vo);
    }
    @Override
    public ECOEssentialApproverCategoryVO getVo(){
        return (ECOEssentialApproverCategoryVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeECOEssentialApproverCategory();
    }
    public void initializeECOEssentialApproverCategory(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ECOEssentialApproverCategory[toString()=" + super.toString() + "]";
    }

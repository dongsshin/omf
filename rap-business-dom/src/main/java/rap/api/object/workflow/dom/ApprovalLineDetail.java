 ...
 * Program ID : ApprovalLineDetail.java
 * ===================================================================
...
import rap.api.object.workflow.model.ApprovalLineDetailVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ApprovalLineDetail extends BusinessObjectMaster {
    public ApprovalLineDetail(String obid){
        super(obid);
    }
    public ApprovalLineDetail(ApprovalLineDetailVO vo){
        super(vo);
    }
    @Override
    public ApprovalLineDetailVO getVo(){
        return (ApprovalLineDetailVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeApprovalLineDetail();
    }
    public void initializeApprovalLineDetail(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ApprovalLineDetail[toString()=" + super.toString() + "]";
    }

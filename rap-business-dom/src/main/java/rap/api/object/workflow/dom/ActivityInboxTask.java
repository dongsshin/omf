 ...
 * Program ID : ActivityInboxTask.java
 * ===================================================================
...
import rap.api.object.workflow.model.ActivityInboxTaskVO;
import rap.api.object.workflow.dom.InBoxTask;


public class ActivityInboxTask extends InBoxTask {
    public ActivityInboxTask(String obid){
        super(obid);
    }
    public ActivityInboxTask(ActivityInboxTaskVO vo){
        super(vo);
    }
    @Override
    public ActivityInboxTaskVO getVo(){
        return (ActivityInboxTaskVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeActivityInboxTask();
    }
    public void initializeActivityInboxTask(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ActivityInboxTask[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ApprovalLineTeamRole.java
 * ===================================================================
...
import rap.api.object.workflow.model.ApprovalLineTeamRoleVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ApprovalLineTeamRole extends BusinessObjectMaster {
    public ApprovalLineTeamRole(String obid){
        super(obid);
    }
    public ApprovalLineTeamRole(ApprovalLineTeamRoleVO vo){
        super(vo);
    }
    @Override
    public ApprovalLineTeamRoleVO getVo(){
        return (ApprovalLineTeamRoleVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeApprovalLineTeamRole();
    }
    public void initializeApprovalLineTeamRole(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ApprovalLineTeamRole[toString()=" + super.toString() + "]";
    }

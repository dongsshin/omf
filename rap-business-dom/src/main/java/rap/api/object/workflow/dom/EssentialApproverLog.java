 ...
 * Program ID : EssentialApproverLog.java
 * ===================================================================
...
public class EssentialApproverLog extends BusinessObjectMaster {
    public EssentialApproverLog(String obid){
        super(obid);
    }
    public EssentialApproverLog(EssentialApproverLogVO vo){
        super(vo);
    }
    @Override
    public EssentialApproverLogVO getVo(){
        return (EssentialApproverLogVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeEssentialApproverLog();
    }
    public void initializeEssentialApproverLog(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "EssentialApproverLog[toString()=" + super.toString() + "]";
    }

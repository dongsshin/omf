 ...
 * Program ID : ApprovalLineMaster.java
 * ===================================================================
...
import rap.api.object.workflow.model.ApprovalLineMasterVO;
import rap.application.workflow.model.ApprovalVO;


public class ApprovalLineMaster extends BusinessObjectMaster {
    public ApprovalLineMaster(String obid){
        super(obid);
    }
    public ApprovalLineMaster(ApprovalLineMasterVO vo){
        super(vo);
    }
    @Override
    public ApprovalLineMasterVO getVo(){
        return (ApprovalLineMasterVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeApprovalLineMaster();
    }
    public void initializeApprovalLineMaster(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ApprovalLineMaster[toString()=" + super.toString() + "]";
    }
    ...
    public static List<ApprovalVO> getProjectApprovalLine(String requestType, String organizationType, String requestSubType,
            String projectType, String productGroupCode, String processType,
            String gradeCode, String devSiteCode, String activityDocument, String projectObid) {
    	return null;
    }

 ...
 * Program ID : ApprovalLineAmount.java
 * ===================================================================
...
import rap.api.object.workflow.model.ApprovalLineAmountVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ApprovalLineAmount extends BusinessObjectMaster {
    public ApprovalLineAmount(String obid){
        super(obid);
    }
    public ApprovalLineAmount(ApprovalLineAmountVO vo){
        super(vo);
    }
    @Override
    public ApprovalLineAmountVO getVo(){
        return (ApprovalLineAmountVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeApprovalLineAmount();
    }
    public void initializeApprovalLineAmount(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ApprovalLineAmount[toString()=" + super.toString() + "]";
    }

...
public class ApprovalLine extends BusinessObjectMaster {
    public ApprovalLine(String obid){
        super(obid);
    }
    public ApprovalLine(ApprovalLineVO vo){
        super(vo);
    }
    @Override
    public ApprovalLineVO getVo(){
        return (ApprovalLineVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeApprovalLine();
    }
    public void initializeApprovalLine(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ApprovalLine[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ECOEssentialApproverItemLog.java
 * ===================================================================
...
import rap.api.object.workflow.model.ECOEssentialApproverItemLogVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ECOEssentialApproverItemLog extends BusinessObjectMaster {
    public ECOEssentialApproverItemLog(String obid){
        super(obid);
    }
    public ECOEssentialApproverItemLog(ECOEssentialApproverItemLogVO vo){
        super(vo);
    }
    @Override
    public ECOEssentialApproverItemLogVO getVo(){
        return (ECOEssentialApproverItemLogVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeECOEssentialApproverItemLog();
    }
    public void initializeECOEssentialApproverItemLog(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ECOEssentialApproverItemLog[toString()=" + super.toString() + "]";
    }

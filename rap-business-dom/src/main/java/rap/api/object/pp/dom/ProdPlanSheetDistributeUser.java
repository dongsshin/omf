 ...
 * Program ID : ProdPlanSheetDistributeUser.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanSheetDistributeUserVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanSheetDistributeUser extends BusinessObjectMaster {
    public ProdPlanSheetDistributeUser(String obid){
        super(obid);
    }
    public ProdPlanSheetDistributeUser(ProdPlanSheetDistributeUserVO vo){
        super(vo);
    }
    @Override
    public ProdPlanSheetDistributeUserVO getVo(){
        return (ProdPlanSheetDistributeUserVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanSheetDistributeUser();
    }
    public void initializeProdPlanSheetDistributeUser(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanSheetDistributeUser[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ProdPlanExcelTemplateFile.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanExcelTemplateFileVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanExcelTemplateFile extends BusinessObjectMaster {
    public ProdPlanExcelTemplateFile(String obid){
        super(obid);
    }
    public ProdPlanExcelTemplateFile(ProdPlanExcelTemplateFileVO vo){
        super(vo);
    }
    @Override
    public ProdPlanExcelTemplateFileVO getVo(){
        return (ProdPlanExcelTemplateFileVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanExcelTemplateFile();
    }
    public void initializeProdPlanExcelTemplateFile(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanExcelTemplateFile[toString()=" + super.toString() + "]";
    }

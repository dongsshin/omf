 ...
 * Program ID : ProdPlanPRMSheetHistory.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanPRMSheetHistoryVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanPRMSheetHistory extends BusinessObjectMaster {
    public ProdPlanPRMSheetHistory(String obid){
        super(obid);
    }
    public ProdPlanPRMSheetHistory(ProdPlanPRMSheetHistoryVO vo){
        super(vo);
    }
    @Override
    public ProdPlanPRMSheetHistoryVO getVo(){
        return (ProdPlanPRMSheetHistoryVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanPRMSheetHistory();
    }
    public void initializeProdPlanPRMSheetHistory(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanPRMSheetHistory[toString()=" + super.toString() + "]";
    }

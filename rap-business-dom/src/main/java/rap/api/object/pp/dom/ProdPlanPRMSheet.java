 ...
 * Program ID : ProdPlanPRMSheet.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanPRMSheetVO;
import com.rap.omc.api.object.dom.BusinessObject;


public class ProdPlanPRMSheet extends BusinessObject {
    public ProdPlanPRMSheet(String obid){
        super(obid);
    }
    public ProdPlanPRMSheet(ProdPlanPRMSheetVO vo){
        super(vo);
    }
    @Override
    public ProdPlanPRMSheetVO getVo(){
        return (ProdPlanPRMSheetVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanPRMSheet();
    }
    public void initializeProdPlanPRMSheet(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanPRMSheet[toString()=" + super.toString() + "]";
    }

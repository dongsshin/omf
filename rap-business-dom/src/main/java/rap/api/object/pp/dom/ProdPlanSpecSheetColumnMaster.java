 ...
 * Program ID : ProdPlanSpecSheetColumnMaster.java
 * ===================================================================
 *  Modification Date      Modifier           Description
 *      2017.04.??       DS Shin            Initial
 * ===================================================================
 */
package rap.api.object.pp.dom;


import java.util.Map;
import rap.api.object.pp.model.ProdPlanSpecSheetColumnMasterVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanSpecSheetColumnMaster extends BusinessObjectMaster {
    public ProdPlanSpecSheetColumnMaster(String obid){
        super(obid);
    }
    public ProdPlanSpecSheetColumnMaster(ProdPlanSpecSheetColumnMasterVO vo){
        super(vo);
    }
    @Override
    public ProdPlanSpecSheetColumnMasterVO getVo(){
        return (ProdPlanSpecSheetColumnMasterVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanSpecSheetColumnMaster();
    }
    public void initializeProdPlanSpecSheetColumnMaster(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanSpecSheetColumnMaster[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ProdPlanSpecSheetGroup.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanSpecSheetGroupVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanSpecSheetGroup extends BusinessObjectMaster {
    public ProdPlanSpecSheetGroup(String obid){
        super(obid);
    }
    public ProdPlanSpecSheetGroup(ProdPlanSpecSheetGroupVO vo){
        super(vo);
    }
    @Override
    public ProdPlanSpecSheetGroupVO getVo(){
        return (ProdPlanSpecSheetGroupVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanSpecSheetGroup();
    }
    public void initializeProdPlanSpecSheetGroup(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanSpecSheetGroup[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ProdPlanPRMSheetGroup.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanPRMSheetGroupVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanPRMSheetGroup extends BusinessObjectMaster {
    public ProdPlanPRMSheetGroup(String obid){
        super(obid);
    }
    public ProdPlanPRMSheetGroup(ProdPlanPRMSheetGroupVO vo){
        super(vo);
    }
    @Override
    public ProdPlanPRMSheetGroupVO getVo(){
        return (ProdPlanPRMSheetGroupVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanPRMSheetGroup();
    }
    public void initializeProdPlanPRMSheetGroup(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanPRMSheetGroup[toString()=" + super.toString() + "]";
    }

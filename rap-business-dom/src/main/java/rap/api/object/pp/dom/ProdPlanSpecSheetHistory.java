 ...
 * Program ID : ProdPlanSpecSheetHistory.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanSpecSheetHistoryVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanSpecSheetHistory extends BusinessObjectMaster {
    public ProdPlanSpecSheetHistory(String obid){
        super(obid);
    }
    public ProdPlanSpecSheetHistory(ProdPlanSpecSheetHistoryVO vo){
        super(vo);
    }
    @Override
    public ProdPlanSpecSheetHistoryVO getVo(){
        return (ProdPlanSpecSheetHistoryVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanSpecSheetHistory();
    }
    public void initializeProdPlanSpecSheetHistory(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanSpecSheetHistory[toString()=" + super.toString() + "]";
    }

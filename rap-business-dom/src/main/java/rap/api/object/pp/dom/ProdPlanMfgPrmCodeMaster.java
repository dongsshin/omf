 ...
 * Program ID : ProdPlanMfgPrmCodeMaster.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanMfgPrmCodeMasterVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanMfgPrmCodeMaster extends BusinessObjectMaster {
    public ProdPlanMfgPrmCodeMaster(String obid){
        super(obid);
    }
    public ProdPlanMfgPrmCodeMaster(ProdPlanMfgPrmCodeMasterVO vo){
        super(vo);
    }
    @Override
    public ProdPlanMfgPrmCodeMasterVO getVo(){
        return (ProdPlanMfgPrmCodeMasterVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanMfgPrmCodeMaster();
    }
    public void initializeProdPlanMfgPrmCodeMaster(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanMfgPrmCodeMaster[toString()=" + super.toString() + "]";
    }

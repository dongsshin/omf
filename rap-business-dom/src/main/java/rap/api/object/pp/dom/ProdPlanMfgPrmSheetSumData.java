 ...
 * Program ID : ProdPlanMfgPrmSheetSumData.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanMfgPrmSheetSumDataVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanMfgPrmSheetSumData extends BusinessObjectMaster {
    public ProdPlanMfgPrmSheetSumData(String obid){
        super(obid);
    }
    public ProdPlanMfgPrmSheetSumData(ProdPlanMfgPrmSheetSumDataVO vo){
        super(vo);
    }
    @Override
    public ProdPlanMfgPrmSheetSumDataVO getVo(){
        return (ProdPlanMfgPrmSheetSumDataVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanMfgPrmSheetSumData();
    }
    public void initializeProdPlanMfgPrmSheetSumData(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanMfgPrmSheetSumData[toString()=" + super.toString() + "]";
    }

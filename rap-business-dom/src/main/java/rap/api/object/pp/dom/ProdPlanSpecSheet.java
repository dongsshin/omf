 ...
 * Program ID : ProdPlanSpecSheet.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanSpecSheetVO;
import com.rap.omc.api.object.dom.BusinessObject;


public class ProdPlanSpecSheet extends BusinessObject {
    public ProdPlanSpecSheet(String obid){
        super(obid);
    }
    public ProdPlanSpecSheet(ProdPlanSpecSheetVO vo){
        super(vo);
    }
    @Override
    public ProdPlanSpecSheetVO getVo(){
        return (ProdPlanSpecSheetVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanSpecSheet();
    }
    public void initializeProdPlanSpecSheet(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanSpecSheet[toString()=" + super.toString() + "]";
    }

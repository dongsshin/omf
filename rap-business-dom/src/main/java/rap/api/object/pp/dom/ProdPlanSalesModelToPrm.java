 ...
 * Program ID : ProdPlanSalesModelToPrm.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanSalesModelToPrmVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanSalesModelToPrm extends BusinessObjectMaster {
    public ProdPlanSalesModelToPrm(String obid){
        super(obid);
    }
    public ProdPlanSalesModelToPrm(ProdPlanSalesModelToPrmVO vo){
        super(vo);
    }
    @Override
    public ProdPlanSalesModelToPrmVO getVo(){
        return (ProdPlanSalesModelToPrmVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanSalesModelToPrm();
    }
    public void initializeProdPlanSalesModelToPrm(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanSalesModelToPrm[toString()=" + super.toString() + "]";
    }

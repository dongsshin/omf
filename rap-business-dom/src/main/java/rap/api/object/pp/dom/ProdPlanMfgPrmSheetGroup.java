 ...
 * Program ID : ProdPlanMfgPrmSheetGroup.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanMfgPrmSheetGroupVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanMfgPrmSheetGroup extends BusinessObjectMaster {
    public ProdPlanMfgPrmSheetGroup(String obid){
        super(obid);
    }
    public ProdPlanMfgPrmSheetGroup(ProdPlanMfgPrmSheetGroupVO vo){
        super(vo);
    }
    @Override
    public ProdPlanMfgPrmSheetGroupVO getVo(){
        return (ProdPlanMfgPrmSheetGroupVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanMfgPrmSheetGroup();
    }
    public void initializeProdPlanMfgPrmSheetGroup(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanMfgPrmSheetGroup[toString()=" + super.toString() + "]";
    }

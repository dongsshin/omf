 ...
 * Program ID : ProdPlanPRMCodeMaster.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanPRMCodeMasterVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanPRMCodeMaster extends BusinessObjectMaster {
    public ProdPlanPRMCodeMaster(String obid){
        super(obid);
    }
    public ProdPlanPRMCodeMaster(ProdPlanPRMCodeMasterVO vo){
        super(vo);
    }
    @Override
    public ProdPlanPRMCodeMasterVO getVo(){
        return (ProdPlanPRMCodeMasterVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanPRMCodeMaster();
    }
    public void initializeProdPlanPRMCodeMaster(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanPRMCodeMaster[toString()=" + super.toString() + "]";
    }

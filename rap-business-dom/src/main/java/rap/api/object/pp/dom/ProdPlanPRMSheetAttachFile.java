 ...
 * Program ID : ProdPlanPRMSheetAttachFile.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanPRMSheetAttachFileVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanPRMSheetAttachFile extends BusinessObjectMaster {
    public ProdPlanPRMSheetAttachFile(String obid){
        super(obid);
    }
    public ProdPlanPRMSheetAttachFile(ProdPlanPRMSheetAttachFileVO vo){
        super(vo);
    }
    @Override
    public ProdPlanPRMSheetAttachFileVO getVo(){
        return (ProdPlanPRMSheetAttachFileVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanPRMSheetAttachFile();
    }
    public void initializeProdPlanPRMSheetAttachFile(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanPRMSheetAttachFile[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ProdPlanSpecSheetData.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanSpecSheetDataVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanSpecSheetData extends BusinessObjectMaster {
    public ProdPlanSpecSheetData(String obid){
        super(obid);
    }
    public ProdPlanSpecSheetData(ProdPlanSpecSheetDataVO vo){
        super(vo);
    }
    @Override
    public ProdPlanSpecSheetDataVO getVo(){
        return (ProdPlanSpecSheetDataVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanSpecSheetData();
    }
    public void initializeProdPlanSpecSheetData(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanSpecSheetData[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ProdPlanSheetDistribute.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanSheetDistributeVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanSheetDistribute extends BusinessObjectMaster {
    public ProdPlanSheetDistribute(String obid){
        super(obid);
    }
    public ProdPlanSheetDistribute(ProdPlanSheetDistributeVO vo){
        super(vo);
    }
    @Override
    public ProdPlanSheetDistributeVO getVo(){
        return (ProdPlanSheetDistributeVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanSheetDistribute();
    }
    public void initializeProdPlanSheetDistribute(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanSheetDistribute[toString()=" + super.toString() + "]";
    }

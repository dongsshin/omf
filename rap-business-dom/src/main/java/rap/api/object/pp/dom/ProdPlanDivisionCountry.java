 ...
 * Program ID : ProdPlanDivisionCountry.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanDivisionCountryVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanDivisionCountry extends BusinessObjectMaster {
    public ProdPlanDivisionCountry(String obid){
        super(obid);
    }
    public ProdPlanDivisionCountry(ProdPlanDivisionCountryVO vo){
        super(vo);
    }
    @Override
    public ProdPlanDivisionCountryVO getVo(){
        return (ProdPlanDivisionCountryVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanDivisionCountry();
    }
    public void initializeProdPlanDivisionCountry(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanDivisionCountry[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ProdPlanPRMSheetData.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanPRMSheetDataVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanPRMSheetData extends BusinessObjectMaster {
    public ProdPlanPRMSheetData(String obid){
        super(obid);
    }
    public ProdPlanPRMSheetData(ProdPlanPRMSheetDataVO vo){
        super(vo);
    }
    @Override
    public ProdPlanPRMSheetDataVO getVo(){
        return (ProdPlanPRMSheetDataVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanPRMSheetData();
    }
    public void initializeProdPlanPRMSheetData(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanPRMSheetData[toString()=" + super.toString() + "]";
    }

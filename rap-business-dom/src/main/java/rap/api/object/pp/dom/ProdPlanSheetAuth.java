 ...
 * Program ID : ProdPlanSheetAuth.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanSheetAuthVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanSheetAuth extends BusinessObjectMaster {
    public ProdPlanSheetAuth(String obid){
        super(obid);
    }
    public ProdPlanSheetAuth(ProdPlanSheetAuthVO vo){
        super(vo);
    }
    @Override
    public ProdPlanSheetAuthVO getVo(){
        return (ProdPlanSheetAuthVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanSheetAuth();
    }
    public void initializeProdPlanSheetAuth(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanSheetAuth[toString()=" + super.toString() + "]";
    }

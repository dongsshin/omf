 ...
 * Program ID : ProdPlanProductType.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanProductTypeVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanProductType extends BusinessObjectMaster {
    public ProdPlanProductType(String obid){
        super(obid);
    }
    public ProdPlanProductType(ProdPlanProductTypeVO vo){
        super(vo);
    }
    @Override
    public ProdPlanProductTypeVO getVo(){
        return (ProdPlanProductTypeVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanProductType();
    }
    public void initializeProdPlanProductType(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanProductType[toString()=" + super.toString() + "]";
    }

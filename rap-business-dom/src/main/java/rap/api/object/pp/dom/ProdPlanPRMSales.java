 ...
 * Program ID : ProdPlanPRMSales.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanPRMSalesVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanPRMSales extends BusinessObjectMaster {
    public ProdPlanPRMSales(String obid){
        super(obid);
    }
    public ProdPlanPRMSales(ProdPlanPRMSalesVO vo){
        super(vo);
    }
    @Override
    public ProdPlanPRMSalesVO getVo(){
        return (ProdPlanPRMSalesVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanPRMSales();
    }
    public void initializeProdPlanPRMSales(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanPRMSales[toString()=" + super.toString() + "]";
    }

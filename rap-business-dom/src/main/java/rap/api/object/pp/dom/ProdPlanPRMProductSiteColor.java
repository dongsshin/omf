 ...
 * Program ID : ProdPlanPRMProductSiteColor.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanPRMProductSiteColorVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanPRMProductSiteColor extends BusinessObjectMaster {
    public ProdPlanPRMProductSiteColor(String obid){
        super(obid);
    }
    public ProdPlanPRMProductSiteColor(ProdPlanPRMProductSiteColorVO vo){
        super(vo);
    }
    @Override
    public ProdPlanPRMProductSiteColorVO getVo(){
        return (ProdPlanPRMProductSiteColorVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanPRMProductSiteColor();
    }
    public void initializeProdPlanPRMProductSiteColor(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanPRMProductSiteColor[toString()=" + super.toString() + "]";
    }

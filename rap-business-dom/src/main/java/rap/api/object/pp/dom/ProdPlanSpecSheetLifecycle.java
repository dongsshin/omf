 ...
 * Program ID : ProdPlanSpecSheetLifecycle.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanSpecSheetLifecycleVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanSpecSheetLifecycle extends BusinessObjectMaster {
    public ProdPlanSpecSheetLifecycle(String obid){
        super(obid);
    }
    public ProdPlanSpecSheetLifecycle(ProdPlanSpecSheetLifecycleVO vo){
        super(vo);
    }
    @Override
    public ProdPlanSpecSheetLifecycleVO getVo(){
        return (ProdPlanSpecSheetLifecycleVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanSpecSheetLifecycle();
    }
    public void initializeProdPlanSpecSheetLifecycle(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanSpecSheetLifecycle[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ProdPlanApproverMatrix.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanApproverMatrixVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanApproverMatrix extends BusinessObjectMaster {
    public ProdPlanApproverMatrix(String obid){
        super(obid);
    }
    public ProdPlanApproverMatrix(ProdPlanApproverMatrixVO vo){
        super(vo);
    }
    @Override
    public ProdPlanApproverMatrixVO getVo(){
        return (ProdPlanApproverMatrixVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanApproverMatrix();
    }
    public void initializeProdPlanApproverMatrix(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanApproverMatrix[toString()=" + super.toString() + "]";
    }

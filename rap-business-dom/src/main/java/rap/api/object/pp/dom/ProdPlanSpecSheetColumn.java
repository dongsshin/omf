 ...
 * Program ID : ProdPlanSpecSheetColumn.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanSpecSheetColumnVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanSpecSheetColumn extends BusinessObjectMaster {
    public ProdPlanSpecSheetColumn(String obid){
        super(obid);
    }
    public ProdPlanSpecSheetColumn(ProdPlanSpecSheetColumnVO vo){
        super(vo);
    }
    @Override
    public ProdPlanSpecSheetColumnVO getVo(){
        return (ProdPlanSpecSheetColumnVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanSpecSheetColumn();
    }
    public void initializeProdPlanSpecSheetColumn(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanSpecSheetColumn[toString()=" + super.toString() + "]";
    }

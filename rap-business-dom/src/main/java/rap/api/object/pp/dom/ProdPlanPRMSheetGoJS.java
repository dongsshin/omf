 ...
 * Program ID : ProdPlanPRMSheetGoJS.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanPRMSheetGoJSVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanPRMSheetGoJS extends BusinessObjectMaster {
    public ProdPlanPRMSheetGoJS(String obid){
        super(obid);
    }
    public ProdPlanPRMSheetGoJS(ProdPlanPRMSheetGoJSVO vo){
        super(vo);
    }
    @Override
    public ProdPlanPRMSheetGoJSVO getVo(){
        return (ProdPlanPRMSheetGoJSVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanPRMSheetGoJS();
    }
    public void initializeProdPlanPRMSheetGoJS(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanPRMSheetGoJS[toString()=" + super.toString() + "]";
    }

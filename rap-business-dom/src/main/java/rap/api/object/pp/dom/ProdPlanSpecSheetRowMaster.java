 ...
 * Program ID : ProdPlanSpecSheetRowMaster.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanSpecSheetRowMasterVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanSpecSheetRowMaster extends BusinessObjectMaster {
    public ProdPlanSpecSheetRowMaster(String obid){
        super(obid);
    }
    public ProdPlanSpecSheetRowMaster(ProdPlanSpecSheetRowMasterVO vo){
        super(vo);
    }
    @Override
    public ProdPlanSpecSheetRowMasterVO getVo(){
        return (ProdPlanSpecSheetRowMasterVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanSpecSheetRowMaster();
    }
    public void initializeProdPlanSpecSheetRowMaster(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanSpecSheetRowMaster[toString()=" + super.toString() + "]";
    }

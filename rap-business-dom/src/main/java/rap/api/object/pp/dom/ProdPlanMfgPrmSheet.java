 ...
 * Program ID : ProdPlanMfgPrmSheet.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanMfgPrmSheetVO;
import com.rap.omc.api.object.dom.BusinessObject;


public class ProdPlanMfgPrmSheet extends BusinessObject {
    public ProdPlanMfgPrmSheet(String obid){
        super(obid);
    }
    public ProdPlanMfgPrmSheet(ProdPlanMfgPrmSheetVO vo){
        super(vo);
    }
    @Override
    public ProdPlanMfgPrmSheetVO getVo(){
        return (ProdPlanMfgPrmSheetVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanMfgPrmSheet();
    }
    public void initializeProdPlanMfgPrmSheet(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanMfgPrmSheet[toString()=" + super.toString() + "]";
    }

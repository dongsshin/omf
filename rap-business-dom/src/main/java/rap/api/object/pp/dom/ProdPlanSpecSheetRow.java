 ...
 * Program ID : ProdPlanSpecSheetRow.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanSpecSheetRowVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanSpecSheetRow extends BusinessObjectMaster {
    public ProdPlanSpecSheetRow(String obid){
        super(obid);
    }
    public ProdPlanSpecSheetRow(ProdPlanSpecSheetRowVO vo){
        super(vo);
    }
    @Override
    public ProdPlanSpecSheetRowVO getVo(){
        return (ProdPlanSpecSheetRowVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanSpecSheetRow();
    }
    public void initializeProdPlanSpecSheetRow(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanSpecSheetRow[toString()=" + super.toString() + "]";
    }

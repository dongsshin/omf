 ...
 * Program ID : ProdPlanSpecSheetDataHistory.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanSpecSheetDataHistoryVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanSpecSheetDataHistory extends BusinessObjectMaster {
    public ProdPlanSpecSheetDataHistory(String obid){
        super(obid);
    }
    public ProdPlanSpecSheetDataHistory(ProdPlanSpecSheetDataHistoryVO vo){
        super(vo);
    }
    @Override
    public ProdPlanSpecSheetDataHistoryVO getVo(){
        return (ProdPlanSpecSheetDataHistoryVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanSpecSheetDataHistory();
    }
    public void initializeProdPlanSpecSheetDataHistory(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanSpecSheetDataHistory[toString()=" + super.toString() + "]";
    }

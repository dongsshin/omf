 ...
 * Program ID : ProdPlanMfgPrmSheetData.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanMfgPrmSheetDataVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanMfgPrmSheetData extends BusinessObjectMaster {
    public ProdPlanMfgPrmSheetData(String obid){
        super(obid);
    }
    public ProdPlanMfgPrmSheetData(ProdPlanMfgPrmSheetDataVO vo){
        super(vo);
    }
    @Override
    public ProdPlanMfgPrmSheetDataVO getVo(){
        return (ProdPlanMfgPrmSheetDataVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanMfgPrmSheetData();
    }
    public void initializeProdPlanMfgPrmSheetData(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanMfgPrmSheetData[toString()=" + super.toString() + "]";
    }

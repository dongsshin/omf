 ...
 * Program ID : ProdPlanPRMSheetDataPrev.java
 * ===================================================================
...
import rap.api.object.pp.model.ProdPlanPRMSheetDataPrevVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProdPlanPRMSheetDataPrev extends BusinessObjectMaster {
    public ProdPlanPRMSheetDataPrev(String obid){
        super(obid);
    }
    public ProdPlanPRMSheetDataPrev(ProdPlanPRMSheetDataPrevVO vo){
        super(vo);
    }
    @Override
    public ProdPlanPRMSheetDataPrevVO getVo(){
        return (ProdPlanPRMSheetDataPrevVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProdPlanPRMSheetDataPrev();
    }
    public void initializeProdPlanPRMSheetDataPrev(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProdPlanPRMSheetDataPrev[toString()=" + super.toString() + "]";
    }

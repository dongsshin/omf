 ...
 * Program ID : PartMasterRoot.java
 * ===================================================================
 *  Modification Date      Modifier           Description
 *      2017.04.??       DS Shin            Initial
 * ===================================================================
 */
package rap.api.object.part.dom;
...
public class PartMasterRoot extends BusinessStructuredObjectMaster {
    public PartMasterRoot(String obid){
        super(obid);
    }
    public PartMasterRoot(PartMasterRootVO vo){
        super(vo);
    }
    @Override
    public PartMasterRootVO getVo(){
        return (PartMasterRootVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartMasterRoot();
    }
    public void initializePartMasterRoot(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartMasterRoot[toString()=" + super.toString() + "]";
    }

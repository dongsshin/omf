...
import rap.api.object.part.model.ModelMasterVO;
import rap.api.object.part.dom.PartMasterRoot;


public class ModelMaster extends PartMasterRoot {
    public ModelMaster(String obid){
        super(obid);
    }
    public ModelMaster(ModelMasterVO vo){
        super(vo);
    }
    @Override
    public ModelMasterVO getVo(){
        return (ModelMasterVO)super.getVo();
    }
    @Override
    ...
    public void initializeModelMaster(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ModelMaster[toString()=" + super.toString() + "]";
    }

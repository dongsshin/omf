...
import rap.api.object.part.model.PartMasterVO;
import rap.api.object.part.dom.PartMasterRoot;


public class PartMaster extends PartMasterRoot {
    public PartMaster(String obid){
        super(obid);
    }
    public PartMaster(PartMasterVO vo){
        super(vo);
    }
    @Override
    public PartMasterVO getVo(){
        return (PartMasterVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartMaster();
    }
    public void initializePartMaster(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartMaster[toString()=" + super.toString() + "]";
    }

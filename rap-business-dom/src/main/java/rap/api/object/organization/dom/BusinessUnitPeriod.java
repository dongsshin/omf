 ...
 * Program ID : BusinessUnitPeriod.java
 * ===================================================================
...
public class BusinessUnitPeriod extends Organizations {
    public BusinessUnitPeriod(String obid){
        super(obid);
    }
    public BusinessUnitPeriod(BusinessUnitPeriodVO vo){
        super(vo);
    }
    @Override
    public BusinessUnitPeriodVO getVo(){
        return (BusinessUnitPeriodVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeBusinessUnitPeriod();
    }
    public void initializeBusinessUnitPeriod(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BusinessUnitPeriod[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : PrearrangedUsers.java
 * ===================================================================
...
import rap.api.object.organization.model.PrearrangedUsersVO;
import rap.api.object.organization.dom.AbstractUsers;


public class PrearrangedUsers extends AbstractUsers {
    public PrearrangedUsers(String obid){
        super(obid);
    }
    public PrearrangedUsers(PrearrangedUsersVO vo){
        super(vo);
    }
    @Override
    public PrearrangedUsersVO getVo(){
        return (PrearrangedUsersVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePrearrangedUsers();
    }
    public void initializePrearrangedUsers(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PrearrangedUsers[toString()=" + super.toString() + "]";
    }

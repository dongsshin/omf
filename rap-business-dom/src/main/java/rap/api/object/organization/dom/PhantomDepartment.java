 ...
 * Program ID : PhantomDepartment.java
 * ===================================================================
...
import rap.api.object.organization.model.PhantomDepartmentVO;
import rap.application.constants.ApplicationSchemaConstants;


public class PhantomDepartment extends AbstractHrDepartment {
    public PhantomDepartment(String obid){
        super(obid);
    }
    public PhantomDepartment(PhantomDepartmentVO vo){
        super(vo);
    }
    @Override
    public PhantomDepartmentVO getVo(){
        return (PhantomDepartmentVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePhantomDepartment();
    }
    public void initializePhantomDepartment(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PhantomDepartment[toString()=" + super.toString() + "]";
    }
   ...
   @Override
    ...
    public void createPhantomDepartment(DepartmentVO departmentVO, String departmentName) {
        this.getVo().setClassName(ApplicationSchemaConstants.BIZCLASS_PHANTOMDEPARTMENT);
        this.getVo().setStates(ApplicationSchemaConstants.STATE_ORGANIZATION_ACTIVE);
        this.getVo().setLifeCycle(ApplicationSchemaConstants.LIFECYCLE_ORGANIZATION);
        this.getVo().setDescriptions(departmentVO.getDescriptions());
        this.getVo().setTitles(departmentVO.getDescriptions());
        this.getVo().setLeaderEmployeeNo(departmentVO.getLeaderEmployeeNo());
        this.getVo().setOrganizationLevel(departmentVO.getOrganizationLevel());
        this.getVo().setDivisionCode(departmentVO.getDivisionCode());
        this.getVo().setAffiliateCode(departmentVO.getAffiliateCode());
        this.getVo().setHrUpperDeptCode(departmentVO.getHrUpperDeptCode());
        
        this.getVo().setNames(departmentName);
        this.getVo().setDepartmentCode(departmentName);

 ...
 * Program ID : VCStdVerOption.java
 * ===================================================================
...
import rap.api.object.budget.model.VCStdVerOptionVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class VCStdVerOption extends BusinessObjectMaster {
    public VCStdVerOption(String obid){
        super(obid);
    }
    public VCStdVerOption(VCStdVerOptionVO vo){
        super(vo);
    }
    @Override
    public VCStdVerOptionVO getVo(){
        return (VCStdVerOptionVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeVCStdVerOption();
    }
    public void initializeVCStdVerOption(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "VCStdVerOption[toString()=" + super.toString() + "]";
    }

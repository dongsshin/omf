 ...
 * Program ID : BgtChemicalMaterial.java
 * ===================================================================
...
import rap.api.object.budget.model.BgtChemicalMaterialVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class BgtChemicalMaterial extends BusinessObjectMaster {
    public BgtChemicalMaterial(String obid){
        super(obid);
    }
    public BgtChemicalMaterial(BgtChemicalMaterialVO vo){
        super(vo);
    }
    @Override
    public BgtChemicalMaterialVO getVo(){
        return (BgtChemicalMaterialVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeBgtChemicalMaterial();
    }
    public void initializeBgtChemicalMaterial(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BgtChemicalMaterial[toString()=" + super.toString() + "]";
    }

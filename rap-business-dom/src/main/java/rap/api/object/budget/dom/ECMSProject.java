...
import rap.api.object.budget.model.ECMSProjectVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ECMSProject extends BusinessObjectMaster {
    public ECMSProject(String obid){
        super(obid);
    }
    public ECMSProject(ECMSProjectVO vo){
        super(vo);
    }
    @Override
    public ECMSProjectVO getVo(){
        return (ECMSProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeECMSProject();
    }
    public void initializeECMSProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ECMSProject[toString()=" + super.toString() + "]";
    }

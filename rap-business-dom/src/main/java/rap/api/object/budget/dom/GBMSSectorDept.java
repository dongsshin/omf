 ...
 * Program ID : GBMSSectorDept.java
 * ===================================================================
...
import rap.api.object.budget.model.GBMSSectorDeptVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class GBMSSectorDept extends BusinessObjectMaster {
    public GBMSSectorDept(String obid){
        super(obid);
    }
    public GBMSSectorDept(GBMSSectorDeptVO vo){
        super(vo);
    }
    @Override
    public GBMSSectorDeptVO getVo(){
        return (GBMSSectorDeptVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeGBMSSectorDept();
    }
    public void initializeGBMSSectorDept(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "GBMSSectorDept[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.budget.model.DevUnitMgtVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class DevUnitMgt extends BusinessObjectMaster {
    public DevUnitMgt(String obid){
        super(obid);
    }
    public DevUnitMgt(DevUnitMgtVO vo){
        super(vo);
    }
    @Override
    public DevUnitMgtVO getVo(){
        return (DevUnitMgtVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDevUnitMgt();
    }
    public void initializeDevUnitMgt(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DevUnitMgt[toString()=" + super.toString() + "]";
    }

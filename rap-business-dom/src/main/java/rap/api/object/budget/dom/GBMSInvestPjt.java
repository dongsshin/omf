...
import rap.api.object.budget.model.GBMSInvestPjtVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class GBMSInvestPjt extends BusinessObjectMaster {
    public GBMSInvestPjt(String obid){
        super(obid);
    }
    public GBMSInvestPjt(GBMSInvestPjtVO vo){
        super(vo);
    }
    @Override
    public GBMSInvestPjtVO getVo(){
        return (GBMSInvestPjtVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeGBMSInvestPjt();
    }
    public void initializeGBMSInvestPjt(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "GBMSInvestPjt[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.budget.model.VCStdMatrixVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class VCStdMatrix extends BusinessObjectMaster {
    public VCStdMatrix(String obid){
        super(obid);
    }
    public VCStdMatrix(VCStdMatrixVO vo){
        super(vo);
    }
    @Override
    public VCStdMatrixVO getVo(){
        return (VCStdMatrixVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeVCStdMatrix();
    }
    public void initializeVCStdMatrix(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "VCStdMatrix[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : BgtConsultSettlement.java
 * ===================================================================
 *  Modification Date      Modifier           Description
 *      2017.04.??       DS Shin            Initial
 * ===================================================================
 */
package rap.api.object.budget.dom;


import java.util.Map;
import rap.api.object.budget.model.BgtConsultSettlementVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class BgtConsultSettlement extends BusinessObjectMaster {
    public BgtConsultSettlement(String obid){
        super(obid);
    }
    public BgtConsultSettlement(BgtConsultSettlementVO vo){
        super(vo);
    }
    @Override
    public BgtConsultSettlementVO getVo(){
        return (BgtConsultSettlementVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeBgtConsultSettlement();
    }
    public void initializeBgtConsultSettlement(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BgtConsultSettlement[toString()=" + super.toString() + "]";
    }

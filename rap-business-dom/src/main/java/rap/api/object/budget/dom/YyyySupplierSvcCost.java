 ...
 * Program ID : YyyySupplierSvcCost.java
 * ===================================================================
...
import rap.api.object.budget.model.YyyySupplierSvcCostVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class YyyySupplierSvcCost extends BusinessObjectMaster {
    public YyyySupplierSvcCost(String obid){
        super(obid);
    }
    public YyyySupplierSvcCost(YyyySupplierSvcCostVO vo){
        super(vo);
    }
    @Override
    public YyyySupplierSvcCostVO getVo(){
        return (YyyySupplierSvcCostVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeYyyySupplierSvcCost();
    }
    public void initializeYyyySupplierSvcCost(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "YyyySupplierSvcCost[toString()=" + super.toString() + "]";
    }

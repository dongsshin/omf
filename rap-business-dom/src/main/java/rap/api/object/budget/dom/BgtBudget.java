...
import rap.api.object.budget.model.BgtBudgetVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class BgtBudget extends BusinessObjectMaster {
    public BgtBudget(String obid){
        super(obid);
    }
    public BgtBudget(BgtBudgetVO vo){
        super(vo);
    }
    @Override
    public BgtBudgetVO getVo(){
        return (BgtBudgetVO)super.getVo();
    }
    @Override
    ...
    public void initializeBgtBudget(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BgtBudget[toString()=" + super.toString() + "]";
    }

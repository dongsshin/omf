 ...
 * Program ID : AwardB2BProjectCode.java
 * ===================================================================
...
import rap.api.object.budget.model.AwardB2BProjectCodeVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class AwardB2BProjectCode extends BusinessObjectMaster {
    public AwardB2BProjectCode(String obid){
        super(obid);
    }
    public AwardB2BProjectCode(AwardB2BProjectCodeVO vo){
        super(vo);
    }
    @Override
    public AwardB2BProjectCodeVO getVo(){
        return (AwardB2BProjectCodeVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeAwardB2BProjectCode();
    }
    public void initializeAwardB2BProjectCode(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "AwardB2BProjectCode[toString()=" + super.toString() + "]";
    }

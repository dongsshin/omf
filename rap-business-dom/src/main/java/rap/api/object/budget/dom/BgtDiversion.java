...
import rap.api.object.budget.model.BgtDiversionVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class BgtDiversion extends BusinessObjectMaster {
    public BgtDiversion(String obid){
        super(obid);
    }
    public BgtDiversion(BgtDiversionVO vo){
        super(vo);
    }
    @Override
    public BgtDiversionVO getVo(){
        return (BgtDiversionVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeBgtDiversion();
    }
    public void initializeBgtDiversion(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BgtDiversion[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : VCStandardVersion.java
 * ===================================================================
...
import rap.api.object.budget.model.VCStandardVersionVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class VCStandardVersion extends BusinessObjectMaster {
    public VCStandardVersion(String obid){
        super(obid);
    }
    public VCStandardVersion(VCStandardVersionVO vo){
        super(vo);
    }
    @Override
    public VCStandardVersionVO getVo(){
        return (VCStandardVersionVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeVCStandardVersion();
    }
    public void initializeVCStandardVersion(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "VCStandardVersion[toString()=" + super.toString() + "]";
    }

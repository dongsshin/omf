...
import rap.api.object.budget.model.ExchangeRateVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ExchangeRate extends BusinessObjectMaster {
    public ExchangeRate(String obid){
        super(obid);
    }
    public ExchangeRate(ExchangeRateVO vo){
        super(vo);
    }
    @Override
    public ExchangeRateVO getVo(){
        return (ExchangeRateVO)super.getVo();
    }
    @Override
    ...
    public String toString() {
        return "ExchangeRate[toString()=" + super.toString() + "]";
    }

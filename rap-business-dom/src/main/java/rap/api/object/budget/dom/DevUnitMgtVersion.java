 ...
 * Program ID : DevUnitMgtVersion.java
 * ===================================================================
...
import rap.api.object.budget.model.DevUnitMgtVersionVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class DevUnitMgtVersion extends BusinessObjectMaster {
    public DevUnitMgtVersion(String obid){
        super(obid);
    }
    public DevUnitMgtVersion(DevUnitMgtVersionVO vo){
        super(vo);
    }
    @Override
    public DevUnitMgtVersionVO getVo(){
        return (DevUnitMgtVersionVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDevUnitMgtVersion();
    }
    public void initializeDevUnitMgtVersion(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DevUnitMgtVersion[toString()=" + super.toString() + "]";
    }

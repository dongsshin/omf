...
import rap.api.object.budget.model.BgtBMSPeriodVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class BgtBMSPeriod extends BusinessObjectMaster {
    public BgtBMSPeriod(String obid){
        super(obid);
    }
    public BgtBMSPeriod(BgtBMSPeriodVO vo){
        super(vo);
    }
    @Override
    public BgtBMSPeriodVO getVo(){
        return (BgtBMSPeriodVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeBgtBMSPeriod();
    }
    public void initializeBgtBMSPeriod(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BgtBMSPeriod[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : BgtInvestDiversion.java
 * ===================================================================
...
import rap.api.object.budget.model.BgtInvestDiversionVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class BgtInvestDiversion extends BusinessObjectMaster {
    public BgtInvestDiversion(String obid){
        super(obid);
    }
    public BgtInvestDiversion(BgtInvestDiversionVO vo){
        super(vo);
    }
    @Override
    public BgtInvestDiversionVO getVo(){
        return (BgtInvestDiversionVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeBgtInvestDiversion();
    }
    public void initializeBgtInvestDiversion(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BgtInvestDiversion[toString()=" + super.toString() + "]";
    }

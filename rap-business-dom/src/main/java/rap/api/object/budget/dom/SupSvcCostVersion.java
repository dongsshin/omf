 ...
 * Program ID : SupSvcCostVersion.java
 * ===================================================================
...
import rap.api.object.budget.model.SupSvcCostVersionVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class SupSvcCostVersion extends BusinessObjectMaster {
    public SupSvcCostVersion(String obid){
        super(obid);
    }
    public SupSvcCostVersion(SupSvcCostVersionVO vo){
        super(vo);
    }
    @Override
    public SupSvcCostVersionVO getVo(){
        return (SupSvcCostVersionVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeSupSvcCostVersion();
    }
    public void initializeSupSvcCostVersion(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "SupSvcCostVersion[toString()=" + super.toString() + "]";
    }

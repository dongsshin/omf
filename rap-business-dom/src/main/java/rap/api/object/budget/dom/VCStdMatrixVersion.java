 ...
 * Program ID : VCStdMatrixVersion.java
 * ===================================================================
...
import rap.api.object.budget.model.VCStdMatrixVersionVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class VCStdMatrixVersion extends BusinessObjectMaster {
    public VCStdMatrixVersion(String obid){
        super(obid);
    }
    public VCStdMatrixVersion(VCStdMatrixVersionVO vo){
        super(vo);
    }
    @Override
    public VCStdMatrixVersionVO getVo(){
        return (VCStdMatrixVersionVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeVCStdMatrixVersion();
    }
    public void initializeVCStdMatrixVersion(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "VCStdMatrixVersion[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : CustomerMasterForPDR.java
 * ===================================================================
...
import rap.api.object.pdr.model.CustomerMasterForPDRVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class CustomerMasterForPDR extends BusinessObjectMaster {
    public CustomerMasterForPDR(String obid){
        super(obid);
    }
    public CustomerMasterForPDR(CustomerMasterForPDRVO vo){
        super(vo);
    }
    @Override
    public CustomerMasterForPDRVO getVo(){
        return (CustomerMasterForPDRVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeCustomerMasterForPDR();
    }
    public void initializeCustomerMasterForPDR(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "CustomerMasterForPDR[toString()=" + super.toString() + "]";
    }

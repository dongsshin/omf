 ...
 * Program ID : SpecNtCodeMaster.java
 * ===================================================================
...
import rap.api.object.pdr.model.SpecNtCodeMasterVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class SpecNtCodeMaster extends BusinessObjectMaster {
    public SpecNtCodeMaster(String obid){
        super(obid);
    }
    public SpecNtCodeMaster(SpecNtCodeMasterVO vo){
        super(vo);
    }
    @Override
    public SpecNtCodeMasterVO getVo(){
        return (SpecNtCodeMasterVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeSpecNtCodeMaster();
    }
    public void initializeSpecNtCodeMaster(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "SpecNtCodeMaster[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.pdr.model.ModelTypeItemVO;
import rap.api.object.pdr.dom.ObjectItems;


public class ModelTypeItem extends ObjectItems {
    public ModelTypeItem(String obid){
        super(obid);
    }
    public ModelTypeItem(ModelTypeItemVO vo){
        super(vo);
    }
    @Override
    public ModelTypeItemVO getVo(){
        return (ModelTypeItemVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeModelTypeItem();
    }
    public void initializeModelTypeItem(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ModelTypeItem[toString()=" + super.toString() + "]";
    }

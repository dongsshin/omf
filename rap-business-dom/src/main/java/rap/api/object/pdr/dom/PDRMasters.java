...
public class PDRMasters extends BusinessObject {
    public PDRMasters(String obid){
        super(obid);
    }
    public PDRMasters(PDRMastersVO vo){
        super(vo);
    }
    @Override
    public PDRMastersVO getVo(){
        return (PDRMastersVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePDRMasters();
    }
    public void initializePDRMasters(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PDRMasters[toString()=" + super.toString() + "]";
    }

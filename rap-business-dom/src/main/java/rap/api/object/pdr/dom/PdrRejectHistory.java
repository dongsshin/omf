 ...
 * Program ID : PdrRejectHistory.java
 * ===================================================================
...
import rap.api.object.pdr.model.PdrRejectHistoryVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PdrRejectHistory extends BusinessObjectMaster {
    public PdrRejectHistory(String obid){
        super(obid);
    }
    public PdrRejectHistory(PdrRejectHistoryVO vo){
        super(vo);
    }
    @Override
    public PdrRejectHistoryVO getVo(){
        return (PdrRejectHistoryVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePdrRejectHistory();
    }
    public void initializePdrRejectHistory(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PdrRejectHistory[toString()=" + super.toString() + "]";
    }

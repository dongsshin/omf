 ...
 * Program ID : SpecToolMaster.java
 * ===================================================================
...
import rap.api.object.pdr.model.SpecToolMasterVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class SpecToolMaster extends BusinessObjectMaster {
    public SpecToolMaster(String obid){
        super(obid);
    }
    public SpecToolMaster(SpecToolMasterVO vo){
        super(vo);
    }
    @Override
    public SpecToolMasterVO getVo(){
        return (SpecToolMasterVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeSpecToolMaster();
    }
    public void initializeSpecToolMaster(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "SpecToolMaster[toString()=" + super.toString() + "]";
    }

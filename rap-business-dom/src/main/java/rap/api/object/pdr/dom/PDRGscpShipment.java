 ...
 * Program ID : PDRGscpShipment.java
 * ===================================================================
...
import rap.api.object.pdr.model.PDRGscpShipmentVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PDRGscpShipment extends BusinessObjectMaster {
    public PDRGscpShipment(String obid){
        super(obid);
    }
    public PDRGscpShipment(PDRGscpShipmentVO vo){
        super(vo);
    }
    @Override
    public PDRGscpShipmentVO getVo(){
        return (PDRGscpShipmentVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePDRGscpShipment();
    }
    public void initializePDRGscpShipment(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PDRGscpShipment[toString()=" + super.toString() + "]";
    }

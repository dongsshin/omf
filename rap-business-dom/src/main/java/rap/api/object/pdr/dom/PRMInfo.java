...
import rap.api.object.pdr.model.PRMInfoVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PRMInfo extends BusinessObjectMaster {
    public PRMInfo(String obid){
        super(obid);
    }
    public PRMInfo(PRMInfoVO vo){
        super(vo);
    }
    @Override
    public PRMInfoVO getVo(){
        return (PRMInfoVO)super.getVo();
    }
    @Override
    ...
    public void initializePRMInfo(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PRMInfo[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : PmsProductGroup.java
 * ===================================================================
...
import rap.api.object.pdr.model.PmsProductGroupVO;
import rap.api.object.pdr.dom.Products;


public class PmsProductGroup extends Products {
    public PmsProductGroup(String obid){
        super(obid);
    }
    public PmsProductGroup(PmsProductGroupVO vo){
        super(vo);
    }
    @Override
    public PmsProductGroupVO getVo(){
        return (PmsProductGroupVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePmsProductGroup();
    }
    public void initializePmsProductGroup(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PmsProductGroup[toString()=" + super.toString() + "]";
    }

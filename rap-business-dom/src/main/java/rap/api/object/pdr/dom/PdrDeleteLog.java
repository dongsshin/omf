...
import rap.api.object.pdr.model.PdrDeleteLogVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PdrDeleteLog extends BusinessObjectMaster {
    public PdrDeleteLog(String obid){
        super(obid);
    }
    public PdrDeleteLog(PdrDeleteLogVO vo){
        super(vo);
    }
    @Override
    public PdrDeleteLogVO getVo(){
        return (PdrDeleteLogVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePdrDeleteLog();
    }
    public void initializePdrDeleteLog(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PdrDeleteLog[toString()=" + super.toString() + "]";
    }

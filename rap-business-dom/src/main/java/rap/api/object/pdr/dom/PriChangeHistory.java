 ...
 * Program ID : PriChangeHistory.java
 * ===================================================================
...
import rap.api.object.pdr.model.PriChangeHistoryVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PriChangeHistory extends BusinessObjectMaster {
    public PriChangeHistory(String obid){
        super(obid);
    }
    public PriChangeHistory(PriChangeHistoryVO vo){
        super(vo);
    }
    @Override
    public PriChangeHistoryVO getVo(){
        return (PriChangeHistoryVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePriChangeHistory();
    }
    public void initializePriChangeHistory(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PriChangeHistory[toString()=" + super.toString() + "]";
    }

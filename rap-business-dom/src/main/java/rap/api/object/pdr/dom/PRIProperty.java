...
import rap.api.object.pdr.model.PRIPropertyVO;
import com.rap.omc.api.object.dom.BusinessObject;


public class PRIProperty extends BusinessObject {
    public PRIProperty(String obid){
        super(obid);
    }
    public PRIProperty(PRIPropertyVO vo){
        super(vo);
    }
    @Override
    public PRIPropertyVO getVo(){
        return (PRIPropertyVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePRIProperty();
    }
    public void initializePRIProperty(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PRIProperty[toString()=" + super.toString() + "]";
    }

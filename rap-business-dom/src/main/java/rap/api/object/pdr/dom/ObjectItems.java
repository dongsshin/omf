...
import rap.api.object.pdr.model.ObjectItemsVO;
import rap.api.object.pdr.dom.SpecItems;


public class ObjectItems extends SpecItems {
    public ObjectItems(String obid){
        super(obid);
    }
    public ObjectItems(ObjectItemsVO vo){
        super(vo);
    }
    @Override
    public ObjectItemsVO getVo(){
        return (ObjectItemsVO)super.getVo();
    }
    @Override
    ...
    public void initializeObjectItems(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ObjectItems[toString()=" + super.toString() + "]";
    }

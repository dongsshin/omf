...
import rap.api.object.pdr.model.ProductsVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class Products extends BusinessObjectMaster {
    public Products(String obid){
        super(obid);
    }
    public Products(ProductsVO vo){
        super(vo);
    }
    @Override
    public ProductsVO getVo(){
        return (ProductsVO)super.getVo();
    }
    @Override
    ...
    public String toString() {
        return "Products[toString()=" + super.toString() + "]";
    }

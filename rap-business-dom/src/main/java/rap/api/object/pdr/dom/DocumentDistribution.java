 ...
 * Program ID : DocumentDistribution.java
 * ===================================================================
...
import rap.api.object.pdr.model.DocumentDistributionVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class DocumentDistribution extends BusinessObjectMaster {
    public DocumentDistribution(String obid){
        super(obid);
    }
    public DocumentDistribution(DocumentDistributionVO vo){
        super(vo);
    }
    @Override
    public DocumentDistributionVO getVo(){
        return (DocumentDistributionVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDocumentDistribution();
    }
    public void initializeDocumentDistribution(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DocumentDistribution[toString()=" + super.toString() + "]";
    }

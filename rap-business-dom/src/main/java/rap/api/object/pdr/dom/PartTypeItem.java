...
import rap.api.object.pdr.model.PartTypeItemVO;
import rap.api.object.pdr.dom.ValueListItems;


public class PartTypeItem extends ValueListItems {
    public PartTypeItem(String obid){
        super(obid);
    }
    public PartTypeItem(PartTypeItemVO vo){
        super(vo);
    }
    @Override
    public PartTypeItemVO getVo(){
        return (PartTypeItemVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePartTypeItem();
    }
    public void initializePartTypeItem(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PartTypeItem[toString()=" + super.toString() + "]";
    }

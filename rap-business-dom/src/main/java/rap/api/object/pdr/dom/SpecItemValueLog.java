 ...
 * Program ID : SpecItemValueLog.java
 * ===================================================================
...
import rap.api.object.pdr.model.SpecItemValueLogVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class SpecItemValueLog extends BusinessObjectMaster {
    public SpecItemValueLog(String obid){
        super(obid);
    }
    public SpecItemValueLog(SpecItemValueLogVO vo){
        super(vo);
    }
    @Override
    public SpecItemValueLogVO getVo(){
        return (SpecItemValueLogVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeSpecItemValueLog();
    }
    public void initializeSpecItemValueLog(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "SpecItemValueLog[toString()=" + super.toString() + "]";
    }

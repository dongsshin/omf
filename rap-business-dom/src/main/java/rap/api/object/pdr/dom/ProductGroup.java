...
import rap.api.object.pdr.model.ProductGroupVO;
import rap.api.object.pdr.dom.Products;


public class ProductGroup extends Products {
    public ProductGroup(String obid){
        super(obid);
    }
    public ProductGroup(ProductGroupVO vo){
        super(vo);
    }
    @Override
    public ProductGroupVO getVo(){
        return (ProductGroupVO)super.getVo();
    }
    @Override
    ...
    public String toString() {
        return "ProductGroup[toString()=" + super.toString() + "]";
    }

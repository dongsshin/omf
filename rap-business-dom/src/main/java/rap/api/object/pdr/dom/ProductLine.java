...
import rap.api.object.pdr.model.ProductLineVO;
import rap.api.object.pdr.dom.Products;


public class ProductLine extends Products {
    public ProductLine(String obid){
        super(obid);
    }
    public ProductLine(ProductLineVO vo){
        super(vo);
    }
    @Override
    public ProductLineVO getVo(){
        return (ProductLineVO)super.getVo();
    }
    @Override
    ...
    public void initializeProductLine(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProductLine[toString()=" + super.toString() + "]";
    }

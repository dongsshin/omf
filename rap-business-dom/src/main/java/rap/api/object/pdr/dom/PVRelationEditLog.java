 ...
 * Program ID : PVRelationEditLog.java
 * ===================================================================
...
import rap.api.object.pdr.model.PVRelationEditLogVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PVRelationEditLog extends BusinessObjectMaster {
    public PVRelationEditLog(String obid){
        super(obid);
    }
    public PVRelationEditLog(PVRelationEditLogVO vo){
        super(vo);
    }
    @Override
    public PVRelationEditLogVO getVo(){
        return (PVRelationEditLogVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePVRelationEditLog();
    }
    public void initializePVRelationEditLog(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PVRelationEditLog[toString()=" + super.toString() + "]";
    }

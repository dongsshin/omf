 ...
 * Program ID : PDRMornitoringGSCPShipment.java
 * ===================================================================
 *  Modification Date      Modifier           Description
 *      2017.04.??       DS Shin            Initial
 * ===================================================================
 */
package rap.api.object.pdr.dom;


import java.util.Map;
import rap.api.object.pdr.model.PDRMornitoringGSCPShipmentVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PDRMornitoringGSCPShipment extends BusinessObjectMaster {
    public PDRMornitoringGSCPShipment(String obid){
        super(obid);
    }
    public PDRMornitoringGSCPShipment(PDRMornitoringGSCPShipmentVO vo){
        super(vo);
    }
    @Override
    public PDRMornitoringGSCPShipmentVO getVo(){
        return (PDRMornitoringGSCPShipmentVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePDRMornitoringGSCPShipment();
    }
    public void initializePDRMornitoringGSCPShipment(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PDRMornitoringGSCPShipment[toString()=" + super.toString() + "]";
    }

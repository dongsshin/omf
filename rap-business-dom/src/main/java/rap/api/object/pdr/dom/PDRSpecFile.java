...
import rap.api.object.pdr.model.PDRSpecFileVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PDRSpecFile extends BusinessObjectMaster {
    public PDRSpecFile(String obid){
        super(obid);
    }
    public PDRSpecFile(PDRSpecFileVO vo){
        super(vo);
    }
    @Override
    public PDRSpecFileVO getVo(){
        return (PDRSpecFileVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePDRSpecFile();
    }
    public void initializePDRSpecFile(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PDRSpecFile[toString()=" + super.toString() + "]";
    }

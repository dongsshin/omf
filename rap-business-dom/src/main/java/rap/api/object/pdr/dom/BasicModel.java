...
import rap.api.object.pdr.model.BasicModelVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class BasicModel extends BusinessObjectMaster {
    public BasicModel(String obid){
        super(obid);
    }
    public BasicModel(BasicModelVO vo){
        super(vo);
    }
    @Override
    public BasicModelVO getVo(){
        return (BasicModelVO)super.getVo();
    }
    @Override
    ...
    public void initializeBasicModel(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "BasicModel[toString()=" + super.toString() + "]";
    }

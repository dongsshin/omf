 ...
 * Program ID : PDRApproverGroup.java
 * ===================================================================
...
import rap.api.object.pdr.model.PDRApproverGroupVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PDRApproverGroup extends BusinessObjectMaster {
    public PDRApproverGroup(String obid){
        super(obid);
    }
    public PDRApproverGroup(PDRApproverGroupVO vo){
        super(vo);
    }
    @Override
    public PDRApproverGroupVO getVo(){
        return (PDRApproverGroupVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePDRApproverGroup();
    }
    public void initializePDRApproverGroup(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PDRApproverGroup[toString()=" + super.toString() + "]";
    }

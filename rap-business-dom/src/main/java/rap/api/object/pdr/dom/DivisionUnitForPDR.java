 ...
 * Program ID : DivisionUnitForPDR.java
 * ===================================================================
...
import rap.api.object.pdr.model.DivisionUnitForPDRVO;
import rap.api.object.organization.dom.Organizations;


public class DivisionUnitForPDR extends Organizations {
    public DivisionUnitForPDR(String obid){
        super(obid);
    }
    public DivisionUnitForPDR(DivisionUnitForPDRVO vo){
        super(vo);
    }
    @Override
    public DivisionUnitForPDRVO getVo(){
        return (DivisionUnitForPDRVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeDivisionUnitForPDR();
    }
    public void initializeDivisionUnitForPDR(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "DivisionUnitForPDR[toString()=" + super.toString() + "]";
    }

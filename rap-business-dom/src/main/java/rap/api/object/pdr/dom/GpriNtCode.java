...
import rap.api.object.pdr.model.GpriNtCodeVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class GpriNtCode extends BusinessObjectMaster {
    public GpriNtCode(String obid){
        super(obid);
    }
    public GpriNtCode(GpriNtCodeVO vo){
        super(vo);
    }
    @Override
    public GpriNtCodeVO getVo(){
        return (GpriNtCodeVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeGpriNtCode();
    }
    public void initializeGpriNtCode(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "GpriNtCode[toString()=" + super.toString() + "]";
    }

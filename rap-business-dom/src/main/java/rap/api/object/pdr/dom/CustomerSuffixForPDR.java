 ...
 * Program ID : CustomerSuffixForPDR.java
 * ===================================================================
...
import rap.api.object.pdr.model.CustomerSuffixForPDRVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class CustomerSuffixForPDR extends BusinessObjectMaster {
    public CustomerSuffixForPDR(String obid){
        super(obid);
    }
    public CustomerSuffixForPDR(CustomerSuffixForPDRVO vo){
        super(vo);
    }
    @Override
    public CustomerSuffixForPDRVO getVo(){
        return (CustomerSuffixForPDRVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeCustomerSuffixForPDR();
    }
    public void initializeCustomerSuffixForPDR(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "CustomerSuffixForPDR[toString()=" + super.toString() + "]";
    }

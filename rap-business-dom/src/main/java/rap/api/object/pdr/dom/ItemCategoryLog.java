 ...
 * Program ID : ItemCategoryLog.java
 * ===================================================================
...
import rap.api.object.pdr.model.ItemCategoryLogVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ItemCategoryLog extends BusinessObjectMaster {
    public ItemCategoryLog(String obid){
        super(obid);
    }
    public ItemCategoryLog(ItemCategoryLogVO vo){
        super(vo);
    }
    @Override
    public ItemCategoryLogVO getVo(){
        return (ItemCategoryLogVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeItemCategoryLog();
    }
    public void initializeItemCategoryLog(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ItemCategoryLog[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : TargetValueForPDR.java
 * ===================================================================
...
import rap.api.object.pdr.model.TargetValueForPDRVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class TargetValueForPDR extends BusinessObjectMaster {
    public TargetValueForPDR(String obid){
        super(obid);
    }
    public TargetValueForPDR(TargetValueForPDRVO vo){
        super(vo);
    }
    @Override
    public TargetValueForPDRVO getVo(){
        return (TargetValueForPDRVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeTargetValueForPDR();
    }
    public void initializeTargetValueForPDR(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "TargetValueForPDR[toString()=" + super.toString() + "]";
    }

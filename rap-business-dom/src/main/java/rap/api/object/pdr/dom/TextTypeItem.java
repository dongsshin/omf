...
import rap.api.object.pdr.model.TextTypeItemVO;
import rap.api.object.pdr.dom.SpecItems;


public class TextTypeItem extends SpecItems {
    public TextTypeItem(String obid){
        super(obid);
    }
    public TextTypeItem(TextTypeItemVO vo){
        super(vo);
    }
    @Override
    public TextTypeItemVO getVo(){
        return (TextTypeItemVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeTextTypeItem();
    }
    public void initializeTextTypeItem(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "TextTypeItem[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : SubsidiaryForPDR.java
 * ===================================================================
...
import rap.api.object.pdr.model.SubsidiaryForPDRVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class SubsidiaryForPDR extends BusinessObjectMaster {
    public SubsidiaryForPDR(String obid){
        super(obid);
    }
    public SubsidiaryForPDR(SubsidiaryForPDRVO vo){
        super(vo);
    }
    @Override
    public SubsidiaryForPDRVO getVo(){
        return (SubsidiaryForPDRVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeSubsidiaryForPDR();
    }
    public void initializeSubsidiaryForPDR(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "SubsidiaryForPDR[toString()=" + super.toString() + "]";
    }

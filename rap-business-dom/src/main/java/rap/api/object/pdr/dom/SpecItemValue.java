...
import rap.api.object.pdr.model.SpecItemValueVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class SpecItemValue extends BusinessObjectMaster {
    public SpecItemValue(String obid){
        super(obid);
    }
    public SpecItemValue(SpecItemValueVO vo){
        super(vo);
    }
    @Override
    public SpecItemValueVO getVo(){
        return (SpecItemValueVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeSpecItemValue();
    }
    public void initializeSpecItemValue(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "SpecItemValue[toString()=" + super.toString() + "]";
    }

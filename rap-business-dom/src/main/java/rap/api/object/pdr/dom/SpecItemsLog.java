...
import rap.api.object.pdr.model.SpecItemsLogVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class SpecItemsLog extends BusinessObjectMaster {
    public SpecItemsLog(String obid){
        super(obid);
    }
    public SpecItemsLog(SpecItemsLogVO vo){
        super(vo);
    }
    @Override
    public SpecItemsLogVO getVo(){
        return (SpecItemsLogVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeSpecItemsLog();
    }
    public void initializeSpecItemsLog(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "SpecItemsLog[toString()=" + super.toString() + "]";
    }

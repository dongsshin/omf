 ...
 * Program ID : PcoChangeHistory.java
 * ===================================================================
...
import rap.api.object.pdr.model.PcoChangeHistoryVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PcoChangeHistory extends BusinessObjectMaster {
    public PcoChangeHistory(String obid){
        super(obid);
    }
    public PcoChangeHistory(PcoChangeHistoryVO vo){
        super(vo);
    }
    @Override
    public PcoChangeHistoryVO getVo(){
        return (PcoChangeHistoryVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePcoChangeHistory();
    }
    public void initializePcoChangeHistory(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PcoChangeHistory[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : PDRSalesTarget.java
 * ===================================================================
...
import rap.api.object.pdr.model.PDRSalesTargetVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PDRSalesTarget extends BusinessObjectMaster {
    public PDRSalesTarget(String obid){
        super(obid);
    }
    public PDRSalesTarget(PDRSalesTargetVO vo){
        super(vo);
    }
    @Override
    public PDRSalesTargetVO getVo(){
        return (PDRSalesTargetVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePDRSalesTarget();
    }
    public void initializePDRSalesTarget(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PDRSalesTarget[toString()=" + super.toString() + "]";
    }

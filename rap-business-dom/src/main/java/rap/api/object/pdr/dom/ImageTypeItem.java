...
import rap.api.object.pdr.model.ImageTypeItemVO;
import rap.api.object.pdr.dom.ValueListItems;


public class ImageTypeItem extends ValueListItems {
    public ImageTypeItem(String obid){
        super(obid);
    }
    public ImageTypeItem(ImageTypeItemVO vo){
        super(vo);
    }
    @Override
    public ImageTypeItemVO getVo(){
        return (ImageTypeItemVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeImageTypeItem();
    }
    public void initializeImageTypeItem(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ImageTypeItem[toString()=" + super.toString() + "]";
    }

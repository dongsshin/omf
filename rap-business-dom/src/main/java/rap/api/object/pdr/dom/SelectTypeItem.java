 ...
 * Program ID : SelectTypeItem.java
 * ===================================================================
...
import rap.api.object.pdr.model.SelectTypeItemVO;
import rap.api.object.pdr.dom.ValueListItems;


public class SelectTypeItem extends ValueListItems {
    public SelectTypeItem(String obid){
        super(obid);
    }
    public SelectTypeItem(SelectTypeItemVO vo){
        super(vo);
    }
    @Override
    public SelectTypeItemVO getVo(){
        return (SelectTypeItemVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeSelectTypeItem();
    }
    public void initializeSelectTypeItem(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "SelectTypeItem[toString()=" + super.toString() + "]";
    }

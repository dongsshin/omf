 ...
 * Program ID : PDRReviewerGroup.java
 * ===================================================================
...
import rap.api.object.pdr.model.PDRReviewerGroupVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PDRReviewerGroup extends BusinessObjectMaster {
    public PDRReviewerGroup(String obid){
        super(obid);
    }
    public PDRReviewerGroup(PDRReviewerGroupVO vo){
        super(vo);
    }
    @Override
    public PDRReviewerGroupVO getVo(){
        return (PDRReviewerGroupVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePDRReviewerGroup();
    }
    public void initializePDRReviewerGroup(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PDRReviewerGroup[toString()=" + super.toString() + "]";
    }

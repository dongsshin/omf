...
import rap.api.object.pdr.model.ProjectSpecVO;
import com.rap.omc.api.object.dom.BusinessObject;


public class ProjectSpec extends BusinessObject {
    public ProjectSpec(String obid){
        super(obid);
    }
    public ProjectSpec(ProjectSpecVO vo){
        super(vo);
    }
    @Override
    public ProjectSpecVO getVo(){
        return (ProjectSpecVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectSpec();
    }
    public void initializeProjectSpec(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectSpec[toString()=" + super.toString() + "]";
    }

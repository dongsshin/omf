 ...
 * Program ID : ValueListItems.java
 * ===================================================================
...
import rap.api.object.pdr.model.ValueListItemsVO;
import rap.api.object.pdr.dom.SpecItems;


public class ValueListItems extends SpecItems {
    public ValueListItems(String obid){
        super(obid);
    }
    public ValueListItems(ValueListItemsVO vo){
        super(vo);
    }
    @Override
    public ValueListItemsVO getVo(){
        return (ValueListItemsVO)super.getVo();
    }
    @Override
    ...
    public void initializeValueListItems(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ValueListItems[toString()=" + super.toString() + "]";
    }

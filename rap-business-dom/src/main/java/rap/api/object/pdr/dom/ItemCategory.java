...
import rap.api.object.pdr.model.ItemCategoryVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ItemCategory extends BusinessObjectMaster {
    public ItemCategory(String obid){
        super(obid);
    }
    public ItemCategory(ItemCategoryVO vo){
        super(vo);
    }
    @Override
    public ItemCategoryVO getVo(){
        return (ItemCategoryVO)super.getVo();
    }
    @Override
    ...
    public void initializeItemCategory(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ItemCategory[toString()=" + super.toString() + "]";
    }

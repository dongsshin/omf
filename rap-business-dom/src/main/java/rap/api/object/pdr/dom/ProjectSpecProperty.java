 ...
 * Program ID : ProjectSpecProperty.java
 * ===================================================================
...
import rap.api.object.pdr.model.ProjectSpecPropertyVO;
import rap.api.object.pdr.dom.PDRMasters;


public class ProjectSpecProperty extends PDRMasters {
    public ProjectSpecProperty(String obid){
        super(obid);
    }
    public ProjectSpecProperty(ProjectSpecPropertyVO vo){
        super(vo);
    }
    @Override
    public ProjectSpecPropertyVO getVo(){
        return (ProjectSpecPropertyVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectSpecProperty();
    }
    public void initializeProjectSpecProperty(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectSpecProperty[toString()=" + super.toString() + "]";
    }

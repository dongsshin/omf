...
public class PDRProperty extends PDRMasters {
    public PDRProperty(String obid){
        super(obid);
    }
    public PDRProperty(PDRPropertyVO vo){
        super(vo);
    }
    @Override
    public PDRPropertyVO getVo(){
        return (PDRPropertyVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePDRProperty();
    }
    public void initializePDRProperty(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PDRProperty[toString()=" + super.toString() + "]";
    }

...
import rap.api.object.pdr.model.SpecItemsVO;
import rap.api.object.pdr.dom.Features;


public class SpecItems extends Features {
    public SpecItems(String obid){
        super(obid);
    }
    public SpecItems(SpecItemsVO vo){
        super(vo);
    }
    @Override
    public SpecItemsVO getVo(){
        return (SpecItemsVO)super.getVo();
    }
    @Override
    ...
    public void initializeSpecItems(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "SpecItems[toString()=" + super.toString() + "]";
    }

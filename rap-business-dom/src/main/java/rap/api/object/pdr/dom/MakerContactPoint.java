 ...
 * Program ID : MakerContactPoint.java
 * ===================================================================
...
import rap.api.object.pdr.model.MakerContactPointVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class MakerContactPoint extends BusinessObjectMaster {
    public MakerContactPoint(String obid){
        super(obid);
    }
    public MakerContactPoint(MakerContactPointVO vo){
        super(vo);
    }
    @Override
    public MakerContactPointVO getVo(){
        return (MakerContactPointVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeMakerContactPoint();
    }
    public void initializeMakerContactPoint(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "MakerContactPoint[toString()=" + super.toString() + "]";
    }

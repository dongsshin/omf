...
import rap.api.object.pdr.model.PCOPropertyVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PCOProperty extends BusinessObjectMaster {
    public PCOProperty(String obid){
        super(obid);
    }
    public PCOProperty(PCOPropertyVO vo){
        super(vo);
    }
    @Override
    public PCOPropertyVO getVo(){
        return (PCOPropertyVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePCOProperty();
    }
    public void initializePCOProperty(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PCOProperty[toString()=" + super.toString() + "]";
    }

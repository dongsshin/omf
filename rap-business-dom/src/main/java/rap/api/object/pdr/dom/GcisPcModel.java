...
import rap.api.object.pdr.model.GcisPcModelVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class GcisPcModel extends BusinessObjectMaster {
    public GcisPcModel(String obid){
        super(obid);
    }
    public GcisPcModel(GcisPcModelVO vo){
        super(vo);
    }
    @Override
    public GcisPcModelVO getVo(){
        return (GcisPcModelVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeGcisPcModel();
    }
    public void initializeGcisPcModel(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "GcisPcModel[toString()=" + super.toString() + "]";
    }

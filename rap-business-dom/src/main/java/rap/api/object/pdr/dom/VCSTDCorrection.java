 ...
 * Program ID : VCSTDCorrection.java
 * ===================================================================
...
import rap.api.object.pdr.model.VCSTDCorrectionVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class VCSTDCorrection extends BusinessObjectMaster {
    public VCSTDCorrection(String obid){
        super(obid);
    }
    public VCSTDCorrection(VCSTDCorrectionVO vo){
        super(vo);
    }
    @Override
    public VCSTDCorrectionVO getVo(){
        return (VCSTDCorrectionVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeVCSTDCorrection();
    }
    public void initializeVCSTDCorrection(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "VCSTDCorrection[toString()=" + super.toString() + "]";
    }

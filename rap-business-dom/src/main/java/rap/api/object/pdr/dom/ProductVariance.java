 ...
 * Program ID : ProductVariance.java
 * ===================================================================
...
import rap.api.object.pdr.model.ProductVarianceVO;
import rap.api.object.pdr.dom.Products;


public class ProductVariance extends Products {
    public ProductVariance(String obid){
        super(obid);
    }
    public ProductVariance(ProductVarianceVO vo){
        super(vo);
    }
    @Override
    public ProductVarianceVO getVo(){
        return (ProductVarianceVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProductVariance();
    }
    public void initializeProductVariance(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProductVariance[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ProjectMemberForPDR.java
 * ===================================================================
...
import rap.api.object.pdr.model.ProjectMemberForPDRVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectMemberForPDR extends BusinessObjectMaster {
    public ProjectMemberForPDR(String obid){
        super(obid);
    }
    public ProjectMemberForPDR(ProjectMemberForPDRVO vo){
        super(vo);
    }
    @Override
    public ProjectMemberForPDRVO getVo(){
        return (ProjectMemberForPDRVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectMemberForPDR();
    }
    public void initializeProjectMemberForPDR(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectMemberForPDR[toString()=" + super.toString() + "]";
    }

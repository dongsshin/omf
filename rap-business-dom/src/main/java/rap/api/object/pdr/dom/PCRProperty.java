...
import rap.api.object.pdr.model.PCRPropertyVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class PCRProperty extends BusinessObjectMaster {
    public PCRProperty(String obid){
        super(obid);
    }
    public PCRProperty(PCRPropertyVO vo){
        super(vo);
    }
    @Override
    public PCRPropertyVO getVo(){
        return (PCRPropertyVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializePCRProperty();
    }
    public void initializePCRProperty(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "PCRProperty[toString()=" + super.toString() + "]";
    }

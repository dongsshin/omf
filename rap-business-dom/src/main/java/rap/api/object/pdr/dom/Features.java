...
public class Features extends BusinessObjectMaster {
    public Features(String obid){
        super(obid);
    }
    public Features(FeaturesVO vo){
        super(vo);
    }
    @Override
    public FeaturesVO getVo(){
        return (FeaturesVO)super.getVo();
    }
    @Override
    ...
    public String toString() {
        return "Features[toString()=" + super.toString() + "]";
    }

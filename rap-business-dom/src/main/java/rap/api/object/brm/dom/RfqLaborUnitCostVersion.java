 ...
 * Program ID : RfqLaborUnitCostVersion.java
 * ===================================================================
...
import rap.api.object.brm.model.RfqLaborUnitCostVersionVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class RfqLaborUnitCostVersion extends BusinessObjectMaster {
    public RfqLaborUnitCostVersion(String obid){
        super(obid);
    }
    public RfqLaborUnitCostVersion(RfqLaborUnitCostVersionVO vo){
        super(vo);
    }
    @Override
    public RfqLaborUnitCostVersionVO getVo(){
        return (RfqLaborUnitCostVersionVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeRfqLaborUnitCostVersion();
    }
    public void initializeRfqLaborUnitCostVersion(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "RfqLaborUnitCostVersion[toString()=" + super.toString() + "]";
    }

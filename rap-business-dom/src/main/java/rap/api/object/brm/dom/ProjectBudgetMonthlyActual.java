 ...
 * Program ID : ProjectBudgetMonthlyActual.java
 * ===================================================================
 *  Modification Date      Modifier           Description
 *      2017.04.??       DS Shin            Initial
 * ===================================================================
 */
package rap.api.object.brm.dom;


import java.util.Map;
import rap.api.object.brm.model.ProjectBudgetMonthlyActualVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectBudgetMonthlyActual extends BusinessObjectMaster {
    public ProjectBudgetMonthlyActual(String obid){
        super(obid);
    }
    public ProjectBudgetMonthlyActual(ProjectBudgetMonthlyActualVO vo){
        super(vo);
    }
    @Override
    public ProjectBudgetMonthlyActualVO getVo(){
        return (ProjectBudgetMonthlyActualVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectBudgetMonthlyActual();
    }
    public void initializeProjectBudgetMonthlyActual(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectBudgetMonthlyActual[toString()=" + super.toString() + "]";
    }

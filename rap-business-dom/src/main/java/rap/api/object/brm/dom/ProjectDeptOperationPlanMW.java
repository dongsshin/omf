 ...
 * Program ID : ProjectDeptOperationPlanMW.java
 * ===================================================================
...
import rap.api.object.brm.model.ProjectDeptOperationPlanMWVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectDeptOperationPlanMW extends BusinessObjectMaster {
    public ProjectDeptOperationPlanMW(String obid){
        super(obid);
    }
    public ProjectDeptOperationPlanMW(ProjectDeptOperationPlanMWVO vo){
        super(vo);
    }
    @Override
    public ProjectDeptOperationPlanMWVO getVo(){
        return (ProjectDeptOperationPlanMWVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectDeptOperationPlanMW();
    }
    public void initializeProjectDeptOperationPlanMW(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectDeptOperationPlanMW[toString()=" + super.toString() + "]";
    }

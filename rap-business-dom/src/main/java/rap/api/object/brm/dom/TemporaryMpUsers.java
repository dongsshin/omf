 ...
 * Program ID : TemporaryMpUsers.java
 * ===================================================================
...
import rap.api.object.brm.model.TemporaryMpUsersVO;
import rap.api.object.organization.dom.AbstractUsers;


public class TemporaryMpUsers extends AbstractUsers {
    public TemporaryMpUsers(String obid){
        super(obid);
    }
    public TemporaryMpUsers(TemporaryMpUsersVO vo){
        super(vo);
    }
    @Override
    public TemporaryMpUsersVO getVo(){
        return (TemporaryMpUsersVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeTemporaryMpUsers();
    }
    public void initializeTemporaryMpUsers(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "TemporaryMpUsers[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : ProjectBudgetRfqPlan.java
 * ===================================================================
...
import rap.api.object.brm.model.ProjectBudgetRfqPlanVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectBudgetRfqPlan extends BusinessObjectMaster {
    public ProjectBudgetRfqPlan(String obid){
        super(obid);
    }
    public ProjectBudgetRfqPlan(ProjectBudgetRfqPlanVO vo){
        super(vo);
    }
    @Override
    public ProjectBudgetRfqPlanVO getVo(){
        return (ProjectBudgetRfqPlanVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectBudgetRfqPlan();
    }
    public void initializeProjectBudgetRfqPlan(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectBudgetRfqPlan[toString()=" + super.toString() + "]";
    }

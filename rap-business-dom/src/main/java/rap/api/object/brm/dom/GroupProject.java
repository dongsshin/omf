...
import rap.api.object.brm.model.GroupProjectVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class GroupProject extends BusinessObjectMaster {
    public GroupProject(String obid){
        super(obid);
    }
    public GroupProject(GroupProjectVO vo){
        super(vo);
    }
    @Override
    public GroupProjectVO getVo(){
        return (GroupProjectVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeGroupProject();
    }
    public void initializeGroupProject(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "GroupProject[toString()=" + super.toString() + "]";
    }

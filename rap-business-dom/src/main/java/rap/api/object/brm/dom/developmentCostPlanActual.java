 ...
 * Program ID : developmentCostPlanActual.java
 * ===================================================================
...
import rap.api.object.brm.model.developmentCostPlanActualVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class developmentCostPlanActual extends BusinessObjectMaster {
    public developmentCostPlanActual(String obid){
        super(obid);
    }
    public developmentCostPlanActual(developmentCostPlanActualVO vo){
        super(vo);
    }
    @Override
    public developmentCostPlanActualVO getVo(){
        return (developmentCostPlanActualVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializedevelopmentCostPlanActual();
    }
    public void initializedevelopmentCostPlanActual(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "developmentCostPlanActual[toString()=" + super.toString() + "]";
    }

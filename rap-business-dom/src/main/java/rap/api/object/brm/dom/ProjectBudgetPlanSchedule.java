 ...
 * Program ID : ProjectBudgetPlanSchedule.java
 * ===================================================================
...
import rap.api.object.brm.model.ProjectBudgetPlanScheduleVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectBudgetPlanSchedule extends BusinessObjectMaster {
    public ProjectBudgetPlanSchedule(String obid){
        super(obid);
    }
    public ProjectBudgetPlanSchedule(ProjectBudgetPlanScheduleVO vo){
        super(vo);
    }
    @Override
    public ProjectBudgetPlanScheduleVO getVo(){
        return (ProjectBudgetPlanScheduleVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectBudgetPlanSchedule();
    }
    public void initializeProjectBudgetPlanSchedule(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectBudgetPlanSchedule[toString()=" + super.toString() + "]";
    }

 ...
 * Program ID : MWScheduleMaster.java
 * ===================================================================
...
import rap.api.object.brm.model.MWScheduleMasterVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class MWScheduleMaster extends BusinessObjectMaster {
    public MWScheduleMaster(String obid){
        super(obid);
    }
    public MWScheduleMaster(MWScheduleMasterVO vo){
        super(vo);
    }
    @Override
    public MWScheduleMasterVO getVo(){
        return (MWScheduleMasterVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeMWScheduleMaster();
    }
    public void initializeMWScheduleMaster(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "MWScheduleMaster[toString()=" + super.toString() + "]";
    }

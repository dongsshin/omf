 ...
 * Program ID : ProjectBudgetTempPlan.java
 * ===================================================================
...
import rap.api.object.brm.model.ProjectBudgetTempPlanVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectBudgetTempPlan extends BusinessObjectMaster {
    public ProjectBudgetTempPlan(String obid){
        super(obid);
    }
    public ProjectBudgetTempPlan(ProjectBudgetTempPlanVO vo){
        super(vo);
    }
    @Override
    public ProjectBudgetTempPlanVO getVo(){
        return (ProjectBudgetTempPlanVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectBudgetTempPlan();
    }
    public void initializeProjectBudgetTempPlan(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectBudgetTempPlan[toString()=" + super.toString() + "]";
    }

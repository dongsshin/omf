 ...
 * Program ID : RfqAccountVersion.java
 * ===================================================================
...
import rap.api.object.brm.model.RfqAccountVersionVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class RfqAccountVersion extends BusinessObjectMaster {
    public RfqAccountVersion(String obid){
        super(obid);
    }
    public RfqAccountVersion(RfqAccountVersionVO vo){
        super(vo);
    }
    @Override
    public RfqAccountVersionVO getVo(){
        return (RfqAccountVersionVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeRfqAccountVersion();
    }
    public void initializeRfqAccountVersion(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "RfqAccountVersion[toString()=" + super.toString() + "]";
    }

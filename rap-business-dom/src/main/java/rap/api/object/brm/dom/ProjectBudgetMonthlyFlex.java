 ...
 * Program ID : ProjectBudgetMonthlyFlex.java
 * ===================================================================
...
import rap.api.object.brm.model.ProjectBudgetMonthlyFlexVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectBudgetMonthlyFlex extends BusinessObjectMaster {
    public ProjectBudgetMonthlyFlex(String obid){
        super(obid);
    }
    public ProjectBudgetMonthlyFlex(ProjectBudgetMonthlyFlexVO vo){
        super(vo);
    }
    @Override
    public ProjectBudgetMonthlyFlexVO getVo(){
        return (ProjectBudgetMonthlyFlexVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectBudgetMonthlyFlex();
    }
    public void initializeProjectBudgetMonthlyFlex(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectBudgetMonthlyFlex[toString()=" + super.toString() + "]";
    }

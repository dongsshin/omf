 ...
 * Program ID : ProjectBudgetOperPlan.java
 * ===================================================================
...
import rap.api.object.brm.model.ProjectBudgetOperPlanVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class ProjectBudgetOperPlan extends BusinessObjectMaster {
    public ProjectBudgetOperPlan(String obid){
        super(obid);
    }
    public ProjectBudgetOperPlan(ProjectBudgetOperPlanVO vo){
        super(vo);
    }
    @Override
    public ProjectBudgetOperPlanVO getVo(){
        return (ProjectBudgetOperPlanVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeProjectBudgetOperPlan();
    }
    public void initializeProjectBudgetOperPlan(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "ProjectBudgetOperPlan[toString()=" + super.toString() + "]";
    }

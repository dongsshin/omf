 ...
 * Program ID : RfqYyyyLaborUnitCost.java
 * ===================================================================
...
import rap.api.object.brm.model.RfqYyyyLaborUnitCostVO;
import com.rap.omc.api.object.dom.BusinessObjectMaster;


public class RfqYyyyLaborUnitCost extends BusinessObjectMaster {
    public RfqYyyyLaborUnitCost(String obid){
        super(obid);
    }
    public RfqYyyyLaborUnitCost(RfqYyyyLaborUnitCostVO vo){
        super(vo);
    }
    @Override
    public RfqYyyyLaborUnitCostVO getVo(){
        return (RfqYyyyLaborUnitCostVO)super.getVo();
    }
    @Override
    public void initialize(){
        super.initialize();
        initializeRfqYyyyLaborUnitCost();
    }
    public void initializeRfqYyyyLaborUnitCost(){
    /*code here*/
    }
    @Override
    public String toString() {
        return "RfqYyyyLaborUnitCost[toString()=" + super.toString() + "]";
    }
